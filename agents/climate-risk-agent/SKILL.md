...
description: 'Physical/transition risk scoring, disclosure mapping (TCFD/ISSB), mitigation ranking'
version: 1.0.0
...
2. Run deterministic heuristics for **Climate Risk Analyst** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/climate-risk-agent/cli/climate_risk.py --help`
