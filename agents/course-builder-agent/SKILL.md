...
description: 'Learning objective mapping, module sequencing, assessment design, completion analytics'
version: 1.0.0
...
2. Run deterministic heuristics for **Course Builder** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/course-builder-agent/cli/course_builder.py --help`
