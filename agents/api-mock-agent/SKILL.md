---
name: api-mock-agent
description: 'Deterministic mocks from OpenAPI, Pact contracts, stub servers, fake-data factories'
version: 1.0.0
author: AI Agent Architect
category: 'Coding & DevOps'
---

# Mock & Contract Stub Generator
...
2. Run deterministic heuristics for **Mock & Contract Stub Generator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/api-mock-agent/cli/api_mock.py --help`
