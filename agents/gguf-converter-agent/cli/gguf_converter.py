"""CLI for GGUF Converter — HF → GGUF, vocab, and Metal/CUDA kernel mapping"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="GGUF Converter — HF → GGUF, vocab, and Metal/CUDA kernel mapping")
    ...
    from core.gguf_converter_engine import GgufConverterEngine
    analysis=GgufConverterEngine.analyze(text)
    if args.json:
        ...
        print(GgufConverterEngine.format_report(analysis))
