---
name: observability-stack-agent
description: 'Prometheus/Grafana/OTel/Loki, SLO burn, and cardinality explosion guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Observability Stack** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/observability-stack-agent/cli/observability_stack.py --help`
