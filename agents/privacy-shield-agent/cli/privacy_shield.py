"""CLI for Privacy & DPA Steward — GDPR/CCPA gap analysis, DPA clause mapping, consent-flow audits, retention enforcement"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Privacy & DPA Steward — GDPR/CCPA gap analysis, DPA clause mapping, consent-flow audits, retention enforcement')
    ...
    from core.privacy_shield_engine import PrivacyShieldEngine
    analysis = PrivacyShieldEngine.analyze(text)
    if args.json:
        ...
        print(PrivacyShieldEngine.format_report(analysis))
