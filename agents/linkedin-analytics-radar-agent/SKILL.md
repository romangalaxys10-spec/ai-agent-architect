---
name: linkedin-analytics-radar-agent
description: 'SSI, impressions→leads, dwell-time, and creator-mode telemetry'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Analytics Radar
...
2. Run deterministic heuristics for **LinkedIn Analytics Radar** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-analytics-radar-agent/cli/linkedin_analytics_radar.py --help`
