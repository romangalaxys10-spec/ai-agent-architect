---
name: gemini-script-to-video-agent
description: 'Script → Gemini scene prompts → shot list + B-roll mapping from free stock'
version: 1.0.0
author: AI Agent Architect
category: 'Video: Freebie + Gemini'
---

# Gemini Script-to-Video
...
2. Run deterministic heuristics for **Gemini Script-to-Video** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/gemini-script-to-video-agent/cli/gemini_script_to_video.py --help`
