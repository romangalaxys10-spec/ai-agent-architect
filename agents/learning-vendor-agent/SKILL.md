---
name: learning-vendor-agent
description: 'Vendor selection, SOW/quality gates, and build-vs-buy decisions'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Learning Vendor Navigator
...
2. Run deterministic heuristics for **Learning Vendor Navigator** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-vendor-agent/cli/learning_vendor.py --help`
