"""CLI for Audio Router — Input/output device switching, volume ducking, mic gate, and audio capture routing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Audio Router — Input/output device switching, volume ducking, mic gate, and audio capture routing")
    ...
    from core.audio_router_engine import AudioRouterEngine
    analysis=AudioRouterEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(AudioRouterEngine.format_report(analysis))
