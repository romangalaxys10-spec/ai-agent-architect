---
name: vector-db-architect-agent
description: 'Index selection (HNSW/IVF), chunking strategy, ANN recall benchmarking, hybrid search tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **Vector DB Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/vector-db-architect-agent/cli/vector_db_architect.py --help`
