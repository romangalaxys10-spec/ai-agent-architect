"""CLI for Journey Mapper — Touchpoint mapping, emotion curves, pain-point severity ranking, opportunity sizing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Journey Mapper — Touchpoint mapping, emotion curves, pain-point severity ranking, opportunity sizing')
    ...
    from core.user_journey_engine import UserJourneyEngine
    analysis = UserJourneyEngine.analyze(text)
    if args.json:
        ...
        print(UserJourneyEngine.format_report(analysis))
