---
name: chaos-lab-agent
description: 'Fault injection plans, blast-radius scoping, steady-state hypotheses, game-day runbooks'
version: 1.0.0
...
2. Run deterministic heuristics for **Chaos Engineering Designer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/chaos-lab-agent/cli/chaos_lab.py --help`
