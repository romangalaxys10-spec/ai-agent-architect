"""CLI for Figma to Code — Figma autolayout → Tailwind/React with token fidelity"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Figma to Code — Figma autolayout → Tailwind/React with token fidelity")
    ...
    from core.figma_to_code_engine import FigmaToCodeEngine
    analysis=FigmaToCodeEngine.analyze(text)
    if args.json:
        ...
        print(FigmaToCodeEngine.format_report(analysis))
