---
name: autonomous-researcher-agent
description: 'Hypothesis generation, experiment planning, lit-review synthesis, preprint monitoring'
version: 1.0.0
...
2. Run deterministic heuristics for **Autonomous Researcher** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/autonomous-researcher-agent/cli/autonomous_researcher.py --help`
