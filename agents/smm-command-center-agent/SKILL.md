---
name: smm-command-center-agent
description: 'Cross-platform calendar, asset variant generation, performance rollup, crisis monitoring'
version: 1.0.0
author: AI Agent Architect
category: 'GTM & SMM Power Suite'
---
...
2. Run deterministic heuristics for **SMM Command Center** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/smm-command-center-agent/cli/smm_command_center.py --help`
