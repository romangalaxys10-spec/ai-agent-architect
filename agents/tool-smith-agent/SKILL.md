---
name: tool-smith-agent
description: 'Tool schema design, validation harness, mock-server generation, version migration planning'
version: 1.0.0
...
2. Run deterministic heuristics for **Tool Smith** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/tool-smith-agent/cli/tool_smith.py --help`
