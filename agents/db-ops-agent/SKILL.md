---
name: db-ops-agent
description: 'Postgres/MySQL/Redis — vacuum/replication/latency, slow-query forensics, backup PITR'
version: 1.0.0
...
2. Run deterministic heuristics for **DB Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/db-ops-agent/cli/db_ops.py --help`
