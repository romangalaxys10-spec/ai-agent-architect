...
description: 'RFP eligibility checks, compliance matrix, proposal choreography for public sector'
version: 1.0.0
author: AI Agent Architect
category: 'Vertical Specialists'
---

# Gov Procurement Navigator
...
2. Run deterministic heuristics for **Gov Procurement Navigator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/gov-procurement-agent/cli/gov_procurement.py --help`
