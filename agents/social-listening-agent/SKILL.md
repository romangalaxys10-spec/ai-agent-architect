...
description: 'Mention clustering, sentiment velocity, crisis early-warning, competitor share-of-voice'
version: 1.0.0
...
2. Run deterministic heuristics for **Social Listening Radar** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/social-listening-agent/cli/social_listening.py --help`
