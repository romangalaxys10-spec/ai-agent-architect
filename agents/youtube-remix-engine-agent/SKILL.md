---
name: youtube-remix-engine-agent
description: 'Remix/repurpose: long→Shorts, compilations, and multi-angle cuts'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# YouTube Remix Engine
...
2. Run deterministic heuristics for **YouTube Remix Engine** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-remix-engine-agent/cli/youtube_remix_engine.py --help`
