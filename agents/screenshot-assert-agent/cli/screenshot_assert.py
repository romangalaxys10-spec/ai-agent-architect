"""CLI for Screenshot Assert Engine — Visual diff, perceptual hash, region masking, and golden screenshot gates"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Screenshot Assert Engine — Visual diff, perceptual hash, region masking, and golden screenshot gates")
    ...
    from core.screenshot_assert_engine import ScreenshotAssertEngine
    analysis=ScreenshotAssertEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ScreenshotAssertEngine.format_report(analysis))
