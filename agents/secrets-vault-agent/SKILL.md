...
description: 'Hardcoded secret scan beyond SAST, rotation schedules, least-privilege env config mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Secrets & Config Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/secrets-vault-agent/cli/secrets_vault.py --help`
