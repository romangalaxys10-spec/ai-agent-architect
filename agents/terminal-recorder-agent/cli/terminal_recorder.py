"""CLI for Terminal Recorder — Asciinema-style capture, timing file synthesis, and deterministic replay gates"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Terminal Recorder — Asciinema-style capture, timing file synthesis, and deterministic replay gates")
    ...
    from core.terminal_recorder_engine import TerminalRecorderEngine
    analysis=TerminalRecorderEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(TerminalRecorderEngine.format_report(analysis))
