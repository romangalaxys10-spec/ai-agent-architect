---
name: tmux-orchestrator-agent
description: 'Session/window/pane topology, layout persistence, and copy-mode automation'
version: 1.0.0
...
2. Run deterministic heuristics for **Tmux Orchestrator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/tmux-orchestrator-agent/cli/tmux_orchestrator.py --help`
