---
name: linkedin-dm-funnel-agent
description: 'Connection → DM → meeting funnel with personalization and safety throttles'
version: 1.0.0
...
2. Run deterministic heuristics for **LinkedIn DM Funnel** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-dm-funnel-agent/cli/linkedin_dm_funnel.py --help`
