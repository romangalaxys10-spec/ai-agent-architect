---
name: feedback-culture-agent
description: 'Feedback cadence, psychological safety, and 360/peer feedback systems'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Feedback Culture Builder
...
2. Run deterministic heuristics for **Feedback Culture Builder** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/feedback-culture-agent/cli/feedback_culture.py --help`
