---
name: build-optimizer-agent
description: 'Bundle-size audit, tree-shake analysis, cache-hit maximization, CI minute reduction'
version: 1.0.0
author: AI Agent Architect
category: 'Coding & DevOps'
---

# Build & Bundle Optimizer
...
2. Run deterministic heuristics for **Build & Bundle Optimizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/build-optimizer-agent/cli/build_optimizer.py --help`
