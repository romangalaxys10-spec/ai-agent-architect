---
name: ansible-pilot-agent
description: 'Playbook linting, idempotency verification, vault, and inventory forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Ansible Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ansible-pilot-agent/cli/ansible_pilot.py --help`
