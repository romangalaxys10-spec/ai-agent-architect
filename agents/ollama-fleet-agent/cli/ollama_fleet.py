"""CLI for Ollama Fleet Pilot — Ollama fleet, model pulls, and Modelfile governance"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Ollama Fleet Pilot — Ollama fleet, model pulls, and Modelfile governance")
    ...
    from core.ollama_fleet_engine import OllamaFleetEngine
    analysis=OllamaFleetEngine.analyze(text)
    if args.json:
        ...
        print(OllamaFleetEngine.format_report(analysis))
