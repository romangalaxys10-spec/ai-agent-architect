"""CLI for Migration Ops — Lift-and-shift vs replatform, data gravity, cutover windows, and rollback rehearsals"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Migration Ops — Lift-and-shift vs replatform, data gravity, cutover windows, and rollback rehearsals")
    ...
    from core.migration_ops_engine import MigrationOpsEngine
    analysis=MigrationOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(MigrationOpsEngine.format_report(analysis))
