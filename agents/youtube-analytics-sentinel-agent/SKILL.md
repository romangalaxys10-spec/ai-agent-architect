---
name: youtube-analytics-sentinel-agent
description: 'Retention curves, traffic sources, and returning vs new'
version: 1.0.0
author: AI Agent Architect
category: 'Social: YouTube'
---

# YouTube Analytics Sentinel
...
2. Run deterministic heuristics for **YouTube Analytics Sentinel** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-analytics-sentinel-agent/cli/youtube_analytics_sentinel.py --help`
