...
description: 'Flag lifecycle, targeting rules, kill-switch runbooks, experiment exposure auditing'
version: 1.0.0
...
2. Run deterministic heuristics for **Feature Flag Governor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/feature-flag-agent/cli/feature_flag.py --help`
