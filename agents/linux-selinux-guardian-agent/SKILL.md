---
name: linux-selinux-guardian-agent
description: 'SELinux/AppArmor audit, denials, and policy authoring'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Linux'
---

# Linux SELinux Guardian
...
2. Run deterministic heuristics for **Linux SELinux Guardian** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-selinux-guardian-agent/cli/linux_selinux_guardian.py --help`
