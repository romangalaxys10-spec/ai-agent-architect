...
description: 'Token hygiene, component API consistency, Figma drift detection, adoption metrics'
version: 1.0.0
...
2. Run deterministic heuristics for **Design System Curator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/design-system-agent/cli/design_system.py --help`
