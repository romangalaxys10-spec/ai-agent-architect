"""CLI for Data Labeling Ops — Label schema design, IAA measurement, active-learning queue prioritization, QA sampling plans"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Data Labeling Ops — Label schema design, IAA measurement, active-learning queue prioritization, QA sampling plans')
    ...
    from core.label_ops_engine import LabelOpsEngine
    analysis = LabelOpsEngine.analyze(text)
    if args.json:
        ...
        print(LabelOpsEngine.format_report(analysis))
