"""CLI for Procurement Scout — Vendor comparison matrices, TCO modeling, negotiation leverage mapping, renewal risk flags"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Procurement Scout — Vendor comparison matrices, TCO modeling, negotiation leverage mapping, renewal risk flags')
    ...
    from core.procurement_scout_engine import ProcurementScoutEngine
    analysis = ProcurementScoutEngine.analyze(text)
    if args.json:
        ...
        print(ProcurementScoutEngine.format_report(analysis))
