---
name: proposal-forge-agent
description: 'RFP shredding, win-theme mapping, compliance matrix, proposal narrative assembly'
version: 1.0.0
...
2. Run deterministic heuristics for **Proposal & RFP Forge** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/proposal-forge-agent/cli/proposal_forge.py --help`
