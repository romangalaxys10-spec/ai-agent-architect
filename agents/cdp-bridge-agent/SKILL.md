---
name: cdp-bridge-agent
description: 'Chrome DevTools Protocol — DOM, debugger, network, emulation, and trace capture'
version: 1.0.0
...
2. Run deterministic heuristics for **CDP Bridge** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/cdp-bridge-agent/cli/cdp_bridge.py --help`
