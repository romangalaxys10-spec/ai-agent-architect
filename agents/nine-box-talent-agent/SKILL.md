---
name: nine-box-talent-agent
description: '9-box facilitation, placement, bias flags, and development vs reward actions'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# 9-Box Talent Grid Facilitator
...
2. Run deterministic heuristics for **9-Box Talent Grid Facilitator** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/nine-box-talent-agent/cli/nine_box_talent.py --help`
