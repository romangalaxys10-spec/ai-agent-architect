"""CLI for Edge & IoT Fleet — Fleet OTA, MQTT, secure boot attestation, and offline-queue draining"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Edge & IoT Fleet — Fleet OTA, MQTT, secure boot attestation, and offline-queue draining")
    ...
    from core.edge_iot_engine import EdgeIotEngine
    analysis=EdgeIotEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(EdgeIotEngine.format_report(analysis))
