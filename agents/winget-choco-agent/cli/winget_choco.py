"""CLI for Winget & Chocolatey Pilot — Package resolution, silent install flags, and winget source pinning"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Winget & Chocolatey Pilot — Package resolution, silent install flags, and winget source pinning")
    ...
    from core.winget_choco_engine import WingetChocoEngine
    analysis=WingetChocoEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(WingetChocoEngine.format_report(analysis))
