---
name: linux-filesystem-surgeon-agent
description: 'fsck, LVM thin, XFS repair, and mount forensics'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Linux'
---

# Linux Filesystem Surgeon
...
2. Run deterministic heuristics for **Linux Filesystem Surgeon** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-filesystem-surgeon-agent/cli/linux_filesystem_surgeon.py --help`
