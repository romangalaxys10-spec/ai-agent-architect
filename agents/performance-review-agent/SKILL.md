...
description: 'Feedback theme synthesis, calibration support, growth-plan drafting, bias flagging'
version: 1.0.0
...
2. Run deterministic heuristics for **Performance Review Synthesizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/performance-review-agent/cli/performance_review.py --help`
