---
name: tiktok-shop-affiliate-agent
description: 'Shop product tags, affiliate match, and commission telemetry'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Shop Affiliate** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-shop-affiliate-agent/cli/tiktok_shop_affiliate.py --help`
