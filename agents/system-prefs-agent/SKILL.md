---
name: system-prefs-agent
description: 'Settings search, plist/registry diffing, profile provisioning, and drift enforcement'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# System Preferences Tuner
...
2. Run deterministic heuristics for **System Preferences Tuner** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/system-prefs-agent/cli/system_prefs.py --help`
