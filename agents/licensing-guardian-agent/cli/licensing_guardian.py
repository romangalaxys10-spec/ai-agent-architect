"""CLI for License & Compliance Sentinel — OSS license compatibility, copyleft risk, SBOM generation, attribution assembly"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='License & Compliance Sentinel — OSS license compatibility, copyleft risk, SBOM generation, attribution assembly')
    ...
    from core.licensing_guardian_engine import LicensingGuardianEngine
    analysis = LicensingGuardianEngine.analyze(text)
    if args.json:
        ...
        print(LicensingGuardianEngine.format_report(analysis))
