---
name: insta-shop-optimizer-agent
description: 'Product tags, catalog hygiene, and DM→checkout drop analysis'
version: 1.0.0
author: AI Agent Architect
category: 'Social: Instagram'
---

# Insta Shop Optimizer
...
2. Run deterministic heuristics for **Insta Shop Optimizer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-shop-optimizer-agent/cli/insta_shop_optimizer.py --help`
