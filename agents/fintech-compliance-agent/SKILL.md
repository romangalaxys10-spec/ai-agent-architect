---
name: fintech-compliance-agent
description: 'KYC/AML flow checks, transaction monitoring flag review, regulatory mapping'
version: 1.0.0
author: AI Agent Architect
category: 'Vertical Specialists'
---

# FinTech Compliance Sentinel
...
2. Run deterministic heuristics for **FinTech Compliance Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/fintech-compliance-agent/cli/fintech_compliance.py --help`
