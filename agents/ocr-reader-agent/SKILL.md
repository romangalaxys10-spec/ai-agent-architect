---
name: ocr-reader-agent
description: 'On-screen text extraction, table de-warping, language detection, and redaction'
version: 1.0.0
...
2. Run deterministic heuristics for **OCR Reader** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ocr-reader-agent/cli/ocr_reader.py --help`
