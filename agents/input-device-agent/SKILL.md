---
name: input-device-agent
description: 'Keyboard/mouse/gamepad pairing, driver health, DPI/remap sync, and latency checks'
version: 1.0.0
...
2. Run deterministic heuristics for **Input Device Manager** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/input-device-agent/cli/input_device.py --help`
