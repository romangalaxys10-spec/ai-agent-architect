"""CLI for Solana Token Ops — SPL / Token-2022, mints, metadata, and treasury ops"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Solana Token Ops — SPL / Token-2022, mints, metadata, and treasury ops")
    ...
    from core.solana_token_ops_engine import SolanaTokenOpsEngine
    analysis=SolanaTokenOpsEngine.analyze(text)
    if args.json:
        ...
        print(SolanaTokenOpsEngine.format_report(analysis))
