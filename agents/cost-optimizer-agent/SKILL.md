...
description: 'Token/latency Pareto frontier, model routing policy, cache-hit maximization'
version: 1.0.0
...
2. Run deterministic heuristics for **Agent Cost Optimizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/cost-optimizer-agent/cli/cost_optimizer.py --help`
