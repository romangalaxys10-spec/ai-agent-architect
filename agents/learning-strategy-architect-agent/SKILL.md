---
name: learning-strategy-architect-agent
description: 'L&D strategy & operating model: build/buy, governance, and portfolio balance'
version: 1.0.0
...
2. Run deterministic heuristics for **Learning Strategy Architect** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-strategy-architect-agent/cli/learning_strategy_architect.py --help`
