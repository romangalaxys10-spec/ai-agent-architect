---
name: keybinding-doctor-agent
description: 'Readline/editing mode, keymap conflict resolution, and latency-to-action tracing'
version: 1.0.0
...
2. Run deterministic heuristics for **Keybinding Doctor** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/keybinding-doctor-agent/cli/keybinding_doctor.py --help`
