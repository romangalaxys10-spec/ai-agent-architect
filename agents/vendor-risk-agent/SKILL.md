...
description: 'Risk tiering, questionnaire gap analysis, mitigation plan generation'
version: 1.0.0
...
2. Run deterministic heuristics for **Vendor Risk Assessor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/vendor-risk-agent/cli/vendor_risk.py --help`
