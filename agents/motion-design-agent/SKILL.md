...
description: 'Micro-interactions, Framer Motion specs, and reduced-motion guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Motion Design Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/motion-design-agent/cli/motion_design.py --help`
