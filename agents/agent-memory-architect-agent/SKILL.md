---
name: agent-memory-architect-agent
description: 'Working/episodic/semantic tier design, compaction triggers, retrieval policy tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **Agent Memory Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/agent-memory-architect-agent/cli/agent_memory_architect.py --help`
