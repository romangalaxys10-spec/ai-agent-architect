...
description: 'PII discovery, retention policy mapping, lineage cataloging, access-tier enforcement'
version: 1.0.0
...
2. Run deterministic heuristics for **Data Governance Steward** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/data-governance-agent/cli/data_governance.py --help`
