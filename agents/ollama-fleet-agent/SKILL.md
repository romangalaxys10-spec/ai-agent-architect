---
name: ollama-fleet-agent
description: 'Ollama fleet, model pulls, and Modelfile governance'
version: 1.0.0
...
2. Run deterministic heuristics for **Ollama Fleet Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/ollama-fleet-agent/cli/ollama_fleet.py --help`
