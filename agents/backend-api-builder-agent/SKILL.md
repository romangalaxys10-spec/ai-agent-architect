---
name: backend-api-builder-agent
description: 'REST/GraphQL/gRPC API with auth, pagination, and idempotency'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Web Dev'
---
...
2. Run deterministic heuristics for **Backend API Builder** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/backend-api-builder-agent/cli/backend_api_builder.py --help`
