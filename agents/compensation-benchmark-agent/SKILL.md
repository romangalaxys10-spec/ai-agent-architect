---
name: compensation-benchmark-agent
description: 'Band mapping, market percentile analysis, pay-equity flags, offer construction (not advice)'
version: 1.0.0
...
2. Run deterministic heuristics for **Compensation Benchmarker** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/compensation-benchmark-agent/cli/compensation_benchmark.py --help`
