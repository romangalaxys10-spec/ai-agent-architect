...
description: 'Interview coding, affinity mapping, insight prioritization, JTBD extraction'
version: 1.0.0
...
2. Run deterministic heuristics for **UX Research Synthesizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ux-research-agent/cli/ux_research.py --help`
