---
name: etl-surgeon-agent
description: 'Pipeline lineage mapping, idempotency checks, late-arriving data handling, cost-per-GB optimization'
version: 1.0.0
author: AI Agent Architect
category: 'Data & AI/ML'
---

# ETL/ELT Pipeline Surgeon
...
2. Run deterministic heuristics for **ETL/ELT Pipeline Surgeon** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/etl-surgeon-agent/cli/etl_surgeon.py --help`
