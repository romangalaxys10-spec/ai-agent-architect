---
name: x-list-intel-agent
description: 'List curation, signal vs noise, and DM-able prospect surfacing'
version: 1.0.0
...
2. Run deterministic heuristics for **X List Intel** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-list-intel-agent/cli/x_list_intel.py --help`
