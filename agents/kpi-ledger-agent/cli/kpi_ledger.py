"""CLI for KPI Ledger Keeper — North-star decomposition, metric ownership, anomaly alerts, board-ready rollups"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='KPI Ledger Keeper — North-star decomposition, metric ownership, anomaly alerts, board-ready rollups')
    ...
    from core.kpi_ledger_engine import KpiLedgerEngine
    analysis = KpiLedgerEngine.analyze(text)
    if args.json:
        ...
        print(KpiLedgerEngine.format_report(analysis))
