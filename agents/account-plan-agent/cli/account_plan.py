"""CLI for Strategic Account Planner — Org chart mapping, whitespace analysis, multi-threading plan, executive briefing pack"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Strategic Account Planner — Org chart mapping, whitespace analysis, multi-threading plan, executive briefing pack')
    ...
    from core.account_plan_engine import AccountPlanEngine
    analysis = AccountPlanEngine.analyze(text)
    if args.json:
        ...
        print(AccountPlanEngine.format_report(analysis))
