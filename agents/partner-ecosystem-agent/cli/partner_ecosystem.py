"""CLI for Partner Ecosystem Scout — Partner-fit scoring, co-sell motion design, referral tracking, enablement gap analysis"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Partner Ecosystem Scout — Partner-fit scoring, co-sell motion design, referral tracking, enablement gap analysis')
    ...
    from core.partner_ecosystem_engine import PartnerEcosystemEngine
    analysis = PartnerEcosystemEngine.analyze(text)
    if args.json:
        ...
        print(PartnerEcosystemEngine.format_report(analysis))
