---
name: x-search-scraper-agent
description: 'Advanced search operators, saved searches, and lead/theme mining'
version: 1.0.0
...
2. Run deterministic heuristics for **X Search Scraper** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-search-scraper-agent/cli/x_search_scraper.py --help`
