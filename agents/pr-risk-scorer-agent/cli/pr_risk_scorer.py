"""CLI for PR Risk Scorer — PR blast radius, churn, and reviewer assignment"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="PR Risk Scorer — PR blast radius, churn, and reviewer assignment")
    ...
    from core.pr_risk_scorer_engine import PrRiskScorerEngine
    analysis=PrRiskScorerEngine.analyze(text)
    if args.json:
        ...
        print(PrRiskScorerEngine.format_report(analysis))
