---
name: linux-boot-rescue-agent
description: 'GRUB/systemd-boot, initramfs, and rescue mode forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Linux Boot Rescue** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-boot-rescue-agent/cli/linux_boot_rescue.py --help`
