---
name: brand-system-agent
description: 'Brand tokens, typography, and component API harmony'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Web Design'
---

# Brand System Curator
...
2. Run deterministic heuristics for **Brand System Curator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/brand-system-agent/cli/brand_system.py --help`
