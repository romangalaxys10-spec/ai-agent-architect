---
name: linkedin-poll-viral-agent
description: 'Poll hooks, comment-velocity design, and algorithm-friendly timing'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Poll Virality Lab
...
2. Run deterministic heuristics for **LinkedIn Poll Virality Lab** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-poll-viral-agent/cli/linkedin_poll_viral.py --help`
