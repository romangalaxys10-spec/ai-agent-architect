"""CLI for Solana NFT Ops — cNFT / Core, collection ops, and marketplace indexing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Solana NFT Ops — cNFT / Core, collection ops, and marketplace indexing")
    ...
    from core.solana_nft_ops_engine import SolanaNftOpsEngine
    analysis=SolanaNftOpsEngine.analyze(text)
    if args.json:
        ...
        print(SolanaNftOpsEngine.format_report(analysis))
