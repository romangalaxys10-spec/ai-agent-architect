...
description: 'Branching scenarios & simulations: consequence design and skill transfer'
version: 1.0.0
...
2. Run deterministic heuristics for **Scenario Simulation Studio** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/scenario-simulation-agent/cli/scenario_simulation.py --help`
