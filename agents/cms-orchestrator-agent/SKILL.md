...
description: 'Headless CMS (Sanity/Contentful), preview, and webhook'
version: 1.0.0
...
2. Run deterministic heuristics for **CMS Orchestrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/cms-orchestrator-agent/cli/cms_orchestrator.py --help`
