"""CLI for Autonomous Researcher — Hypothesis generation, experiment planning, lit-review synthesis, preprint monitoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Autonomous Researcher — Hypothesis generation, experiment planning, lit-review synthesis, preprint monitoring')
    ...
    from core.autonomous_researcher_engine import AutonomousResearcherEngine
    analysis = AutonomousResearcherEngine.analyze(text)
    if args.json:
        ...
        print(AutonomousResearcherEngine.format_report(analysis))
