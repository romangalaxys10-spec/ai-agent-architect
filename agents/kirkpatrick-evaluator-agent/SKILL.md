---
name: kirkpatrick-evaluator-agent
description: 'Levels 1-4 with leading indicators, control groups, and attribution guardrails'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Kirkpatrick Evaluator
...
2. Run deterministic heuristics for **Kirkpatrick Evaluator** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/kirkpatrick-evaluator-agent/cli/kirkpatrick_evaluator.py --help`
