"""CLI for CSAT Surgeon — Driver analysis, recovery playbooks, closed-loop tracking, segment trending"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='CSAT Surgeon — Driver analysis, recovery playbooks, closed-loop tracking, segment trending')
    ...
    from core.csat_surgeon_engine import CsatSurgeonEngine
    analysis = CsatSurgeonEngine.analyze(text)
    if args.json:
        ...
        print(CsatSurgeonEngine.format_report(analysis))
