---
name: nonprofit-impact-agent
description: 'Theory-of-change mapping, outcome metric design, grant reporting packet assembly'
version: 1.0.0
...
2. Run deterministic heuristics for **Nonprofit Impact Tracker** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/nonprofit-impact-agent/cli/nonprofit_impact.py --help`
