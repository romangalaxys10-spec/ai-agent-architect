---
name: exit-insight-agent
description: 'Departure theme extraction, regretted vs non-regretted loss, retention lever mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Exit Insight Miner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/exit-insight-agent/cli/exit_insight.py --help`
