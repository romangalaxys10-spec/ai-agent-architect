"""CLI for Screen Recorder & Replay — Session capture, action trace diffing, deterministic replay, and flake diagnosis"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Screen Recorder & Replay — Session capture, action trace diffing, deterministic replay, and flake diagnosis")
    ...
    from core.screen_recorder_engine import ScreenRecorderEngine
    analysis=ScreenRecorderEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ScreenRecorderEngine.format_report(analysis))
