"""CLI for NPS Driver Analyst — Promoter/passive/detractor drivers, closed-loop prioritization, exec narrative"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='NPS Driver Analyst — Promoter/passive/detractor drivers, closed-loop prioritization, exec narrative')
    ...
    from core.nps_driver_engine import NpsDriverEngine
    analysis = NpsDriverEngine.analyze(text)
    if args.json:
        ...
        print(NpsDriverEngine.format_report(analysis))
