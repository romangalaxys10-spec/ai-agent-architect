...
description: 'Bias/fairness audits, SHAP-style attribution summaries, challenger-model comparison, MRM reports'
version: 1.0.0
...
2. Run deterministic heuristics for **Model Risk & Validation** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/model-risk-agent/cli/model_risk.py --help`
