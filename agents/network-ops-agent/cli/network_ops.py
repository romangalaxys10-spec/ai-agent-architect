"""CLI for Network Ops — iptables/nftables, ip route, DNS (systemd-resolved/Unbound), and mtr forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Network Ops — iptables/nftables, ip route, DNS (systemd-resolved/Unbound), and mtr forensics")
    ...
    from core.network_ops_engine import NetworkOpsEngine
    analysis=NetworkOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(NetworkOpsEngine.format_report(analysis))
