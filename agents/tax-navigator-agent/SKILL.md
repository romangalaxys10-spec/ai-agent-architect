---
name: tax-navigator-agent
description: 'Jurisdiction mapping, nexus flagging, filing deadline calendar, risk-ranked action list (not advice)'
version: 1.0.0
...
2. Run deterministic heuristics for **Tax Navigator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/tax-navigator-agent/cli/tax_navigator.py --help`
