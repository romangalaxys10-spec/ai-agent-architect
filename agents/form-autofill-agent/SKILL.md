...
description: 'Field inference, constraint validation, CAPTCHA/Turnstile routing, and submit guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Form Autofill Engine** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/form-autofill-agent/cli/form_autofill.py --help`
