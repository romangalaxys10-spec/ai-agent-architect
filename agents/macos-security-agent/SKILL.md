---
name: macos-security-agent
description: 'Gatekeeper, XProtect, TCC db, keychain, and Endpoint Security framework'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# macOS Security Sentinel
...
2. Run deterministic heuristics for **macOS Security Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/macos-security-agent/cli/macos_security.py --help`
