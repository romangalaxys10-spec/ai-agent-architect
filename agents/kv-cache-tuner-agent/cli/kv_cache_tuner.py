"""CLI for KV-Cache Tuner — KV quantization, prefix cache, and eviction policy"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="KV-Cache Tuner — KV quantization, prefix cache, and eviction policy")
    ...
    from core.kv_cache_tuner_engine import KvCacheTunerEngine
    analysis=KvCacheTunerEngine.analyze(text)
    if args.json:
        ...
        print(KvCacheTunerEngine.format_report(analysis))
