---
name: inference-benchmark-agent
description: 'TTFT/TPS, p95, and cost-per-1k for local LLM'
version: 1.0.0
...
2. Run deterministic heuristics for **Inference Benchmark** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/inference-benchmark-agent/cli/inference_benchmark.py --help`
