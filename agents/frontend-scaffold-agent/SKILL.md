...
description: 'Vite/Next/Nuxt scaffold with TS, lint, and a11y baseline'
version: 1.0.0
...
2. Run deterministic heuristics for **Frontend Scaffold** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/frontend-scaffold-agent/cli/frontend_scaffold.py --help`
