---
name: referral-architect-agent
description: 'Incentive design, viral coefficient math, fraud controls, share-copy generation'
version: 1.0.0
...
2. Run deterministic heuristics for **Referral Program Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/referral-architect-agent/cli/referral_architect.py --help`
