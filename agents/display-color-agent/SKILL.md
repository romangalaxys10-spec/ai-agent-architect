---
name: display-color-agent
description: 'Resolution/refresh switching, HDR/color profile validation, and night-shift scheduling'
version: 1.0.0
...
2. Run deterministic heuristics for **Display & Color Calibrator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/display-color-agent/cli/display_color.py --help`
