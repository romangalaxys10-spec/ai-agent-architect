---
name: knowledge-ops-agent
description: 'Article performance vs ticket deflection, freshness SLA, AI-assist readiness scoring'
version: 1.0.0
author: AI Agent Architect
category: 'Support & Success'
---

# Knowledge Ops Scaler
...
2. Run deterministic heuristics for **Knowledge Ops Scaler** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/knowledge-ops-agent/cli/knowledge_ops.py --help`
