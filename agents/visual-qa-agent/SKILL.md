...
description: 'Pixel diff, perceptual hash, and responsive breakpoints QA'
version: 1.0.0
...
2. Run deterministic heuristics for **Visual QA Sentinel** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/visual-qa-agent/cli/visual_qa.py --help`
