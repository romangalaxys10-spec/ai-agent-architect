---
name: ab-test-architect-agent
description: 'Hypothesis framing, sample-size math, guardrail metrics, ship/hold/iterate verdicts'
version: 1.0.0
author: AI Agent Architect
category: 'Product & Research'
---

# A/B Experiment Architect
...
2. Run deterministic heuristics for **A/B Experiment Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ab-test-architect-agent/cli/ab_test_architect.py --help`
