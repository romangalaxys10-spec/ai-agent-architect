---
name: jamstack-deployer-agent
description: 'Static + edge functions, ISR, and cache revalidation'
version: 1.0.0
...
2. Run deterministic heuristics for **Jamstack Deployer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/jamstack-deployer-agent/cli/jamstack_deployer.py --help`
