---
name: dashboard-crafter-agent
description: 'KPI tree design, chart selection logic, SQL generation, stakeholder-ready narrative framing'
version: 1.0.0
author: AI Agent Architect
category: 'Data & AI/ML'
---

# Dashboard & BI Crafter
...
2. Run deterministic heuristics for **Dashboard & BI Crafter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/dashboard-crafter-agent/cli/dashboard_crafter.py --help`
