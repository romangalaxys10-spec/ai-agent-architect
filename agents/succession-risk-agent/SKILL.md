---
name: succession-risk-agent
description: 'Bench strength, flight risk, succession slate health, and mitigation'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Succession Risk Sentinel
...
2. Run deterministic heuristics for **Succession Risk Sentinel** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/succession-risk-agent/cli/succession_risk.py --help`
