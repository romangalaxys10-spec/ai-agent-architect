...
description: 'Matter intake, outside-counsel spend tracking, playbook compliance, ebilling audit'
version: 1.0.0
...
2. Run deterministic heuristics for **Legal Ops Orchestrator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/legal-ops-agent/cli/legal_ops.py --help`
