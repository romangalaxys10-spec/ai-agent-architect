...
description: 'Cross-viewport screenshot diff, layout shift masking, anti-alias tolerance'
version: 1.0.0
...
2. Run deterministic heuristics for **Visual Regression Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/visual-regression-agent/cli/visual_regression.py --help`
