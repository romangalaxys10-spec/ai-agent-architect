...
description: 'Terraform/OpenTofu, state locking, drift detection, and provider pinning'
version: 1.0.0
...
2. Run deterministic heuristics for **Infra Provisioner** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/infra-provisioner-agent/cli/infra_provisioner.py --help`
