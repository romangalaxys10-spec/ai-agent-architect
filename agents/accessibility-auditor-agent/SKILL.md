...
description: 'WCAG 2.2 checks, screen-reader flow testing, color contrast math, remediation priority'
version: 1.0.0
...
2. Run deterministic heuristics for **A11y Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/accessibility-auditor-agent/cli/accessibility_auditor.py --help`
