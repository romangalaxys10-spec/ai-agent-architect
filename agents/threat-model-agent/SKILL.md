...
description: 'STRIDE mapping, attack-tree enumeration, mitigations ranked by risk-to-cost'
version: 1.0.0
...
2. Run deterministic heuristics for **Threat Modeler** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/threat-model-agent/cli/threat_model.py --help`
