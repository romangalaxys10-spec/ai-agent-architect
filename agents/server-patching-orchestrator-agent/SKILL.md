---
name: server-patching-orchestrator-agent
description: 'Patch windows, canary rings, and live kernel patching'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Server Mgmt'
---

# Server Patching Orchestrator
...
2. Run deterministic heuristics for **Server Patching Orchestrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-patching-orchestrator-agent/cli/server_patching_orchestrator.py --help`
