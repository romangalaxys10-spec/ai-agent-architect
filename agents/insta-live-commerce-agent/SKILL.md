---
name: insta-live-commerce-agent
description: 'Live shopping run-of-show, drops, and checkout telemetry'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta Live Commerce** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-live-commerce-agent/cli/insta_live_commerce.py --help`
