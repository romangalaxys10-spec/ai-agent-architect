"""CLI for Policy Drafter — Policy structure generation, control mapping, exception workflow, review cadence design"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Policy Drafter — Policy structure generation, control mapping, exception workflow, review cadence design')
    ...
    from core.policy_drafter_engine import PolicyDrafterEngine
    analysis = PolicyDrafterEngine.analyze(text)
    if args.json:
        ...
        print(PolicyDrafterEngine.format_report(analysis))
