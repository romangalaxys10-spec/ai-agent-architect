---
name: pr-pitch-agent
description: 'Angle generation, journalist-fit scoring, embargo timing, follow-up sequencing'
version: 1.0.0
...
2. Run deterministic heuristics for **PR Pitch Crafter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/pr-pitch-agent/cli/pr_pitch.py --help`
