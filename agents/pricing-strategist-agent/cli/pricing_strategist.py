"""CLI for Pricing Strategist — Willingness-to-pay modeling, packaging tiers, discount guardrails, expansion triggers"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Pricing Strategist — Willingness-to-pay modeling, packaging tiers, discount guardrails, expansion triggers')
    ...
    from core.pricing_strategist_engine import PricingStrategistEngine
    analysis = PricingStrategistEngine.analyze(text)
    if args.json:
        ...
        print(PricingStrategistEngine.format_report(analysis))
