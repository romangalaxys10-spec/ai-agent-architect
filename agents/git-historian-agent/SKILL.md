---
name: git-historian-agent
description: 'Blame forensics, bisect automation, contributor graphs, tech-debt timeline mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Git History Archaeologist** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/git-historian-agent/cli/git_historian.py --help`
