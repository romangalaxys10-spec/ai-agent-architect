...
description: 'Cross-app desktop workflows, window management, dock/taskbar control, and macro recording'
version: 1.0.0
...
2. Run deterministic heuristics for **Desktop Automation Orchestrator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/desktop-automation-agent/cli/desktop_automation.py --help`
