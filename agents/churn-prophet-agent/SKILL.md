---
name: churn-prophet-agent
description: 'Health scoring, leading-indicator ranking, save-play matching, expansion risk flagging'
version: 1.0.0
...
2. Run deterministic heuristics for **Churn Prediction & Save** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/churn-prophet-agent/cli/churn_prophet.py --help`
