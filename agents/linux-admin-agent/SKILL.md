---
name: linux-admin-agent
description: 'User/group/sudo, service (systemd), cron/at, and filesystem (ext4/xfs/btrfs) operations'
version: 1.0.0
...
2. Run deterministic heuristics for **Linux Admin** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-admin-agent/cli/linux_admin.py --help`
