---
name: resilience-burnout-agent
description: 'Burnout signals, workload forensics, recovery sprints, and resilience skills'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Resilience & Burnout Guard
...
2. Run deterministic heuristics for **Resilience & Burnout Guard** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/resilience-burnout-agent/cli/resilience_burnout.py --help`
