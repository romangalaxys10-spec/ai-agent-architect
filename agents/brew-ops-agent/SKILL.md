---
name: brew-ops-agent
description: 'Formula/cask lifecycle, pin, bottle vs source, and cleanup/doctor diagnostics'
version: 1.0.0
...
2. Run deterministic heuristics for **Homebrew Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/brew-ops-agent/cli/brew_ops.py --help`
