---
name: healthcare-scribe-agent
description: 'SOAP note structuring, code suggestion, compliance flagging (not medical advice)'
version: 1.0.0
...
2. Run deterministic heuristics for **Healthcare Scribe** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/healthcare-scribe-agent/cli/healthcare_scribe.py --help`
