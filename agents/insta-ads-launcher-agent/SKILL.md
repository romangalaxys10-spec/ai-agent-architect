---
name: insta-ads-launcher-agent
description: 'Creative variants, audience, placements, and incrementality for IG Ads'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta Ads Launcher** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-ads-launcher-agent/cli/insta_ads_launcher.py --help`
