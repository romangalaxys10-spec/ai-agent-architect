---
name: retail-merchandiser-agent
description: 'Assortment planning, markdown optimization, planogram compliance, sell-through analysis'
version: 1.0.0
...
2. Run deterministic heuristics for **Retail Merchandiser** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/retail-merchandiser-agent/cli/retail_merchandiser.py --help`
