"""CLI for Shell Pilot — POSIX shell orchestration (bash/zsh/fish), prompt detection, and exit-code triage"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Shell Pilot — POSIX shell orchestration (bash/zsh/fish), prompt detection, and exit-code triage")
    ...
    from core.shell_pilot_engine import ShellPilotEngine
    analysis=ShellPilotEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ShellPilotEngine.format_report(analysis))
