"""CLI for Lifecycle Email Architect — Journey mapping, trigger logic, send-time optimization, deliverability linting"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Lifecycle Email Architect — Journey mapping, trigger logic, send-time optimization, deliverability linting')
    ...
    from core.lifecycle_marketer_engine import LifecycleMarketerEngine
    analysis = LifecycleMarketerEngine.analyze(text)
    if args.json:
        ...
        print(LifecycleMarketerEngine.format_report(analysis))
