"""CLI for Threat Modeler — STRIDE mapping, attack-tree enumeration, mitigations ranked by risk-to-cost"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Threat Modeler — STRIDE mapping, attack-tree enumeration, mitigations ranked by risk-to-cost')
    ...
    from core.threat_model_engine import ThreatModelEngine
    analysis = ThreatModelEngine.analyze(text)
    if args.json:
        ...
        print(ThreatModelEngine.format_report(analysis))
