---
name: employer-value-agent
description: 'EVP articulation, employer brand audit, and career site narratives'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Employer Value Architect
...
2. Run deterministic heuristics for **Employer Value Architect** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/employer-value-agent/cli/employer_value.py --help`
