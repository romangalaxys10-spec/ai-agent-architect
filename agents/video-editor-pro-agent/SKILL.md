---
name: video-editor-pro-agent
description: 'Professional timeline editing: cuts, transitions, color grading, and proxy workflows'
version: 1.0.0
...
2. Run deterministic heuristics for **Video Editor Pro** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/video-editor-pro-agent/cli/video_editor_pro.py --help`
