...
description: 'Lighthouse/Web Vitals, CLS/LCP/INP budgets, bundle waterfall, and perf regression gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Web Performance Auditor** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/performance-audit-agent/cli/performance_audit.py --help`
