---
name: linux-dist-upgrade-agent
description: 'In-place upgrades, phased rollouts, and rollback rehearsals'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Linux'
---

# Linux Dist Upgrade Pilot
...
2. Run deterministic heuristics for **Linux Dist Upgrade Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-dist-upgrade-agent/cli/linux_dist_upgrade.py --help`
