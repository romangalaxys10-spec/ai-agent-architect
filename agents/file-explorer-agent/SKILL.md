...
description: 'Finder/Explorer/Nautilus navigation, batch rename, quick-look preview, and breadcrumb forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **File Explorer Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/file-explorer-agent/cli/file_explorer.py --help`
