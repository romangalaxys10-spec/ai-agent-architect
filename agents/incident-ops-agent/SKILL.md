---
name: incident-ops-agent
description: 'On-call handoff, status page, postmortem, and runbook-as-code'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# Incident Ops Commander
...
2. Run deterministic heuristics for **Incident Ops Commander** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/incident-ops-agent/cli/incident_ops.py --help`
