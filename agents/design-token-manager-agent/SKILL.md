---
name: design-token-manager-agent
description: 'Tokens, theming, and Figma Variables sync'
version: 1.0.0
...
2. Run deterministic heuristics for **Design Token Manager** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/design-token-manager-agent/cli/design_token_manager.py --help`
