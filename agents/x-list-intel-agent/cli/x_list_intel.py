"""CLI for X List Intel — List curation, signal vs noise, and DM-able prospect surfacing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="X List Intel — List curation, signal vs noise, and DM-able prospect surfacing")
    ...
    from core.x_list_intel_engine import XListIntelEngine
    analysis=XListIntelEngine.analyze(text)
    if args.json:
        ...
        print(XListIntelEngine.format_report(analysis))
