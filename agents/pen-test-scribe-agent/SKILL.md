---
name: pen-test-scribe-agent
description: 'Finding deduplication, CVSS scoring, evidence packets, remediation roadmaps'
version: 1.0.0
author: AI Agent Architect
category: 'Security & Compliance'
---

# Pen Test Report Scribe
...
2. Run deterministic heuristics for **Pen Test Report Scribe** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/pen-test-scribe-agent/cli/pen_test_scribe.py --help`
