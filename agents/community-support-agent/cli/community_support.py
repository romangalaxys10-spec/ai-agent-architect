"""CLI for Community Support Triage — Forum post classification, crowdsourced answer scoring, escalation to KB creation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Community Support Triage — Forum post classification, crowdsourced answer scoring, escalation to KB creation')
    ...
    from core.community_support_engine import CommunitySupportEngine
    analysis = CommunitySupportEngine.analyze(text)
    if args.json:
        ...
        print(CommunitySupportEngine.format_report(analysis))
