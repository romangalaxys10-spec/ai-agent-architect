...
description: 'Frontend↔API↔DB wiring, env parity, and deploy gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Fullstack Integrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/fullstack-integrator-agent/cli/fullstack_integrator.py --help`
