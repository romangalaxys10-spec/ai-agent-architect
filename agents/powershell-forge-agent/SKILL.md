---
name: powershell-forge-agent
description: 'Module authoring, DSC, remoting (WinRM), and execution policy forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **PowerShell Forge** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/powershell-forge-agent/cli/powershell_forge.py --help`
