---
name: learning-ecosystem-agent
description: 'Ecosystem curation: LMS/LXP, content, cohorts, mentoring, and social'
version: 1.0.0
...
2. Run deterministic heuristics for **Learning Ecosystem Designer** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-ecosystem-agent/cli/learning_ecosystem.py --help`
