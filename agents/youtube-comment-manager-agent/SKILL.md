---
name: youtube-comment-manager-agent
description: 'Pinned comment, heart/reply strategy, and toxic filtering'
version: 1.0.0
...
2. Run deterministic heuristics for **YouTube Comment Manager** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-comment-manager-agent/cli/youtube_comment_manager.py --help`
