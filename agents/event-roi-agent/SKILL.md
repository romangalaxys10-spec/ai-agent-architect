...
description: 'Event cost capture, lead-to-opportunity math, follow-up SLA enforcement, repeat/skip verdict'
version: 1.0.0
...
2. Run deterministic heuristics for **Field & Event ROI Tracker** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/event-roi-agent/cli/event_roi.py --help`
