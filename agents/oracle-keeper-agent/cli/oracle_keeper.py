"""CLI for Oracle Keeper — Price feeds, staleness, and circuit breaker"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Oracle Keeper — Price feeds, staleness, and circuit breaker")
    ...
    from core.oracle_keeper_engine import OracleKeeperEngine
    analysis=OracleKeeperEngine.analyze(text)
    if args.json:
        ...
        print(OracleKeeperEngine.format_report(analysis))
