---
name: perf-lab-agent
description: 'CPU flame graphs, heap profiles, io_uring, and p95 regression gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Perf Lab** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/perf-lab-agent/cli/perf_lab.py --help`
