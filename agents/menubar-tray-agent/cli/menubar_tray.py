"""CLI for Menubar & Tray Governor — Status item orchestration, menu introspection, tray icon health checks"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Menubar & Tray Governor — Status item orchestration, menu introspection, tray icon health checks")
    ...
    from core.menubar_tray_engine import MenubarTrayEngine
    analysis=MenubarTrayEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(MenubarTrayEngine.format_report(analysis))
