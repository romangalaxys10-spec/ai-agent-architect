"""CLI for Content Repurposing Engine — Long-form -> thread/carousel/shorts atomization, platform-native rewriting, CTA tailoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Content Repurposing Engine — Long-form -> thread/carousel/shorts atomization, platform-native rewriting, CTA tailoring')
    ...
    from core.content_repurposer_engine import ContentRepurposerEngine
    analysis = ContentRepurposerEngine.analyze(text)
    if args.json:
        ...
        print(ContentRepurposerEngine.format_report(analysis))
