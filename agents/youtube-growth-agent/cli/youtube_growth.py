"""CLI for YouTube Growth Architect — Title/thumbnail scoring, retention editing, chapter optimization, cross-platform repurposing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='YouTube Growth Architect — Title/thumbnail scoring, retention editing, chapter optimization, cross-platform repurposing')
    ...
    from core.youtube_growth_engine import YoutubeGrowthEngine
    analysis = YoutubeGrowthEngine.analyze(text)
    if args.json:
        ...
        print(YoutubeGrowthEngine.format_report(analysis))
