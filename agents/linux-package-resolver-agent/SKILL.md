---
name: linux-package-resolver-agent
description: 'Dependency hell, holds/pins, and atomic rollback'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Linux'
---

# Linux Package Resolver
...
2. Run deterministic heuristics for **Linux Package Resolver** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-package-resolver-agent/cli/linux_package_resolver.py --help`
