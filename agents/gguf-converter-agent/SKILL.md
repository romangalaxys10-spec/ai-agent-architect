---
name: gguf-converter-agent
description: 'HF → GGUF, vocab, and Metal/CUDA kernel mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **GGUF Converter** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/gguf-converter-agent/cli/gguf_converter.py --help`
