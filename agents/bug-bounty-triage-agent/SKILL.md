---
name: bug-bounty-triage-agent
description: 'Report deduplication, reproducibility checks, severity re-grading, payout band mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Bug Bounty Triage** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/bug-bounty-triage-agent/cli/bug_bounty_triage.py --help`
