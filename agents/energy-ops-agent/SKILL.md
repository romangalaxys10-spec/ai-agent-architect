...
description: 'Load forecasting, tariff optimization, curtailment planning, carbon accounting'
version: 1.0.0
...
2. Run deterministic heuristics for **Energy Ops Analyst** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/energy-ops-agent/cli/energy_ops.py --help`
