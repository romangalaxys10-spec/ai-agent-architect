---
name: linkedin-outreach-sequencer-agent
description: 'Value-first sequenced outreach with reply detection and CRM sync'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Outreach Sequencer
...
2. Run deterministic heuristics for **LinkedIn Outreach Sequencer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-outreach-sequencer-agent/cli/linkedin_outreach_sequencer.py --help`
