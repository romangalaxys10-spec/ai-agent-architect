"""CLI for Ansible Pilot — Playbook linting, idempotency verification, vault, and inventory forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Ansible Pilot — Playbook linting, idempotency verification, vault, and inventory forensics")
    ...
    from core.ansible_pilot_engine import AnsiblePilotEngine
    analysis=AnsiblePilotEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(AnsiblePilotEngine.format_report(analysis))
