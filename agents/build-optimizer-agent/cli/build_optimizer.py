"""CLI for Build & Bundle Optimizer — Bundle-size audit, tree-shake analysis, cache-hit maximization, CI minute reduction"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Build & Bundle Optimizer — Bundle-size audit, tree-shake analysis, cache-hit maximization, CI minute reduction')
    ...
    from core.build_optimizer_engine import BuildOptimizerEngine
    analysis = BuildOptimizerEngine.analyze(text)
    if args.json:
        ...
        print(BuildOptimizerEngine.format_report(analysis))
