---
name: vllm-optimizer-agent
description: 'PagedAttention, continuous batching, and tensor parallel tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **vLLM Optimizer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/vllm-optimizer-agent/cli/vllm_optimizer.py --help`
