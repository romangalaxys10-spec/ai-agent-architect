---
name: browser-pilot-agent
description: 'Tab orchestration, navigation guards, history/cookie/session control, and profile isolation'
version: 1.0.0
...
2. Run deterministic heuristics for **Browser Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/browser-pilot-agent/cli/browser_pilot.py --help`
