---
name: terminal-security-agent
description: 'Shell injection forensics, quoted-arg validation, and paste-jacking guards'
version: 1.0.0
author: AI Agent Architect
category: 'Terminal Use'
---

# Terminal Security Sentinel
...
2. Run deterministic heuristics for **Terminal Security Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/terminal-security-agent/cli/terminal_security.py --help`
