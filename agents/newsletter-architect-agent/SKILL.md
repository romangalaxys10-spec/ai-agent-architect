---
name: newsletter-architect-agent
description: 'Section planning, curation scoring, subject-A/B generation, send-time optimization'
version: 1.0.0
...
2. Run deterministic heuristics for **Newsletter Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/newsletter-architect-agent/cli/newsletter_architect.py --help`
