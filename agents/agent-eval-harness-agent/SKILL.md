---
name: agent-eval-harness-agent
description: 'Trajectory scoring, tool-use accuracy, golden-set curation, pass@k gating'
version: 1.0.0
...
2. Run deterministic heuristics for **Agent Evaluation Harness** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/agent-eval-harness-agent/cli/agent_eval_harness.py --help`
