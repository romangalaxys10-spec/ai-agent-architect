...
description: 'Specs, redlines, and asset slice for dev handoff'
version: 1.0.0
...
2. Run deterministic heuristics for **Design Handoff Orchestrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/design-handoff-agent/cli/design_handoff.py --help`
