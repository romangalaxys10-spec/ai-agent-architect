---
name: future-of-work-architect-agent
description: 'Hybrid/remote, skills-based org, and AI-augmented work design'
version: 1.0.0
...
2. Run deterministic heuristics for **Future of Work Architect** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/future-of-work-architect-agent/cli/future_of_work_architect.py --help`
