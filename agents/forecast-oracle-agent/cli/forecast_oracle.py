"""CLI for Forecasting Oracle — Horizon selection, Prophet/ARIMA-style heuristics, confidence intervals, scenario modeling"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Forecasting Oracle — Horizon selection, Prophet/ARIMA-style heuristics, confidence intervals, scenario modeling')
    ...
    from core.forecast_oracle_engine import ForecastOracleEngine
    analysis = ForecastOracleEngine.analyze(text)
    if args.json:
        ...
        print(ForecastOracleEngine.format_report(analysis))
