---
name: windows-admin-agent
description: 'Registry, services (sc.exe), Task Scheduler, and NTFS/ACL forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Windows Admin** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/windows-admin-agent/cli/windows_admin.py --help`
