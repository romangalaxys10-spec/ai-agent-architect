"""CLI for Web Scraper — Polite crawling, robots.txt respect, anti-bot evasion planning, and dataset diffing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Web Scraper — Polite crawling, robots.txt respect, anti-bot evasion planning, and dataset diffing")
    ...
    from core.web_scraper_engine import WebScraperEngine
    analysis=WebScraperEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(WebScraperEngine.format_report(analysis))
