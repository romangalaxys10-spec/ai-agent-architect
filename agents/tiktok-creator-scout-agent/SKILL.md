---
name: tiktok-creator-scout-agent
description: 'Creator discovery, authenticity, and brief→post tracking'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Creator Scout** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-creator-scout-agent/cli/tiktok_creator_scout.py --help`
