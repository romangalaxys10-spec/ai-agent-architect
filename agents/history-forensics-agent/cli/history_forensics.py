"""CLI for History Forensics — Shell history forensics, deduplication, secret scrubbing, and recall ranking"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="History Forensics — Shell history forensics, deduplication, secret scrubbing, and recall ranking")
    ...
    from core.history_forensics_engine import HistoryForensicsEngine
    analysis=HistoryForensicsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(HistoryForensicsEngine.format_report(analysis))
