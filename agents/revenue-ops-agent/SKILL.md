...
description: 'Funnel stage conversion, forecast hygiene, territory balancing, comp-plan alignment'
version: 1.0.0
...
2. Run deterministic heuristics for **RevOps Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/revenue-ops-agent/cli/revenue_ops.py --help`
