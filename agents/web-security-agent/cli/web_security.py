"""CLI for Web Security Sentinel — CSP/HSTS/XFO audit, mixed-content detection, and SRI/subresource integrity checks"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Web Security Sentinel — CSP/HSTS/XFO audit, mixed-content detection, and SRI/subresource integrity checks")
    ...
    from core.web_security_engine import WebSecurityEngine
    analysis=WebSecurityEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(WebSecurityEngine.format_report(analysis))
