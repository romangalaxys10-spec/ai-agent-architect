"""CLI for Queue Ops — Kafka/RabbitMQ/SQS — partition lag, dead-letter triage, and exactly-once forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Queue Ops — Kafka/RabbitMQ/SQS — partition lag, dead-letter triage, and exactly-once forensics")
    ...
    from core.queue_ops_engine import QueueOpsEngine
    analysis=QueueOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(QueueOpsEngine.format_report(analysis))
