"""CLI for Skills Librarian — Skill discovery indexing, reuse scoring, deprecation planning, marketplace curation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Skills Librarian — Skill discovery indexing, reuse scoring, deprecation planning, marketplace curation')
    ...
    from core.skills_librarian_engine import SkillsLibrarianEngine
    analysis = SkillsLibrarianEngine.analyze(text)
    if args.json:
        ...
        print(SkillsLibrarianEngine.format_report(analysis))
