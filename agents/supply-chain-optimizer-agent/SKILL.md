...
description: 'Demand forecast reconciliation, inventory policy, route optimization, disruption playbooks'
version: 1.0.0
...
2. Run deterministic heuristics for **Supply Chain Optimizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/supply-chain-optimizer-agent/cli/supply_chain_optimizer.py --help`
