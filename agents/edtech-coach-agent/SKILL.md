---
name: edtech-coach-agent
description: 'Curriculum alignment, Bloom-level tagging, assignment feedback scaffolding'
version: 1.0.0
...
2. Run deterministic heuristics for **EdTech Coach** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/edtech-coach-agent/cli/edtech_coach.py --help`
