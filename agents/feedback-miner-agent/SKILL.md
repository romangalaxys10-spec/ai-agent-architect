---
name: feedback-miner-agent
description: 'Support/survey/app-review clustering, theme-to-roadmap linking, fix prioritization'
version: 1.0.0
...
2. Run deterministic heuristics for **Feedback Miner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/feedback-miner-agent/cli/feedback_miner.py --help`
