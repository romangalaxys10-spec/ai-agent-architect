"""CLI for Memory Leak Hunter — Heap dumps, ASAN/Valgrind, and leak triage"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Memory Leak Hunter — Heap dumps, ASAN/Valgrind, and leak triage")
    ...
    from core.memory_leak_hunter_engine import MemoryLeakHunterEngine
    analysis=MemoryLeakHunterEngine.analyze(text)
    if args.json:
        ...
        print(MemoryLeakHunterEngine.format_report(analysis))
