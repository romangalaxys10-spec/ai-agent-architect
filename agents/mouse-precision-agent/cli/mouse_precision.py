"""CLI for Mouse Precision Engine — DPI-aware moves, drag semantics, hover intent, and pixel-perfect assertion"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Mouse Precision Engine — DPI-aware moves, drag semantics, hover intent, and pixel-perfect assertion")
    ...
    from core.mouse_precision_engine import MousePrecisionEngine
    analysis=MousePrecisionEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(MousePrecisionEngine.format_report(analysis))
