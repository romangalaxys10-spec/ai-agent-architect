...
description: 'Vault/1Password/AWS Secrets Manager rotation, lease scoping, and break-glass drills'
version: 1.0.0
...
2. Run deterministic heuristics for **Secrets Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/secrets-ops-agent/cli/secrets_ops.py --help`
