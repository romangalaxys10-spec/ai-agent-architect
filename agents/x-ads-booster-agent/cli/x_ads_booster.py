"""CLI for X Ads Booster — Creative fatigue, bid, audience, and brand-safety for X Ads"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="X Ads Booster — Creative fatigue, bid, audience, and brand-safety for X Ads")
    ...
    from core.x_ads_booster_engine import XAdsBoosterEngine
    analysis=XAdsBoosterEngine.analyze(text)
    if args.json:
        ...
        print(XAdsBoosterEngine.format_report(analysis))
