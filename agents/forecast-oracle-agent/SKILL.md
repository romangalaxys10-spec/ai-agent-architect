---
name: forecast-oracle-agent
description: 'Horizon selection, Prophet/ARIMA-style heuristics, confidence intervals, scenario modeling'
version: 1.0.0
...
2. Run deterministic heuristics for **Forecasting Oracle** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/forecast-oracle-agent/cli/forecast_oracle.py --help`
