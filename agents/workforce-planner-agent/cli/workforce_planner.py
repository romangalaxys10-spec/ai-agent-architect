"""CLI for Workforce Planner — Capacity modeling, hiring plan phasing, attrition risk flags, org design options"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Workforce Planner — Capacity modeling, hiring plan phasing, attrition risk flags, org design options')
    ...
    from core.workforce_planner_engine import WorkforcePlannerEngine
    analysis = WorkforcePlannerEngine.analyze(text)
    if args.json:
        ...
        print(WorkforcePlannerEngine.format_report(analysis))
