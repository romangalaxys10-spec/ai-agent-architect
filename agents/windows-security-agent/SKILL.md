...
description: 'Defender, AppLocker/WDAC, Credential Guard, and event log forensics'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# Windows Security Sentinel
...
2. Run deterministic heuristics for **Windows Security Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/windows-security-agent/cli/windows_security.py --help`
