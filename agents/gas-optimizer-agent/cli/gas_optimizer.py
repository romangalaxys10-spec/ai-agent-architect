"""CLI for Gas Optimizer — Gas profiling, calldata packing, and batch strategy"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Gas Optimizer — Gas profiling, calldata packing, and batch strategy")
    ...
    from core.gas_optimizer_engine import GasOptimizerEngine
    analysis=GasOptimizerEngine.analyze(text)
    if args.json:
        ...
        print(GasOptimizerEngine.format_report(analysis))
