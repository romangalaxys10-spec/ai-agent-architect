"""CLI for Identity Governance Sentinel — SoD conflict detection, certification campaign planning, orphaned account hunting"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Identity Governance Sentinel — SoD conflict detection, certification campaign planning, orphaned account hunting')
    ...
    analysis = IdentityGovernanceEngine.analyze(text)
    if args.json:
        ...
        print(IdentityGovernanceEngine.format_report(analysis))
