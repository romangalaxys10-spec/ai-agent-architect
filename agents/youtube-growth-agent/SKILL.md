...
description: 'Title/thumbnail scoring, retention editing, chapter optimization, cross-platform repurposing'
version: 1.0.0
...
2. Run deterministic heuristics for **YouTube Growth Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-growth-agent/cli/youtube_growth.py --help`
