---
name: houdini-fx-agent
description: 'Houdini procedural FX with VEX, Karma, and USD pipelines'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# Houdini FX Architect
...
2. Run deterministic heuristics for **Houdini FX Architect** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/houdini-fx-agent/cli/houdini_fx.py --help`
