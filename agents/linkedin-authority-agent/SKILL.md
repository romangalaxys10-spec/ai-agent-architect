---
name: linkedin-authority-agent
description: 'POV extraction from commits, carousel outlining, comment-to-DM funnel, SSI scoring'
version: 1.0.0
...
2. Run deterministic heuristics for **LinkedIn Authority Builder** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-authority-agent/cli/linkedin_authority.py --help`
