---
name: experiment-tracker-agent
description: 'Run comparison matrices, hyperparam importance, early-stopping verdicts, reproducibility checklists'
version: 1.0.0
author: AI Agent Architect
category: 'Data & AI/ML'
---

# Experiment Tracker & Comparator
...
2. Run deterministic heuristics for **Experiment Tracker & Comparator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/experiment-tracker-agent/cli/experiment_tracker.py --help`
