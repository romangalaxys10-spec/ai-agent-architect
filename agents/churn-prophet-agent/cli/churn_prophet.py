"""CLI for Churn Prediction & Save — Health scoring, leading-indicator ranking, save-play matching, expansion risk flagging"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Churn Prediction & Save — Health scoring, leading-indicator ranking, save-play matching, expansion risk flagging')
    ...
    from core.churn_prophet_engine import ChurnProphetEngine
    analysis = ChurnProphetEngine.analyze(text)
    if args.json:
        ...
        print(ChurnProphetEngine.format_report(analysis))
