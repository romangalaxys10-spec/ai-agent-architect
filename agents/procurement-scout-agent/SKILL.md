---
name: procurement-scout-agent
description: 'Vendor comparison matrices, TCO modeling, negotiation leverage mapping, renewal risk flags'
version: 1.0.0
...
2. Run deterministic heuristics for **Procurement Scout** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/procurement-scout-agent/cli/procurement_scout.py --help`
