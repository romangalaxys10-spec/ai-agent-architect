---
name: learning-roi-agent
description: 'Phillips ROI: cost capture, monetized benefits, and ROI/story for CFO'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Learning ROI Forecaster
...
2. Run deterministic heuristics for **Learning ROI Forecaster** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-roi-agent/cli/learning_roi.py --help`
