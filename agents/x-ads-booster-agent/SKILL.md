---
name: x-ads-booster-agent
description: 'Creative fatigue, bid, audience, and brand-safety for X Ads'
version: 1.0.0
...
2. Run deterministic heuristics for **X Ads Booster** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-ads-booster-agent/cli/x_ads_booster.py --help`
