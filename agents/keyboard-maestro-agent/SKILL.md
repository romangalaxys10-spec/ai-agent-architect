---
name: keyboard-maestro-agent
description: 'Hotkey choreography, chord sequencing, input method switching, and shortcut conflict resolution'
version: 1.0.0
...
2. Run deterministic heuristics for **Keyboard Maestro** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/keyboard-maestro-agent/cli/keyboard_maestro.py --help`
