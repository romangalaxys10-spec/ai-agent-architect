---
name: spotlight-search-agent
description: 'Indexed search, intent disambiguation, quick-open ranking, and recent-items forensics'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Spotlight & Search Pilot
...
2. Run deterministic heuristics for **Spotlight & Search Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/spotlight-search-agent/cli/spotlight_search.py --help`
