---
name: accessibility-web-agent
description: 'axe-core style audits, keyboard trap detection, color contrast, and screen-reader order'
version: 1.0.0
...
2. Run deterministic heuristics for **Web A11y Auditor** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/accessibility-web-agent/cli/accessibility_web.py --help`
