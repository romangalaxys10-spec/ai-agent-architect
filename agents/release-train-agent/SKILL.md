---
name: release-train-agent
description: 'Cut branches, changelog collation, semver enforcement, rollout & feature-flag coordination'
version: 1.0.0
...
2. Run deterministic heuristics for **Release Orchestrator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/release-train-agent/cli/release_train.py --help`
