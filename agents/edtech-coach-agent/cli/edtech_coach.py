"""CLI for EdTech Coach — Curriculum alignment, Bloom-level tagging, assignment feedback scaffolding"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='EdTech Coach — Curriculum alignment, Bloom-level tagging, assignment feedback scaffolding')
    ...
    from core.edtech_coach_engine import EdtechCoachEngine
    analysis = EdtechCoachEngine.analyze(text)
    if args.json:
        ...
        print(EdtechCoachEngine.format_report(analysis))
