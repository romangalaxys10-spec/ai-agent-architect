---
name: linkedin-company-page-agent
description: 'Page admin, showcase pages, employee advocacy, and analytics rollup'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Company Page Pilot
...
2. Run deterministic heuristics for **LinkedIn Company Page Pilot** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-company-page-agent/cli/linkedin_company_page.py --help`
