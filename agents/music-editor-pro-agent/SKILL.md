---
name: music-editor-pro-agent
description: 'DAW editing with comping, elastic audio, and mix prep'
version: 1.0.0
...
2. Run deterministic heuristics for **Music Editor Pro** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/music-editor-pro-agent/cli/music_editor_pro.py --help`
