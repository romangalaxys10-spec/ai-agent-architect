---
name: 3d-texturing-agent
description: 'UV unwrapping, PBR texturing with Substance, and bake hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# 3D Texturing Sentinel
...
2. Run deterministic heuristics for **3D Texturing Sentinel** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/3d-texturing-agent/cli/m_3d_texturing.py --help`
