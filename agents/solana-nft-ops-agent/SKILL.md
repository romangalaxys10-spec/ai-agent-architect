---
name: solana-nft-ops-agent
description: 'cNFT / Core, collection ops, and marketplace indexing'
version: 1.0.0
...
2. Run deterministic heuristics for **Solana NFT Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-nft-ops-agent/cli/solana_nft_ops.py --help`
