---
name: transformation-lead-agent
description: 'HR operating model & digital transformation roadmaps with maturity staging'
version: 1.0.0
...
2. Run deterministic heuristics for **HR Transformation Lead** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/transformation-lead-agent/cli/transformation_lead.py --help`
