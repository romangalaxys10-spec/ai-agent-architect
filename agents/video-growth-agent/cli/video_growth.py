"""CLI for Video Growth Strategist — Hook scoring, retention-curve analysis, thumbnail/title A/B planning, platform cutdowns"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Video Growth Strategist — Hook scoring, retention-curve analysis, thumbnail/title A/B planning, platform cutdowns')
    ...
    from core.video_growth_engine import VideoGrowthEngine
    analysis = VideoGrowthEngine.analyze(text)
    if args.json:
        ...
        print(VideoGrowthEngine.format_report(analysis))
