"""CLI for Xcode Ops — xcodebuild, simulators, provisioning, notarization, and SPM resolution"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Xcode Ops — xcodebuild, simulators, provisioning, notarization, and SPM resolution")
    ...
    from core.xcode_ops_engine import XcodeOpsEngine
    analysis=XcodeOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(XcodeOpsEngine.format_report(analysis))
