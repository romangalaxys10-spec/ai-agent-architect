...
description: 'Forum post classification, crowdsourced answer scoring, escalation to KB creation'
version: 1.0.0
...
2. Run deterministic heuristics for **Community Support Triage** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/community-support-agent/cli/community_support.py --help`
