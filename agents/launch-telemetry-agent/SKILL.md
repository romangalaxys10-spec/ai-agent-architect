...
description: 'Pre/post metric deltas, sentiment shift, source attribution, repeat-launch playbook'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Launch Telemetry Tracker
...
2. Run deterministic heuristics for **Launch Telemetry Tracker** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/launch-telemetry-agent/cli/launch_telemetry.py --help`
