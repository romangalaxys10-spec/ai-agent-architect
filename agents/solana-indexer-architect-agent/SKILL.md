---
name: solana-indexer-architect-agent
description: 'Indexer design, account filters, Carbon/Vixen decoding, and backfill'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Solana'
---

# Solana Indexer Architect
...
2. Run deterministic heuristics for **Solana Indexer Architect** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-indexer-architect-agent/cli/solana_indexer_architect.py --help`
