"""CLI for Agent Cost Optimizer — Token/latency Pareto frontier, model routing policy, cache-hit maximization"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Agent Cost Optimizer — Token/latency Pareto frontier, model routing policy, cache-hit maximization')
    ...
    from core.cost_optimizer_engine import CostOptimizerEngine
    analysis = CostOptimizerEngine.analyze(text)
    if args.json:
        ...
        print(CostOptimizerEngine.format_report(analysis))
