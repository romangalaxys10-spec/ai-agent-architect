---
name: supply-chain-guard-agent
description: 'Dependency provenance, sigstore verification, typosquat detection, SBOM diffing'
version: 1.0.0
...
2. Run deterministic heuristics for **Supply-Chain Guardian** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/supply-chain-guard-agent/cli/supply_chain_guard.py --help`
