---
name: premiere-workflow-agent
description: 'Premiere Pro project, bins, proxies, and Media Encoder pipelines'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# Premiere Workflow Pilot
...
2. Run deterministic heuristics for **Premiere Workflow Pilot** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/premiere-workflow-agent/cli/premiere_workflow.py --help`
