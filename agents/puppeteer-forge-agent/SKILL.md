---
name: puppeteer-forge-agent
description: 'Headless Chromium control, PDF/screenshot pipelines, and request interception'
version: 1.0.0
...
2. Run deterministic heuristics for **Puppeteer Forge** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/puppeteer-forge-agent/cli/puppeteer_forge.py --help`
