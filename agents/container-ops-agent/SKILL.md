---
name: container-ops-agent
description: 'Docker/Podman, cgroups, overlayfs, rootless, and image provenance (cosign)'
version: 1.0.0
...
2. Run deterministic heuristics for **Container Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/container-ops-agent/cli/container_ops.py --help`
