...
description: 'Org chart mapping, whitespace analysis, multi-threading plan, executive briefing pack'
version: 1.0.0
...
2. Run deterministic heuristics for **Strategic Account Planner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/account-plan-agent/cli/account_plan.py --help`
