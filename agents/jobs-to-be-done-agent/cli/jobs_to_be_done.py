"""CLI for JTBD Mapper — Job statement extraction, switch-moment mapping, competing-solution analysis"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='JTBD Mapper — Job statement extraction, switch-moment mapping, competing-solution analysis')
    ...
    from core.jobs_to_be_done_engine import JobsToBeDoneEngine
    analysis = JobsToBeDoneEngine.analyze(text)
    if args.json:
        ...
        print(JobsToBeDoneEngine.format_report(analysis))
