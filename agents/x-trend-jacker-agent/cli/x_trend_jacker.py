"""CLI for X Trend Jacker — Trend velocity, angle fit, and safe trend-jacking timing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="X Trend Jacker — Trend velocity, angle fit, and safe trend-jacking timing")
    ...
    from core.x_trend_jacker_engine import XTrendJackerEngine
    analysis=XTrendJackerEngine.analyze(text)
    if args.json:
        ...
        print(XTrendJackerEngine.format_report(analysis))
