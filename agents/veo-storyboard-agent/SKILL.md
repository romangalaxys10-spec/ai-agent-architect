---
name: veo-storyboard-agent
description: 'Veo 3 prompts, camera moves, and continuity guards'
version: 1.0.0
author: AI Agent Architect
category: 'Video: Freebie + Gemini'
---

# Veo Storyboard Architect
...
2. Run deterministic heuristics for **Veo Storyboard Architect** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/veo-storyboard-agent/cli/veo_storyboard.py --help`
