---
name: skills-ontology-agent
description: 'Skills taxonomy/ontology design, dedup, proficiency scales, and inference'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Skills Ontology Architect
...
2. Run deterministic heuristics for **Skills Ontology Architect** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/skills-ontology-agent/cli/skills_ontology.py --help`
