---
name: qa-oracle-agent
description: 'Test plan matrices, edge-case enumeration, risk-based test prioritization, flaky test triage'
version: 1.0.0
...
2. Run deterministic heuristics for **QA & Test Strategy** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/qa-oracle-agent/cli/qa_oracle.py --help`
