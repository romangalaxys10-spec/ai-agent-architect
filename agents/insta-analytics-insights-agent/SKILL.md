---
name: insta-analytics-insights-agent
description: 'Reach/saves/shares, follower activity windows, and content mix audit'
version: 1.0.0
author: AI Agent Architect
category: 'Social: Instagram'
---

# Insta Analytics Insights
...
2. Run deterministic heuristics for **Insta Analytics Insights** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-analytics-insights-agent/cli/insta_analytics_insights.py --help`
