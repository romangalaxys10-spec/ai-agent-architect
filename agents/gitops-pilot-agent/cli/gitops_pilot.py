"""CLI for GitOps Pilot — ArgoCD/Flux, drift vs desired, sync waves, and progressive delivery analysis"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="GitOps Pilot — ArgoCD/Flux, drift vs desired, sync waves, and progressive delivery analysis")
    ...
    from core.gitops_pilot_engine import GitopsPilotEngine
    analysis=GitopsPilotEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(GitopsPilotEngine.format_report(analysis))
