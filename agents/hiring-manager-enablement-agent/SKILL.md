---
name: hiring-manager-enablement-agent
description: 'Hiring manager intake, calibration, and inclusive interviewing capability'
version: 1.0.0
...
2. Run deterministic heuristics for **Hiring Manager Enablement** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/hiring-manager-enablement-agent/cli/hiring_manager_enablement.py --help`
