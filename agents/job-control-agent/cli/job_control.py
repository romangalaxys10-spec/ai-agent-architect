"""CLI for Job Control Sentinel — Foreground/background, disown/nohup, signal routing, and exit trap cleanup"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Job Control Sentinel — Foreground/background, disown/nohup, signal routing, and exit trap cleanup")
    ...
    from core.job_control_engine import JobControlEngine
    analysis=JobControlEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(JobControlEngine.format_report(analysis))
