"""CLI for Model Risk & Validation — Bias/fairness audits, SHAP-style attribution summaries, challenger-model comparison, MRM reports"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Model Risk & Validation — Bias/fairness audits, SHAP-style attribution summaries, challenger-model comparison, MRM reports')
    ...
    from core.model_risk_engine import ModelRiskEngine
    analysis = ModelRiskEngine.analyze(text)
    if args.json:
        ...
        print(ModelRiskEngine.format_report(analysis))
