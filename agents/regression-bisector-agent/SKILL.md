---
name: regression-bisector-agent
description: 'git bisect, bisection forensics, and fix verification'
version: 1.0.0
...
2. Run deterministic heuristics for **Regression Bisector** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/regression-bisector-agent/cli/regression_bisector.py --help`
