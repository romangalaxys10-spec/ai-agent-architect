---
name: forensics-timeline-agent
description: 'Artifact correlation, chain-of-custody logging, timeline reconstruction'
version: 1.0.0
...
2. Run deterministic heuristics for **Digital Forensics Timeline** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/forensics-timeline-agent/cli/forensics_timeline.py --help`
