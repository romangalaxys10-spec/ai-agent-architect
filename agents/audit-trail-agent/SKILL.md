...
description: 'Evidence packet assembly, control-to-artifact mapping, auditor-ready narratives'
version: 1.0.0
...
2. Run deterministic heuristics for **Audit Trail Assembler** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/audit-trail-agent/cli/audit_trail.py --help`
