---
name: xcode-ops-agent
description: 'xcodebuild, simulators, provisioning, notarization, and SPM resolution'
version: 1.0.0
...
2. Run deterministic heuristics for **Xcode Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/xcode-ops-agent/cli/xcode_ops.py --help`
