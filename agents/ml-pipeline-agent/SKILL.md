...
description: 'Feature store wiring, training DAG authoring, eval gates, model registry lifecycle'
version: 1.0.0
...
2. Run deterministic heuristics for **ML Pipeline Orchestrator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ml-pipeline-agent/cli/ml_pipeline.py --help`
