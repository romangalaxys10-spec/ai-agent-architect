---
name: identity-governance-agent
description: 'SoD conflict detection, certification campaign planning, orphaned account hunting'
version: 1.0.0
author: AI Agent Architect
category: 'Security & Compliance'
---

# Identity Governance Sentinel
...
2. Run deterministic heuristics for **Identity Governance Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/identity-governance-agent/cli/identity_governance.py --help`
