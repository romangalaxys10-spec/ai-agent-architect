---
name: x-spaces-producer-agent
description: 'Spaces agenda, speaker queue, and clip harvesting'
version: 1.0.0
...
2. Run deterministic heuristics for **X Spaces Producer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-spaces-producer-agent/cli/x_spaces_producer.py --help`
