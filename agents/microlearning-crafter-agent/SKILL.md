---
name: microlearning-crafter-agent
description: 'Microlearning & nudges: spacing, retrieval practice, and in-flow performance support'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Microlearning Crafter
...
2. Run deterministic heuristics for **Microlearning Crafter** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/microlearning-crafter-agent/cli/microlearning_crafter.py --help`
