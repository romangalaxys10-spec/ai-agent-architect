...
description: 'Goal cascade, OKR quality, measurability, and vertical/horizontal alignment'
version: 1.0.0
...
2. Run deterministic heuristics for **Goal Alignment Orchestrator** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/goal-alignment-agent/cli/goal_alignment.py --help`
