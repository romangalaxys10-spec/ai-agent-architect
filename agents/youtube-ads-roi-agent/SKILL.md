---
name: youtube-ads-roi-agent
description: 'TrueView, CPM/CPV, view-through, and creative fatigue for YT Ads'
version: 1.0.0
author: AI Agent Architect
category: 'Social: YouTube'
---

# YouTube Ads ROI Tracker
...
2. Run deterministic heuristics for **YouTube Ads ROI Tracker** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-ads-roi-agent/cli/youtube_ads_roi.py --help`
