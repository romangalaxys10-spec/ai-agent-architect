"""CLI for Proposal & RFP Forge — RFP shredding, win-theme mapping, compliance matrix, proposal narrative assembly"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Proposal & RFP Forge — RFP shredding, win-theme mapping, compliance matrix, proposal narrative assembly')
    ...
    from core.proposal_forge_engine import ProposalForgeEngine
    analysis = ProposalForgeEngine.analyze(text)
    if args.json:
        ...
        print(ProposalForgeEngine.format_report(analysis))
