"""CLI for Workflow Miner — Process mining from logs, variant analysis, automation opportunity ranking"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Workflow Miner — Process mining from logs, variant analysis, automation opportunity ranking')
    ...
    from core.workflow_miner_engine import WorkflowMinerEngine
    analysis = WorkflowMinerEngine.analyze(text)
    if args.json:
        ...
        print(WorkflowMinerEngine.format_report(analysis))
