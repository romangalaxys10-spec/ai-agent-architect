---
name: youtube-publisher-agent
description: 'Publish ops: scheduling, premieres, end screens, cards, and rollout'
version: 1.0.0
...
2. Run deterministic heuristics for **YouTube Publisher** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-publisher-agent/cli/youtube_publisher.py --help`
