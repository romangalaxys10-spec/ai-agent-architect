"""CLI for Affiliate Ops Manager — Payout integrity, fraud heuristics, creative freshness scoring, partner tiering"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Affiliate Ops Manager — Payout integrity, fraud heuristics, creative freshness scoring, partner tiering')
    ...
    from core.affiliate_ops_engine import AffiliateOpsEngine
    analysis = AffiliateOpsEngine.analyze(text)
    if args.json:
        ...
        print(AffiliateOpsEngine.format_report(analysis))
