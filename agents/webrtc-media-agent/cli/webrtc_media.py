"""CLI for WebRTC Media Pilot — Peer connection forensics, ICE candidate mapping, bandwidth/echo diagnostics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="WebRTC Media Pilot — Peer connection forensics, ICE candidate mapping, bandwidth/echo diagnostics")
    ...
    from core.webrtc_media_engine import WebrtcMediaEngine
    analysis=WebrtcMediaEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(WebrtcMediaEngine.format_report(analysis))
