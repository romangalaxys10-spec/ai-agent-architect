...
description: 'State-sync design, simulation scenario authoring, drift detection, what-if analysis'
version: 1.0.0
...
2. Run deterministic heuristics for **Digital Twin Orchestrator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/digital-twin-agent/cli/digital_twin.py --help`
