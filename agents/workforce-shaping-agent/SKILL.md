---
name: workforce-shaping-agent
description: 'Scenario-based workforce shaping: demand/supply gaps, build/buy/borrow/bot tradeoffs'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Workforce Shaping Strategist
...
2. Run deterministic heuristics for **Workforce Shaping Strategist** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/workforce-shaping-agent/cli/workforce_shaping.py --help`
