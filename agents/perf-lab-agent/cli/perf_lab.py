"""CLI for Perf Lab — CPU flame graphs, heap profiles, io_uring, and p95 regression gates"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Perf Lab — CPU flame graphs, heap profiles, io_uring, and p95 regression gates")
    ...
    from core.perf_lab_engine import PerfLabEngine
    analysis=PerfLabEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(PerfLabEngine.format_report(analysis))
