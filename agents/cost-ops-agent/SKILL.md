---
name: cost-ops-agent
description: 'Tagging hygiene, idle/oversized detection, reservation modeling, and showback'
version: 1.0.0
...
2. Run deterministic heuristics for **Cost Ops (FinOps)** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/cost-ops-agent/cli/cost_ops.py --help`
