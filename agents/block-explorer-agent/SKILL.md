---
name: block-explorer-agent
description: 'Explorer API, tracing, and label curation'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Blockchain'
---

# Block Explorer Architect
...
2. Run deterministic heuristics for **Block Explorer Architect** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/block-explorer-agent/cli/block_explorer.py --help`
