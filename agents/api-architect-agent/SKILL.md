...
description: 'Designs REST/GraphQL/gRPC APIs with OpenAPI specs, versioning, and contract tests'
version: 1.0.0
author: AI Agent Architect
category: 'Coding & DevOps'
---

# API Design & Spec Generator
...
2. Run deterministic heuristics for **API Design & Spec Generator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/api-architect-agent/cli/api_architect.py --help`
