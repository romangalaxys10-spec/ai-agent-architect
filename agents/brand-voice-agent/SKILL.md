...
description: 'Tone taxonomy enforcement, off-brand flagging, rewrite suggestions with voice preservation'
version: 1.0.0
...
2. Run deterministic heuristics for **Brand Voice Guardian** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/brand-voice-agent/cli/brand_voice.py --help`
