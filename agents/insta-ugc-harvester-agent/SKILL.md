---
name: insta-ugc-harvester-agent
description: 'UGC discovery, rights requests, and repurpose queue'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta UGC Harvester** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-ugc-harvester-agent/cli/insta_ugc_harvester.py --help`
