---
name: youtube-curation-agent
description: 'Channel curation, playlists, community posts, and catalog hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# YouTube Curation Architect
...
2. Run deterministic heuristics for **YouTube Curation Architect** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-curation-agent/cli/youtube_curation.py --help`
