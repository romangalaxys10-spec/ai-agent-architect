---
name: blender-studio-agent
description: 'Blender modeling/sculpting/rigging/rendering with Geometry Nodes and Cycles'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# Blender Studio Pilot
...
2. Run deterministic heuristics for **Blender Studio Pilot** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/blender-studio-agent/cli/blender_studio.py --help`
