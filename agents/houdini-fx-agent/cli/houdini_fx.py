"""CLI for Houdini FX Architect — Houdini procedural FX with VEX, Karma, and USD pipelines"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Houdini FX Architect — Houdini procedural FX with VEX, Karma, and USD pipelines")
    ...
    from core.houdini_fx_engine import HoudiniFxEngine
    analysis=HoudiniFxEngine.analyze(text)
    if args.json:
        ...
        print(HoudiniFxEngine.format_report(analysis))
