---
name: paid-growth-ops-agent
description: 'Channel mix modeling, CAC payback math, creative fatigue rotation, incrementality testing'
version: 1.0.0
...
2. Run deterministic heuristics for **Paid Growth Ops** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/paid-growth-ops-agent/cli/paid_growth_ops.py --help`
