---
name: insta-grid-planner-agent
description: 'Grid aesthetics, color-story, alt-text, and carousel sequencing'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta Grid Planner** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-grid-planner-agent/cli/insta_grid_planner.py --help`
