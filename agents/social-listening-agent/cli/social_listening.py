"""CLI for Social Listening Radar — Mention clustering, sentiment velocity, crisis early-warning, competitor share-of-voice"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Social Listening Radar — Mention clustering, sentiment velocity, crisis early-warning, competitor share-of-voice')
    ...
    from core.social_listening_engine import SocialListeningEngine
    analysis = SocialListeningEngine.analyze(text)
    if args.json:
        ...
        print(SocialListeningEngine.format_report(analysis))
