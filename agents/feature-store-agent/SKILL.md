...
description: 'Feature drift detection, leakage checks, importance ranking, store backfill plans'
version: 1.0.0
author: AI Agent Architect
category: 'Data & AI/ML'
---

# Feature Engineering Sentinel
...
2. Run deterministic heuristics for **Feature Engineering Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/feature-store-agent/cli/feature_store.py --help`
