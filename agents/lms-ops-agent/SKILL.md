---
name: lms-ops-agent
description: 'LMS/LXP ops: catalog hygiene, assignments, compliance tracking, and integrations'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# LMS/LXP Ops Commander
...
2. Run deterministic heuristics for **LMS/LXP Ops Commander** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/lms-ops-agent/cli/lms_ops.py --help`
