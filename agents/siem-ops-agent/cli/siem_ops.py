"""CLI for SIEM Ops — Log pipeline, detection-as-code, and false-positive tuning"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="SIEM Ops — Log pipeline, detection-as-code, and false-positive tuning")
    ...
    from core.siem_ops_engine import SiemOpsEngine
    analysis=SiemOpsEngine.analyze(text)
    if args.json:
        ...
        print(SiemOpsEngine.format_report(analysis))
