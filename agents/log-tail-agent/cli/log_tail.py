"""CLI for Log Tail & Watch — Follow-mode, ANSI stripping, pattern alerting, and backpressure handling"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Log Tail & Watch — Follow-mode, ANSI stripping, pattern alerting, and backpressure handling")
    ...
    from core.log_tail_engine import LogTailEngine
    analysis=LogTailEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(LogTailEngine.format_report(analysis))
