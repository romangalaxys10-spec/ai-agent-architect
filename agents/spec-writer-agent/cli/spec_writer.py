"""CLI for PRD Spec Writer — Requirement decomposition, acceptance criteria authoring, edge-case enumeration, open-question tracking"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='PRD Spec Writer — Requirement decomposition, acceptance criteria authoring, edge-case enumeration, open-question tracking')
    ...
    from core.spec_writer_engine import SpecWriterEngine
    analysis = SpecWriterEngine.analyze(text)
    if args.json:
        ...
        print(SpecWriterEngine.format_report(analysis))
