"""CLI for Manager Coach — 1:1 agenda generation, coaching prompt synthesis, team health diagnostics"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Manager Coach — 1:1 agenda generation, coaching prompt synthesis, team health diagnostics')
    ...
    from core.manager_coach_engine import ManagerCoachEngine
    analysis = ManagerCoachEngine.analyze(text)
    if args.json:
        ...
        print(ManagerCoachEngine.format_report(analysis))
