...
description: 'Obligation extraction, renewal/deadline tracking, clause deviation flagging'
version: 1.0.0
...
2. Run deterministic heuristics for **Contract Lifecycle Manager** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/contract-lifecycle-agent/cli/contract_lifecycle.py --help`
