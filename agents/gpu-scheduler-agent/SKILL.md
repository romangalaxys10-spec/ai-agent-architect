...
description: 'CUDA/MPS, VRAM bin-packing, and preemption for LLM'
version: 1.0.0
...
2. Run deterministic heuristics for **GPU Scheduler** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/gpu-scheduler-agent/cli/gpu_scheduler.py --help`
