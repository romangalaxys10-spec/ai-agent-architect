...
description: 'Kafka/RabbitMQ/SQS — partition lag, dead-letter triage, and exactly-once forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Queue Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/queue-ops-agent/cli/queue_ops.py --help`
