---
name: tiktok-script-lab-agent
description: '3-sec hook, pattern interrupts, and CTA tailoring'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Script Lab** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-script-lab-agent/cli/tiktok_script_lab.py --help`
