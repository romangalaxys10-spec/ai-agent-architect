---
name: window-tiling-agent
description: 'Tiling layout synthesis, focus follows mouse, workspace assignment, and multi-monitor mapping'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Window Tiling Architect
...
2. Run deterministic heuristics for **Window Tiling Architect** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/window-tiling-agent/cli/window_tiling.py --help`
