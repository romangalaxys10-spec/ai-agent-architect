---
name: gemini-thumbnail-gen-agent
description: 'Gemini/Imagen thumbnail prompts, text sparsity, and CTR hypothesis'
version: 1.0.0
author: AI Agent Architect
category: 'Video: Freebie + Gemini'
---

# Gemini Thumbnail Gen
...
2. Run deterministic heuristics for **Gemini Thumbnail Gen** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/gemini-thumbnail-gen-agent/cli/gemini_thumbnail_gen.py --help`
