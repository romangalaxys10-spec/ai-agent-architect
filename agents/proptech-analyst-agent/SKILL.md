---
name: proptech-analyst-agent
description: 'Rent-roll parsing, valuation sensitivity, zoning flag checks, investment memo drafting'
version: 1.0.0
...
2. Run deterministic heuristics for **PropTech Analyst** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/proptech-analyst-agent/cli/proptech_analyst.py --help`
