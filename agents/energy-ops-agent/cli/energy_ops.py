"""CLI for Energy Ops Analyst — Load forecasting, tariff optimization, curtailment planning, carbon accounting"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Energy Ops Analyst — Load forecasting, tariff optimization, curtailment planning, carbon accounting')
    ...
    from core.energy_ops_engine import EnergyOpsEngine
    analysis = EnergyOpsEngine.analyze(text)
    if args.json:
        ...
        print(EnergyOpsEngine.format_report(analysis))
