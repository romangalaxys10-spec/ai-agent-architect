---
name: x-toxicity-shield-agent
description: 'Harassment, dogpiling, and shadow-ban risk detection'
version: 1.0.0
...
2. Run deterministic heuristics for **X Toxicity Shield** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-toxicity-shield-agent/cli/x_toxicity_shield.py --help`
