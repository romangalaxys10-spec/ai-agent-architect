---
name: heap-dump-analyzer-agent
description: 'Heap histogram, dominator tree, and leak suspects'
version: 1.0.0
...
2. Run deterministic heuristics for **Heap Dump Analyzer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/heap-dump-analyzer-agent/cli/heap_dump_analyzer.py --help`
