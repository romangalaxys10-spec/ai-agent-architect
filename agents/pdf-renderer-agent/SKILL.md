---
name: pdf-renderer-agent
description: 'HTML→PDF fidelity, print media CSS, pagination orphans, and PDF/A validation'
version: 1.0.0
...
2. Run deterministic heuristics for **PDF Renderer** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/pdf-renderer-agent/cli/pdf_renderer.py --help`
