"""CLI for Keybinding Doctor — Readline/editing mode, keymap conflict resolution, and latency-to-action tracing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Keybinding Doctor — Readline/editing mode, keymap conflict resolution, and latency-to-action tracing")
    ...
    from core.keybinding_doctor_engine import KeybindingDoctorEngine
    analysis=KeybindingDoctorEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(KeybindingDoctorEngine.format_report(analysis))
