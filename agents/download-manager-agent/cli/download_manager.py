"""CLI for Download Manager — Download orchestration, virus-scan hooks, checksum verification, and resume safety"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Download Manager — Download orchestration, virus-scan hooks, checksum verification, and resume safety")
    ...
    from core.download_manager_engine import DownloadManagerEngine
    analysis=DownloadManagerEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(DownloadManagerEngine.format_report(analysis))
