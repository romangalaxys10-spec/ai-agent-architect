...
description: 'Cash positioning, bank fee audit, FX exposure flagging, liquidity runway math'
version: 1.0.0
author: AI Agent Architect
category: 'Ops, Finance & Legal'
---

# Treasury Ops Sentinel
...
2. Run deterministic heuristics for **Treasury Ops Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/treasury-ops-agent/cli/treasury_ops.py --help`
