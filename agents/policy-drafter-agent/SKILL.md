---
name: policy-drafter-agent
description: 'Policy structure generation, control mapping, exception workflow, review cadence design'
version: 1.0.0
...
2. Run deterministic heuristics for **Policy Drafter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/policy-drafter-agent/cli/policy_drafter.py --help`
