---
name: partner-ecosystem-agent
description: 'Partner-fit scoring, co-sell motion design, referral tracking, enablement gap analysis'
version: 1.0.0
...
2. Run deterministic heuristics for **Partner Ecosystem Scout** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/partner-ecosystem-agent/cli/partner_ecosystem.py --help`
