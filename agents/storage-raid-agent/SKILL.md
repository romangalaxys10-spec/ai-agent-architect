---
name: storage-raid-agent
description: 'RAID/LVM/ZFS/btrfs, fstab, mount guards, and SMART failure prediction'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# Storage & RAID Architect
...
2. Run deterministic heuristics for **Storage & RAID Architect** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/storage-raid-agent/cli/storage_raid.py --help`
