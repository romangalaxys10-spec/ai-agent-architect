...
description: 'Composition with MIDI, arrangement, theory, and score export'
version: 1.0.0
...
2. Run deterministic heuristics for **Music Composer** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/music-composer-agent/cli/music_composer.py --help`
