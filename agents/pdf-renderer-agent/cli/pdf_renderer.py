"""CLI for PDF Renderer — HTML→PDF fidelity, print media CSS, pagination orphans, and PDF/A validation"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="PDF Renderer — HTML→PDF fidelity, print media CSS, pagination orphans, and PDF/A validation")
    ...
    from core.pdf_renderer_engine import PdfRendererEngine
    analysis=PdfRendererEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(PdfRendererEngine.format_report(analysis))
