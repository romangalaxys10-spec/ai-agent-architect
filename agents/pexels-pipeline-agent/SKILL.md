---
name: pexels-pipeline-agent
description: 'Pexels API search, pagination, download, and attribution assembly'
version: 1.0.0
...
2. Run deterministic heuristics for **Pexels Pipeline** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/pexels-pipeline-agent/cli/pexels_pipeline.py --help`
