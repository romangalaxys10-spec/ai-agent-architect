"""CLI for Vendor Risk Assessor — Risk tiering, questionnaire gap analysis, mitigation plan generation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Vendor Risk Assessor — Risk tiering, questionnaire gap analysis, mitigation plan generation')
    ...
    analysis = VendorRiskEngine.analyze(text)
    if args.json:
        ...
        print(VendorRiskEngine.format_report(analysis))
