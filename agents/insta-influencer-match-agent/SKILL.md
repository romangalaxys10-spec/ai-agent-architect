---
name: insta-influencer-match-agent
description: 'Audience overlap, fake-follower audit, and brief→deliverable tracking'
version: 1.0.0
author: AI Agent Architect
category: 'Social: Instagram'
---

# Insta Influencer Matcher
...
2. Run deterministic heuristics for **Insta Influencer Matcher** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-influencer-match-agent/cli/insta_influencer_match.py --help`
