---
name: shell-pilot-agent
description: 'POSIX shell orchestration (bash/zsh/fish), prompt detection, and exit-code triage'
version: 1.0.0
...
2. Run deterministic heuristics for **Shell Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/shell-pilot-agent/cli/shell_pilot.py --help`
