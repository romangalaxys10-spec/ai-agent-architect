"""CLI for Vuln Triage Sentinel — CVE intake, EPSS, and patch priority with SLAs"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Vuln Triage Sentinel — CVE intake, EPSS, and patch priority with SLAs")
    ...
    from core.vuln_triage_engine import VulnTriageEngine
    analysis=VulnTriageEngine.analyze(text)
    if args.json:
        ...
        print(VulnTriageEngine.format_report(analysis))
