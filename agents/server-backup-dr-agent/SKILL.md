---
name: server-backup-dr-agent
description: 'Bare-metal backup, pilot-light DR, and restore drills'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Server Mgmt'
---

# Server Backup & DR Orchestrator
...
2. Run deterministic heuristics for **Server Backup & DR Orchestrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-backup-dr-agent/cli/server_backup_dr.py --help`
