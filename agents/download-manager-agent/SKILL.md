---
name: download-manager-agent
description: 'Download orchestration, virus-scan hooks, checksum verification, and resume safety'
version: 1.0.0
...
2. Run deterministic heuristics for **Download Manager** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/download-manager-agent/cli/download_manager.py --help`
