...
description: 'HR→business OKR cascade, strategy translation, and quarterly business review narratives'
version: 1.0.0
...
2. Run deterministic heuristics for **Business Alignment Engine** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/business-alignment-agent/cli/business_alignment.py --help`
