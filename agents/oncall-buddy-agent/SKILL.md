---
name: oncall-buddy-agent
description: 'Runbook retrieval, escalation routing, post-page context assembly, handoff summaries'
version: 1.0.0
...
2. Run deterministic heuristics for **On-Call Companion** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/oncall-buddy-agent/cli/oncall_buddy.py --help`
