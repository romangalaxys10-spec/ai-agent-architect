---
name: perf-surgeon-agent
description: 'Bottleneck detection, flame-graph interpretation, latency budgets, and perf regression gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Performance Profiler & Optimizer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/perf-surgeon-agent/cli/perf_surgeon.py --help`
