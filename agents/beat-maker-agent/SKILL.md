---
name: beat-maker-agent
description: 'Beat construction with 808s, drum machines, and swing/groove'
version: 1.0.0
...
2. Run deterministic heuristics for **Beat Maker** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/beat-maker-agent/cli/beat_maker.py --help`
