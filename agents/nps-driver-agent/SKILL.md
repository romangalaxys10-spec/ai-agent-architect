---
name: nps-driver-agent
description: 'Promoter/passive/detractor drivers, closed-loop prioritization, exec narrative'
version: 1.0.0
...
2. Run deterministic heuristics for **NPS Driver Analyst** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/nps-driver-agent/cli/nps_driver.py --help`
