---
name: subtitle-auto-agent
description: 'Whisper-style timing, speaker diarization, and SRT/VTT export'
version: 1.0.0
...
2. Run deterministic heuristics for **Subtitle Auto Generator** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/subtitle-auto-agent/cli/subtitle_auto.py --help`
