---
name: internal-mobility-marketplace-agent
description: 'Internal talent marketplace: skills inference, matching, and career nudges'
version: 1.0.0
...
2. Run deterministic heuristics for **Internal Mobility Marketplace** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/internal-mobility-marketplace-agent/cli/internal_mobility_marketplace.py --help`
