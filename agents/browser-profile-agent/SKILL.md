---
name: browser-profile-agent
description: 'Profile cloning, fingerprint hygiene, proxy rotation, and container isolation'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Browser Profile Steward
...
2. Run deterministic heuristics for **Browser Profile Steward** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/browser-profile-agent/cli/browser_profile.py --help`
