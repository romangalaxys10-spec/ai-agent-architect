"""CLI for Self-Serve Architect — Deflection opportunity scoring, flow design, containment rate tracking"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Self-Serve Architect — Deflection opportunity scoring, flow design, containment rate tracking')
    ...
    from core.self_serve_architect_engine import SelfServeArchitectEngine
    analysis = SelfServeArchitectEngine.analyze(text)
    if args.json:
        ...
        print(SelfServeArchitectEngine.format_report(analysis))
