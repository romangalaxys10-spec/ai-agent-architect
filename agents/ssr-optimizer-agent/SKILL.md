---
name: ssr-optimizer-agent
description: 'SSR/SSG/CSR tradeoffs, hydration, and streaming'
version: 1.0.0
...
2. Run deterministic heuristics for **SSR Optimizer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/ssr-optimizer-agent/cli/ssr_optimizer.py --help`
