---
name: solana-staking-governance-agent
description: 'Stake pools, delegation, and Realms/Squads governance flows'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Solana'
---

# Solana Staking & Governance
...
2. Run deterministic heuristics for **Solana Staking & Governance** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-staking-governance-agent/cli/solana_staking_governance.py --help`
