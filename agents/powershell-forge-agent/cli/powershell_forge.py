"""CLI for PowerShell Forge — Module authoring, DSC, remoting (WinRM), and execution policy forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="PowerShell Forge — Module authoring, DSC, remoting (WinRM), and execution policy forensics")
    ...
    from core.powershell_forge_engine import PowershellForgeEngine
    analysis=PowershellForgeEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(PowershellForgeEngine.format_report(analysis))
