"""CLI for Nonprofit Impact Tracker — Theory-of-change mapping, outcome metric design, grant reporting packet assembly"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Nonprofit Impact Tracker — Theory-of-change mapping, outcome metric design, grant reporting packet assembly')
    ...
    from core.nonprofit_impact_engine import NonprofitImpactEngine
    analysis = NonprofitImpactEngine.analyze(text)
    if args.json:
        ...
        print(NonprofitImpactEngine.format_report(analysis))
