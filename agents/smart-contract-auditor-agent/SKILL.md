...
description: 'Slither/Mythril-style checks, access control, and reentrancy triage'
version: 1.0.0
...
2. Run deterministic heuristics for **Smart Contract Auditor** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/smart-contract-auditor-agent/cli/smart_contract_auditor.py --help`
