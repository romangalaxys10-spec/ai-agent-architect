"""CLI for Conversation Intelligence Miner — Call transcript themes, competitor mention tracking, coaching moment extraction"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Conversation Intelligence Miner — Call transcript themes, competitor mention tracking, coaching moment extraction')
    ...
    from core.gong_clone_engine import GongCloneEngine
    analysis = GongCloneEngine.analyze(text)
    if args.json:
        ...
        print(GongCloneEngine.format_report(analysis))
