"""CLI for Retail Merchandiser — Assortment planning, markdown optimization, planogram compliance, sell-through analysis"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Retail Merchandiser — Assortment planning, markdown optimization, planogram compliance, sell-through analysis')
    ...
    from core.retail_merchandiser_engine import RetailMerchandiserEngine
    analysis = RetailMerchandiserEngine.analyze(text)
    if args.json:
        ...
        print(RetailMerchandiserEngine.format_report(analysis))
