---
name: server-dns-ops-agent
description: '权威 DNS, split-horizon, and DNSSEC forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Server DNS Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-dns-ops-agent/cli/server_dns_ops.py --help`
