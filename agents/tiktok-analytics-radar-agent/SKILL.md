---
name: tiktok-analytics-radar-agent
description: 'Completion rate, rewatch, and follower activity heatmaps'
version: 1.0.0
author: AI Agent Architect
category: 'Social: TikTok'
---

# TikTok Analytics Radar
...
2. Run deterministic heuristics for **TikTok Analytics Radar** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-analytics-radar-agent/cli/tiktok_analytics_radar.py --help`
