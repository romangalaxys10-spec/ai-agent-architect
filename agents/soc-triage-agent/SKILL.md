...
description: 'Alert correlation, false-positive suppression, playbook dispatch, MTTR estimation'
version: 1.0.0
...
2. Run deterministic heuristics for **SOC Alert Triage** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/soc-triage-agent/cli/soc_triage.py --help`
