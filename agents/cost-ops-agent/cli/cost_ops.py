"""CLI for Cost Ops (FinOps) — Tagging hygiene, idle/oversized detection, reservation modeling, and showback"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Cost Ops (FinOps) — Tagging hygiene, idle/oversized detection, reservation modeling, and showback")
    ...
    from core.cost_ops_engine import CostOpsEngine
    analysis=CostOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(CostOpsEngine.format_report(analysis))
