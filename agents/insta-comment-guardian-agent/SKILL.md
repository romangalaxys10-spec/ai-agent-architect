---
name: insta-comment-guardian-agent
description: 'Toxicity, spam, and brand-safety moderation with allowlists'
version: 1.0.0
author: AI Agent Architect
category: 'Social: Instagram'
---

# Insta Comment Guardian
...
2. Run deterministic heuristics for **Insta Comment Guardian** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-comment-guardian-agent/cli/insta_comment_guardian.py --help`
