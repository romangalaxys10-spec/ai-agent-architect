"""CLI for PropTech Analyst — Rent-roll parsing, valuation sensitivity, zoning flag checks, investment memo drafting"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='PropTech Analyst — Rent-roll parsing, valuation sensitivity, zoning flag checks, investment memo drafting')
    ...
    from core.proptech_analyst_engine import ProptechAnalystEngine
    analysis = ProptechAnalystEngine.analyze(text)
    if args.json:
        ...
        print(ProptechAnalystEngine.format_report(analysis))
