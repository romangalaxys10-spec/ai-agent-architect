---
name: camera-mic-governor-agent
description: 'Permission gates, virtual camera/mic injection, and recording indicator enforcement'
version: 1.0.0
...
2. Run deterministic heuristics for **Camera & Mic Governor** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/camera-mic-governor-agent/cli/camera_mic_governor.py --help`
