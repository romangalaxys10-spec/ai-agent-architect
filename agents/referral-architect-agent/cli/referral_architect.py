"""CLI for Referral Program Architect — Incentive design, viral coefficient math, fraud controls, share-copy generation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Referral Program Architect — Incentive design, viral coefficient math, fraud controls, share-copy generation')
    ...
    from core.referral_architect_engine import ReferralArchitectEngine
    analysis = ReferralArchitectEngine.analyze(text)
    if args.json:
        ...
        print(ReferralArchitectEngine.format_report(analysis))
