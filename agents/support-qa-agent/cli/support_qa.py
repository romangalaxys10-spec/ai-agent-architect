"""CLI for Support QA Auditor — Interaction scoring against rubric, coaching themes, calibration packet assembly"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Support QA Auditor — Interaction scoring against rubric, coaching themes, calibration packet assembly')
    ...
    from core.support_qa_engine import SupportQaEngine
    analysis = SupportQaEngine.analyze(text)
    if args.json:
        ...
        print(SupportQaEngine.format_report(analysis))
