"""CLI for Windows Admin — Registry, services (sc.exe), Task Scheduler, and NTFS/ACL forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Windows Admin — Registry, services (sc.exe), Task Scheduler, and NTFS/ACL forensics")
    ...
    from core.windows_admin_engine import WindowsAdminEngine
    analysis=WindowsAdminEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(WindowsAdminEngine.format_report(analysis))
