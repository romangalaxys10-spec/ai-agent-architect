...
description: 'Manifest v3, content/background/service worker, storage sync, and store review prep'
version: 1.0.0
...
2. Run deterministic heuristics for **Extension Architect** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/browser-extension-agent/cli/browser_extension.py --help`
