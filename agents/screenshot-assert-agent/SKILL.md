---
name: screenshot-assert-agent
description: 'Visual diff, perceptual hash, region masking, and golden screenshot gates'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Screenshot Assert Engine
...
2. Run deterministic heuristics for **Screenshot Assert Engine** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/screenshot-assert-agent/cli/screenshot_assert.py --help`
