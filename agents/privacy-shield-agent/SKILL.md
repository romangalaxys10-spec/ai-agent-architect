...
description: 'GDPR/CCPA gap analysis, DPA clause mapping, consent-flow audits, retention enforcement'
version: 1.0.0
...
2. Run deterministic heuristics for **Privacy & DPA Steward** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/privacy-shield-agent/cli/privacy_shield.py --help`
