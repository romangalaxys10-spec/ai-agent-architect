---
name: csat-surgeon-agent
description: 'Driver analysis, recovery playbooks, closed-loop tracking, segment trending'
version: 1.0.0
...
2. Run deterministic heuristics for **CSAT Surgeon** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/csat-surgeon-agent/cli/csat_surgeon.py --help`
