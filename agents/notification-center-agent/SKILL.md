---
name: notification-center-agent
description: 'Banner/toast interception, permission routing, Do-Not-Disturb orchestration, and alert triage'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Notification Center Commander
...
2. Run deterministic heuristics for **Notification Center Commander** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/notification-center-agent/cli/notification_center.py --help`
