---
name: licensing-guardian-agent
description: 'OSS license compatibility, copyleft risk, SBOM generation, attribution assembly'
version: 1.0.0
author: AI Agent Architect
category: 'Coding & DevOps'
---

# License & Compliance Sentinel
...
2. Run deterministic heuristics for **License & Compliance Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/licensing-guardian-agent/cli/licensing_guardian.py --help`
