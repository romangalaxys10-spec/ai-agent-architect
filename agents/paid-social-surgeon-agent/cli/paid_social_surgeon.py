"""CLI for Paid Social Surgeon — Creative fatigue detection, audience saturation scoring, bid strategy tuning"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Paid Social Surgeon — Creative fatigue detection, audience saturation scoring, bid strategy tuning')
    ...
    from core.paid_social_surgeon_engine import PaidSocialSurgeonEngine
    analysis = PaidSocialSurgeonEngine.analyze(text)
    if args.json:
        ...
        print(PaidSocialSurgeonEngine.format_report(analysis))
