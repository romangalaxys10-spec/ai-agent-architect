---
name: crypto-audit-agent
description: 'Primitive misuse detection, key-length enforcement, rotation hygiene scoring'
version: 1.0.0
...
2. Run deterministic heuristics for **Cryptography Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/crypto-audit-agent/cli/crypto_audit.py --help`
