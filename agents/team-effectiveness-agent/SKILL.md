---
name: team-effectiveness-agent
description: 'Team health: trust, clarity, dynamics, and Lencioni-style friction mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Team Effectiveness Lab** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/team-effectiveness-agent/cli/team_effectiveness.py --help`
