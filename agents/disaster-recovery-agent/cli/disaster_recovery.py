"""CLI for Disaster Recovery Architect — RTO/RPO math, pilot-light vs warm-standby, and chaos-day runbooks"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Disaster Recovery Architect — RTO/RPO math, pilot-light vs warm-standby, and chaos-day runbooks")
    ...
    from core.disaster_recovery_engine import DisasterRecoveryEngine
    analysis=DisasterRecoveryEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(DisasterRecoveryEngine.format_report(analysis))
