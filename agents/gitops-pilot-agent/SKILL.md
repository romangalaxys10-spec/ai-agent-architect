---
name: gitops-pilot-agent
description: 'ArgoCD/Flux, drift vs desired, sync waves, and progressive delivery analysis'
version: 1.0.0
...
2. Run deterministic heuristics for **GitOps Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/gitops-pilot-agent/cli/gitops_pilot.py --help`
