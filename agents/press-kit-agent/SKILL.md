---
name: press-kit-agent
description: 'Boilerplate synthesis, asset inventory, embargo packet, media Q&A prep'
version: 1.0.0
...
2. Run deterministic heuristics for **Press Kit Assembler** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/press-kit-agent/cli/press_kit.py --help`
