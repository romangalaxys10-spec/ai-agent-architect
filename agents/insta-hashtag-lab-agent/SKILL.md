---
name: insta-hashtag-lab-agent
description: 'Hashtag tiering, banned-tag audit, and reach vs niche balance'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta Hashtag Lab** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-hashtag-lab-agent/cli/insta_hashtag_lab.py --help`
