"""CLI for FinTech Compliance Sentinel — KYC/AML flow checks, transaction monitoring flag review, regulatory mapping"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='FinTech Compliance Sentinel — KYC/AML flow checks, transaction monitoring flag review, regulatory mapping')
    ...
    from core.fintech_compliance_engine import FintechComplianceEngine
    analysis = FintechComplianceEngine.analyze(text)
    if args.json:
        ...
        print(FintechComplianceEngine.format_report(analysis))
