"""CLI for Puppeteer Forge — Headless Chromium control, PDF/screenshot pipelines, and request interception"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Puppeteer Forge — Headless Chromium control, PDF/screenshot pipelines, and request interception")
    ...
    from core.puppeteer_forge_engine import PuppeteerForgeEngine
    analysis=PuppeteerForgeEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(PuppeteerForgeEngine.format_report(analysis))
