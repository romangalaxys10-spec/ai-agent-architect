---
name: repl-bridge-agent
description: 'Python/Node/Ruby REPL orchestration, cell execution guards, and output capture'
version: 1.0.0
...
2. Run deterministic heuristics for **REPL Bridge** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/repl-bridge-agent/cli/repl_bridge.py --help`
