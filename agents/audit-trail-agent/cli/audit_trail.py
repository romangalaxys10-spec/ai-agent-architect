"""CLI for Audit Trail Assembler — Evidence packet assembly, control-to-artifact mapping, auditor-ready narratives"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Audit Trail Assembler — Evidence packet assembly, control-to-artifact mapping, auditor-ready narratives')
    ...
    analysis = AuditTrailEngine.analyze(text)
    if args.json:
        ...
        print(AuditTrailEngine.format_report(analysis))
