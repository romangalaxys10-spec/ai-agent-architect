"""CLI for Feedback Miner — Support/survey/app-review clustering, theme-to-roadmap linking, fix prioritization"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Feedback Miner — Support/survey/app-review clustering, theme-to-roadmap linking, fix prioritization')
    ...
    from core.feedback_miner_engine import FeedbackMinerEngine
    analysis = FeedbackMinerEngine.analyze(text)
    if args.json:
        ...
        print(FeedbackMinerEngine.format_report(analysis))
