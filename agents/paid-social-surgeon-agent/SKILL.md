---
name: paid-social-surgeon-agent
description: 'Creative fatigue detection, audience saturation scoring, bid strategy tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **Paid Social Surgeon** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/paid-social-surgeon-agent/cli/paid_social_surgeon.py --help`
