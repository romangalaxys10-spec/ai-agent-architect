---
name: linkedin-scheduler-agent
description: 'Queue, calendar, timezone-aware publishing, and cross-post guards for LinkedIn'
version: 1.0.0
...
2. Run deterministic heuristics for **LinkedIn Scheduler** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-scheduler-agent/cli/linkedin_scheduler.py --help`
