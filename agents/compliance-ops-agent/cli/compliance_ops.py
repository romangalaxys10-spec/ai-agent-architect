"""CLI for Compliance Ops — SOC2/HIPAA evidence, CIS drift, and continuous audit trails"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Compliance Ops — SOC2/HIPAA evidence, CIS drift, and continuous audit trails")
    ...
    from core.compliance_ops_engine import ComplianceOpsEngine
    analysis=ComplianceOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ComplianceOpsEngine.format_report(analysis))
