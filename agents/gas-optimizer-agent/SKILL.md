...
description: 'Gas profiling, calldata packing, and batch strategy'
version: 1.0.0
...
2. Run deterministic heuristics for **Gas Optimizer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/gas-optimizer-agent/cli/gas_optimizer.py --help`
