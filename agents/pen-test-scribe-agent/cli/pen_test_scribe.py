"""CLI for Pen Test Report Scribe — Finding deduplication, CVSS scoring, evidence packets, remediation roadmaps"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Pen Test Report Scribe — Finding deduplication, CVSS scoring, evidence packets, remediation roadmaps')
    ...
    from core.pen_test_scribe_engine import PenTestScribeEngine
    analysis = PenTestScribeEngine.analyze(text)
    if args.json:
        ...
        print(PenTestScribeEngine.format_report(analysis))
