---
name: oracle-keeper-agent
description: 'Price feeds, staleness, and circuit breaker'
version: 1.0.0
...
2. Run deterministic heuristics for **Oracle Keeper** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/oracle-keeper-agent/cli/oracle_keeper.py --help`
