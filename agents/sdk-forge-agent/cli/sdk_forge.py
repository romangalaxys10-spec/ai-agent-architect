"""CLI for SDK & Client Generator — Multi-language SDK scaffolding from OpenAPI/Proto, versioned changelogs, breaking-change detection"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='SDK & Client Generator — Multi-language SDK scaffolding from OpenAPI/Proto, versioned changelogs, breaking-change detection')
    ...
    from core.sdk_forge_engine import SdkForgeEngine
    analysis = SdkForgeEngine.analyze(text)
    if args.json:
        ...
        print(SdkForgeEngine.format_report(analysis))
