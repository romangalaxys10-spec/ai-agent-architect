"""CLI for NLP Pipeline Architect — Tokenization choices, NER/CLS routing, eval on imbalanced sets, multilingual tradeoffs"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='NLP Pipeline Architect — Tokenization choices, NER/CLS routing, eval on imbalanced sets, multilingual tradeoffs')
    ...
    from core.nlp_pipeline_engine import NlpPipelineEngine
    analysis = NlpPipelineEngine.analyze(text)
    if args.json:
        ...
        print(NlpPipelineEngine.format_report(analysis))
