---
name: talent-calibration-agent
description: 'Cross-team talent calibration, distribution health, and bias-safe facilitation'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Talent Calibration Conductor
...
2. Run deterministic heuristics for **Talent Calibration Conductor** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/talent-calibration-agent/cli/talent_calibration.py --help`
