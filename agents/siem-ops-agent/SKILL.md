---
name: siem-ops-agent
description: 'Log pipeline, detection-as-code, and false-positive tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **SIEM Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/siem-ops-agent/cli/siem_ops.py --help`
