...
description: 'Skill-gap mapping, curriculum sequencing, adaptive checkpoint design, certification prep'
version: 1.0.0
...
2. Run deterministic heuristics for **Learning Path Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-path-agent/cli/learning_path.py --help`
