"""CLI for TLS Cert Steward — ACME/Let’s Encrypt, chain validation, OCSP, and cert-rotation without downtime"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="TLS Cert Steward — ACME/Let’s Encrypt, chain validation, OCSP, and cert-rotation without downtime")
    ...
    from core.tls_cert_engine import TlsCertEngine
    analysis=TlsCertEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(TlsCertEngine.format_report(analysis))
