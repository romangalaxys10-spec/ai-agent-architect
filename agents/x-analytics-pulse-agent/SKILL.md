---
name: x-analytics-pulse-agent
description: 'Views, bookmarks, profile clicks, and follower quality'
version: 1.0.0
...
2. Run deterministic heuristics for **X Analytics Pulse** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-analytics-pulse-agent/cli/x_analytics_pulse.py --help`
