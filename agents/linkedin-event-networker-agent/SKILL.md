---
name: linkedin-event-networker-agent
description: 'Event attendee mapping, warm-intro paths, and post-event follow-up'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Event Networker
...
2. Run deterministic heuristics for **LinkedIn Event Networker** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-event-networker-agent/cli/linkedin_event_networker.py --help`
