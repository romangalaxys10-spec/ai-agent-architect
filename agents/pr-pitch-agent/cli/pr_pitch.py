"""CLI for PR Pitch Crafter — Angle generation, journalist-fit scoring, embargo timing, follow-up sequencing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='PR Pitch Crafter — Angle generation, journalist-fit scoring, embargo timing, follow-up sequencing')
    ...
    from core.pr_pitch_engine import PrPitchEngine
    analysis = PrPitchEngine.analyze(text)
    if args.json:
        ...
        print(PrPitchEngine.format_report(analysis))
