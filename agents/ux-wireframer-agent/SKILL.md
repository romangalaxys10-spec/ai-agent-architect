---
name: ux-wireframer-agent
description: 'IA, user flows, and low→high fidelity wireframes'
version: 1.0.0
...
2. Run deterministic heuristics for **UX Wireframer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/ux-wireframer-agent/cli/ux_wireframer.py --help`
