...
description: 'rsync/restic/borg, push vs pull, encryption, and restore drill verification'
version: 1.0.0
...
2. Run deterministic heuristics for **Backup & Restore Orchestrator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/backup-restore-agent/cli/backup_restore.py --help`
