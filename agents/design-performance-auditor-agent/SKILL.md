---
name: design-performance-auditor-agent
description: 'Bundle/image/font budgets from design decisions'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Web Design'
---

# Design Performance Auditor
...
2. Run deterministic heuristics for **Design Performance Auditor** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/design-performance-auditor-agent/cli/design_performance_auditor.py --help`
