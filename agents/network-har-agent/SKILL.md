---
name: network-har-agent
description: 'HAR capture, waterfall analysis, cache-hit verification, and payload PII scrubbing'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Network HAR Forensics
...
2. Run deterministic heuristics for **Network HAR Forensics** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/network-har-agent/cli/network_har.py --help`
