---
name: people-analytics-storyteller-agent
description: 'People analytics → executive narrative: hypothesis, viz choice, and so-what'
version: 1.0.0
...
2. Run deterministic heuristics for **People Analytics Storyteller** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/people-analytics-storyteller-agent/cli/people_analytics_storyteller.py --help`
