...
description: 'Touchpoint mapping, emotion curves, pain-point severity ranking, opportunity sizing'
version: 1.0.0
...
2. Run deterministic heuristics for **Journey Mapper** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/user-journey-agent/cli/user_journey.py --help`
