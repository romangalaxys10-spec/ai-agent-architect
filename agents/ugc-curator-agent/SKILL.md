---
name: ugc-curator-agent
description: 'Submission triage, rights management, creator attribution, repurposing queue'
version: 1.0.0
...
2. Run deterministic heuristics for **UGC Curator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ugc-curator-agent/cli/ugc_curator.py --help`
