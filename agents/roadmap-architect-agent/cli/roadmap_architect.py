"""CLI for Roadmap Architect — RICE/WSJF scoring, dependency mapping, theme balancing, stakeholder narrative"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Roadmap Architect — RICE/WSJF scoring, dependency mapping, theme balancing, stakeholder narrative')
    ...
    from core.roadmap_architect_engine import RoadmapArchitectEngine
    analysis = RoadmapArchitectEngine.analyze(text)
    if args.json:
        ...
        print(RoadmapArchitectEngine.format_report(analysis))
