...
description: 'Terminal prompt theme (starship/oh-my-zsh), git status embedding, and latency budgets'
version: 1.0.0
author: AI Agent Architect
category: 'Terminal Use'
---

# Prompt Engineer (Terminal)
...
2. Run deterministic heuristics for **Prompt Engineer (Terminal)** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/prompt-engineer-agent/cli/prompt_engineer.py --help`
