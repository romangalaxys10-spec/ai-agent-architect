---
name: clipboard-ops-agent
description: 'Multi-format clipboard (text/image/files), history vault, and cross-app paste validation'
version: 1.0.0
...
2. Run deterministic heuristics for **Clipboard Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/clipboard-ops-agent/cli/clipboard_ops.py --help`
