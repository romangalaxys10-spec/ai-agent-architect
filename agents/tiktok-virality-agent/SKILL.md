...
description: 'Hook-window optimization, trend-jacking timing, sound selection, loop-rate engineering'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Virality Lab** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-virality-agent/cli/tiktok_virality.py --help`
