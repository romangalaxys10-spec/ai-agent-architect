...
description: 'Red-team prompt banks, bypass attempt logging, safety regression tracking'
version: 1.0.0
...
2. Run deterministic heuristics for **Adversarial Tester** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/adversarial-tester-agent/cli/adversarial_tester.py --help`
