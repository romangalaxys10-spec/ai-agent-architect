"""CLI for Orchestration Designer — Topology selection (hierarchical/mesh/blackboard), handoff choreography, failure-mode mapping"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Orchestration Designer — Topology selection (hierarchical/mesh/blackboard), handoff choreography, failure-mode mapping')
    ...
    from core.orchestration_designer_engine import OrchestrationDesignerEngine
    analysis = OrchestrationDesignerEngine.analyze(text)
    if args.json:
        ...
        print(OrchestrationDesignerEngine.format_report(analysis))
