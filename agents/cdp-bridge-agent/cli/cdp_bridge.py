"""CLI for CDP Bridge — Chrome DevTools Protocol — DOM, debugger, network, emulation, and trace capture"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="CDP Bridge — Chrome DevTools Protocol — DOM, debugger, network, emulation, and trace capture")
    ...
    from core.cdp_bridge_engine import CdpBridgeEngine
    analysis=CdpBridgeEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(CdpBridgeEngine.format_report(analysis))
