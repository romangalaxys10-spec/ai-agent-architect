"""CLI for Terminal Renderer — ANSI/VT100 parsing, 24-bit color, ligature handling, and damage-region rendering"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Terminal Renderer — ANSI/VT100 parsing, 24-bit color, ligature handling, and damage-region rendering")
    ...
    from core.terminal_renderer_engine import TerminalRendererEngine
    analysis=TerminalRendererEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(TerminalRendererEngine.format_report(analysis))
