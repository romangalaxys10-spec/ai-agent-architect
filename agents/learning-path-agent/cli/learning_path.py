"""CLI for Learning Path Architect — Skill-gap mapping, curriculum sequencing, adaptive checkpoint design, certification prep"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Learning Path Architect — Skill-gap mapping, curriculum sequencing, adaptive checkpoint design, certification prep')
    ...
    from core.learning_path_engine import LearningPathEngine
    analysis = LearningPathEngine.analyze(text)
    if args.json:
        ...
        print(LearningPathEngine.format_report(analysis))
