---
name: assessment-validation-agent
description: 'Selection assessment design, adverse impact, reliability/validity, and fairness'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Assessment Validation Lab
...
2. Run deterministic heuristics for **Assessment Validation Lab** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/assessment-validation-agent/cli/assessment_validation.py --help`
