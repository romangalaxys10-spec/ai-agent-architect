---
name: chain-indexer-general-agent
description: 'Cross-chain indexer, RPC pooling, and reorg handling'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Blockchain'
---

# Chain Indexer (General)
...
2. Run deterministic heuristics for **Chain Indexer (General)** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/chain-indexer-general-agent/cli/chain_indexer_general.py --help`
