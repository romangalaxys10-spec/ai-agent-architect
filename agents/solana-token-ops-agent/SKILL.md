---
name: solana-token-ops-agent
description: 'SPL / Token-2022, mints, metadata, and treasury ops'
version: 1.0.0
...
2. Run deterministic heuristics for **Solana Token Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-token-ops-agent/cli/solana_token_ops.py --help`
