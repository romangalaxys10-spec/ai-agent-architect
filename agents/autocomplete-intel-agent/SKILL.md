---
name: autocomplete-intel-agent
description: 'Tab completion synthesis, fuzzy ranking, man-page harvesting, and contextual suggestion'
version: 1.0.0
...
2. Run deterministic heuristics for **Autocomplete Intel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/autocomplete-intel-agent/cli/autocomplete_intel.py --help`
