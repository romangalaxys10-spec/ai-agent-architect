---
name: facilitation-master-agent
description: 'Elite facilitation: session design, energy arcs, and difficult-room handling'
version: 1.0.0
...
2. Run deterministic heuristics for **Facilitation Master** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/facilitation-master-agent/cli/facilitation_master.py --help`
