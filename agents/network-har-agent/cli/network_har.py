"""CLI for Network HAR Forensics — HAR capture, waterfall analysis, cache-hit verification, and payload PII scrubbing"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Network HAR Forensics — HAR capture, waterfall analysis, cache-hit verification, and payload PII scrubbing")
    ...
    from core.network_har_engine import NetworkHarEngine
    analysis=NetworkHarEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(NetworkHarEngine.format_report(analysis))
