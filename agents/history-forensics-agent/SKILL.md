---
name: history-forensics-agent
description: 'Shell history forensics, deduplication, secret scrubbing, and recall ranking'
version: 1.0.0
...
2. Run deterministic heuristics for **History Forensics** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/history-forensics-agent/cli/history_forensics.py --help`
