"""CLI for Cryptography Auditor — Primitive misuse detection, key-length enforcement, rotation hygiene scoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Cryptography Auditor — Primitive misuse detection, key-length enforcement, rotation hygiene scoring')
    ...
    from core.crypto_audit_engine import CryptoAuditEngine
    analysis = CryptoAuditEngine.analyze(text)
    if args.json:
        ...
        print(CryptoAuditEngine.format_report(analysis))
