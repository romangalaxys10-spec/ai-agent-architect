...
description: 'Long-form -> thread/carousel/shorts atomization, platform-native rewriting, CTA tailoring'
version: 1.0.0
...
2. Run deterministic heuristics for **Content Repurposing Engine** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/content-repurposer-agent/cli/content_repurposer.py --help`
