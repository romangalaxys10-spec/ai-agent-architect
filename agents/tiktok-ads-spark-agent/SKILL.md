---
name: tiktok-ads-spark-agent
description: 'Spark Ads, creator licensing, and whitelisting workflow'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Spark Ads** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-ads-spark-agent/cli/tiktok_ads_spark.py --help`
