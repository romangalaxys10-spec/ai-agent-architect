...
description: 'logrotate/journal vacuuming, retention budgets, and centralized shipper wiring'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# Log Rotation Steward
...
2. Run deterministic heuristics for **Log Rotation Steward** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/log-rotation-agent/cli/log_rotation.py --help`
