---
name: hrbp-coaching-agent
description: 'HRBP as coach: GROW-based leader coaching, contracting, and impact evidence'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# HRBP Coaching Catalyst
...
2. Run deterministic heuristics for **HRBP Coaching Catalyst** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/hrbp-coaching-agent/cli/hrbp_coaching.py --help`
