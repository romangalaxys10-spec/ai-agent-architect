---
name: orchestration-designer-agent
description: 'Topology selection (hierarchical/mesh/blackboard), handoff choreography, failure-mode mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Orchestration Designer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/orchestration-designer-agent/cli/orchestration_designer.py --help`
