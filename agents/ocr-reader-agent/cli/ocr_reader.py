"""CLI for OCR Reader — On-screen text extraction, table de-warping, language detection, and redaction"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="OCR Reader — On-screen text extraction, table de-warping, language detection, and redaction")
    ...
    from core.ocr_reader_engine import OcrReaderEngine
    analysis=OcrReaderEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(OcrReaderEngine.format_report(analysis))
