---
name: x-dm-funnel-agent
description: 'Public → DM permission, value ladders, and auto-qualify'
version: 1.0.0
...
2. Run deterministic heuristics for **X DM Funnel** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-dm-funnel-agent/cli/x_dm_funnel.py --help`
