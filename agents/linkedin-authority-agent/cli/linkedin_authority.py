"""CLI for LinkedIn Authority Builder — POV extraction from commits, carousel outlining, comment-to-DM funnel, SSI scoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='LinkedIn Authority Builder — POV extraction from commits, carousel outlining, comment-to-DM funnel, SSI scoring')
    ...
    from core.linkedin_authority_engine import LinkedinAuthorityEngine
    analysis = LinkedinAuthorityEngine.analyze(text)
    if args.json:
        ...
        print(LinkedinAuthorityEngine.format_report(analysis))
