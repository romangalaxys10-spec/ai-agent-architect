"""CLI for Supply-Chain Guardian — Dependency provenance, sigstore verification, typosquat detection, SBOM diffing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Supply-Chain Guardian — Dependency provenance, sigstore verification, typosquat detection, SBOM diffing')
    ...
    from core.supply_chain_guard_engine import SupplyChainGuardEngine
    analysis = SupplyChainGuardEngine.analyze(text)
    if args.json:
        ...
        print(SupplyChainGuardEngine.format_report(analysis))
