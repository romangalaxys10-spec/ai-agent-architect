"""CLI for Community Growth Hacker — Activation funnel, referral loop design, moderation at scale, UGC flywheel"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Community Growth Hacker — Activation funnel, referral loop design, moderation at scale, UGC flywheel')
    ...
    from core.community_growth_engine import CommunityGrowthEngine
    analysis = CommunityGrowthEngine.analyze(text)
    if args.json:
        ...
        print(CommunityGrowthEngine.format_report(analysis))
