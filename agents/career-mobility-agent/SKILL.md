---
name: career-mobility-agent
description: 'Career lattices, progression frameworks, and internal mobility pathways'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Career Mobility Navigator
...
2. Run deterministic heuristics for **Career Mobility Navigator** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/career-mobility-agent/cli/career_mobility.py --help`
