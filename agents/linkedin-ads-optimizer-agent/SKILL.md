---
name: linkedin-ads-optimizer-agent
description: 'Campaign, audience, bid, and creative fatigue for LinkedIn Ads'
version: 1.0.0
...
2. Run deterministic heuristics for **LinkedIn Ads Optimizer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-ads-optimizer-agent/cli/linkedin_ads_optimizer.py --help`
