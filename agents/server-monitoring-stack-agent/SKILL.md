---
name: server-monitoring-stack-agent
description: 'Prometheus/Grafana/Alertmanager with SLO burn and cardinality guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Server Monitoring Stack** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-monitoring-stack-agent/cli/server_monitoring_stack.py --help`
