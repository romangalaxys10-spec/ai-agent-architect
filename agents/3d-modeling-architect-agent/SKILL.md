---
name: 3d-modeling-architect-agent
description: 'Hard-surface & organic modeling with topology, retopo, and LOD'
version: 1.0.0
...
2. Run deterministic heuristics for **3D Modeling Architect** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/3d-modeling-architect-agent/cli/m_3d_modeling_architect.py --help`
