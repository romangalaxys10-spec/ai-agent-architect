---
name: server-config-drift-agent
description: 'Drift detection via Chef/Puppet/Ansible and remediation'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Server Mgmt'
---

# Server Config Drift Sentinel
...
2. Run deterministic heuristics for **Server Config Drift Sentinel** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-config-drift-agent/cli/server_config_drift.py --help`
