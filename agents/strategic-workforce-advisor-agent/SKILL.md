---
name: strategic-workforce-advisor-agent
description: 'Strategic workforce planning (SWP): 3-horizon headcount and skills forecast'
version: 1.0.0
...
2. Run deterministic heuristics for **Strategic Workforce Advisor** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/strategic-workforce-advisor-agent/cli/strategic_workforce_advisor.py --help`
