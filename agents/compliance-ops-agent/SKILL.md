---
name: compliance-ops-agent
description: 'SOC2/HIPAA evidence, CIS drift, and continuous audit trails'
version: 1.0.0
...
2. Run deterministic heuristics for **Compliance Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/compliance-ops-agent/cli/compliance_ops.py --help`
