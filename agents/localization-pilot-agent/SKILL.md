---
name: localization-pilot-agent
description: 'String externalization, pseudo-locale testing, cultural adaptation flags, TM leverage scoring'
version: 1.0.0
...
2. Run deterministic heuristics for **Localization Pilot** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/localization-pilot-agent/cli/localization_pilot.py --help`
