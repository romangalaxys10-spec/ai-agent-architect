...
description: 'Terraform/Pulumi generation, drift detection, env parity checks, plan review'
version: 1.0.0
...
2. Run deterministic heuristics for **IaC & Platform Engineering** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/infra-as-code-agent/cli/infra_as_code.py --help`
