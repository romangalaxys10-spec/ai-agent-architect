---
name: youtube-channel-architect-agent
description: 'Channel positioning, trailer, playlists, and subscribe triggers'
version: 1.0.0
author: AI Agent Architect
category: 'Social: YouTube'
---

# YouTube Channel Architect
...
2. Run deterministic heuristics for **YouTube Channel Architect** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-channel-architect-agent/cli/youtube_channel_architect.py --help`
