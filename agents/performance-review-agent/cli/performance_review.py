"""CLI for Performance Review Synthesizer — Feedback theme synthesis, calibration support, growth-plan drafting, bias flagging"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Performance Review Synthesizer — Feedback theme synthesis, calibration support, growth-plan drafting, bias flagging')
    ...
    from core.performance_review_engine import PerformanceReviewEngine
    analysis = PerformanceReviewEngine.analyze(text)
    if args.json:
        ...
        print(PerformanceReviewEngine.format_report(analysis))
