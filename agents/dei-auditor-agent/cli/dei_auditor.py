"""CLI for DEI Auditor — Pipeline diversity metrics, language inclusivity audit, intervention effectiveness scoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='DEI Auditor — Pipeline diversity metrics, language inclusivity audit, intervention effectiveness scoring')
    ...
    from core.dei_auditor_engine import DeiAuditorEngine
    analysis = DeiAuditorEngine.analyze(text)
    if args.json:
        ...
        print(DeiAuditorEngine.format_report(analysis))
