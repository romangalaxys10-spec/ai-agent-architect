...
description: 'Channel health scoring, contributor ladder design, moderation playbooks, activation campaigns'
version: 1.0.0
...
2. Run deterministic heuristics for **Community Builder** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/community-builder-agent/cli/community_builder.py --help`
