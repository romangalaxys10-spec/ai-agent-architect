---
name: insta-story-architect-agent
description: 'Story arcs, stickers, polls, swipe-ups, and highlight hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'Social: Instagram'
---

# Insta Story Architect
...
2. Run deterministic heuristics for **Insta Story Architect** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-story-architect-agent/cli/insta_story_architect.py --help`
