---
name: x-community-cultivator-agent
description: 'Community notes, member roles, and UGC flywheel on X'
version: 1.0.0
author: AI Agent Architect
category: 'Social: X'
---

# X Community Cultivator
...
2. Run deterministic heuristics for **X Community Cultivator** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-community-cultivator-agent/cli/x_community_cultivator.py --help`
