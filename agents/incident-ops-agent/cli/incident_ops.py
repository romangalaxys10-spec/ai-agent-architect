"""CLI for Incident Ops Commander — On-call handoff, status page, postmortem, and runbook-as-code"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Incident Ops Commander — On-call handoff, status page, postmortem, and runbook-as-code")
    ...
    from core.incident_ops_engine import IncidentOpsEngine
    analysis=IncidentOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(IncidentOpsEngine.format_report(analysis))
