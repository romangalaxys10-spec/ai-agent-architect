---
name: web-perf-auditor-agent
description: 'Lighthouse/Web Vitals, image/CDN, and critical path'
version: 1.0.0
...
2. Run deterministic heuristics for **Web Perf Auditor** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/web-perf-auditor-agent/cli/web_perf_auditor.py --help`
