---
name: real-estate-scout-agent
description: 'Location scoring, comps analysis, cap-rate math, due-diligence checklist'
version: 1.0.0
...
2. Run deterministic heuristics for **Real Estate Scout** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/real-estate-scout-agent/cli/real_estate_scout.py --help`
