---
name: nlp-pipeline-agent
description: 'Tokenization choices, NER/CLS routing, eval on imbalanced sets, multilingual tradeoffs'
version: 1.0.0
...
2. Run deterministic heuristics for **NLP Pipeline Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/nlp-pipeline-agent/cli/nlp_pipeline.py --help`
