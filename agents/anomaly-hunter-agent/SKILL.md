...
description: 'Time-series outlier detection, seasonal decomposition, root-cause ranking, alert suppression tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **Anomaly Hunter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/anomaly-hunter-agent/cli/anomaly_hunter.py --help`
