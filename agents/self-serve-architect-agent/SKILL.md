---
name: self-serve-architect-agent
description: 'Deflection opportunity scoring, flow design, containment rate tracking'
version: 1.0.0
author: AI Agent Architect
category: 'Support & Success'
---

# Self-Serve Architect
...
2. Run deterministic heuristics for **Self-Serve Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/self-serve-architect-agent/cli/self_serve_architect.py --help`
