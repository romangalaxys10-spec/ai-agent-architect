---
name: bare-metal-provisioner-agent
description: 'PXE/iPXE, Redfish, and firmware attestation'
version: 1.0.0
...
2. Run deterministic heuristics for **Bare-Metal Provisioner** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/bare-metal-provisioner-agent/cli/bare_metal_provisioner.py --help`
