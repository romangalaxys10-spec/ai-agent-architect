---
name: realtime-collab-agent
description: 'WebSocket/Yjs/CRDT for realtime collaboration'
version: 1.0.0
...
2. Run deterministic heuristics for **Realtime Collab Engine** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/realtime-collab-agent/cli/realtime_collab.py --help`
