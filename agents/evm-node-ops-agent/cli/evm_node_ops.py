"""CLI for EVM Node Ops — Geth/Reth/Erigon sync, peering, and pruning for EVM chains"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="EVM Node Ops — Geth/Reth/Erigon sync, peering, and pruning for EVM chains")
    ...
    from core.evm_node_ops_engine import EvmNodeOpsEngine
    analysis=EvmNodeOpsEngine.analyze(text)
    if args.json:
        ...
        print(EvmNodeOpsEngine.format_report(analysis))
