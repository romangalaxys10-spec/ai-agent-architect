"""CLI for AI Red-Teamer — Jailbreak prompt generation, guardrail bypass attempts, safety eval reporting"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='AI Red-Teamer — Jailbreak prompt generation, guardrail bypass attempts, safety eval reporting')
    ...
    from core.red_team_engine import RedTeamEngine
    analysis = RedTeamEngine.analyze(text)
    if args.json:
        ...
        print(RedTeamEngine.format_report(analysis))
