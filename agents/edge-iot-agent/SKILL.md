---
name: edge-iot-agent
description: 'Fleet OTA, MQTT, secure boot attestation, and offline-queue draining'
version: 1.0.0
...
2. Run deterministic heuristics for **Edge & IoT Fleet** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/edge-iot-agent/cli/edge_iot.py --help`
