"""CLI for Form Autofill Engine — Field inference, constraint validation, CAPTCHA/Turnstile routing, and submit guards"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Form Autofill Engine — Field inference, constraint validation, CAPTCHA/Turnstile routing, and submit guards")
    ...
    from core.form_autofill_engine import FormAutofillEngine
    analysis=FormAutofillEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(FormAutofillEngine.format_report(analysis))
