"""CLI for Treasury Ops Sentinel — Cash positioning, bank fee audit, FX exposure flagging, liquidity runway math"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Treasury Ops Sentinel — Cash positioning, bank fee audit, FX exposure flagging, liquidity runway math')
    ...
    from core.treasury_ops_engine import TreasuryOpsEngine
    analysis = TreasuryOpsEngine.analyze(text)
    if args.json:
        ...
        print(TreasuryOpsEngine.format_report(analysis))
