---
name: api-contract-tester-agent
description: 'Pact/OpenAPI contract tests and breaking-change detection'
version: 1.0.0
...
2. Run deterministic heuristics for **API Contract Tester** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/api-contract-tester-agent/cli/api_contract_tester.py --help`
