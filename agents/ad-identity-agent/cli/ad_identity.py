"""CLI for AD & Identity Steward — Active Directory/GPO, Entra ID sync, LDAP, and Kerberos ticket forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="AD & Identity Steward — Active Directory/GPO, Entra ID sync, LDAP, and Kerberos ticket forensics")
    ...
    from core.ad_identity_engine import AdIdentityEngine
    analysis=AdIdentityEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(AdIdentityEngine.format_report(analysis))
