"""CLI for Man & Help Synthesizer — Man page summarization, flag inference, example harvesting, and TL;DR generation"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Man & Help Synthesizer — Man page summarization, flag inference, example harvesting, and TL;DR generation")
    ...
    from core.man_help_engine import ManHelpEngine
    analysis=ManHelpEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ManHelpEngine.format_report(analysis))
