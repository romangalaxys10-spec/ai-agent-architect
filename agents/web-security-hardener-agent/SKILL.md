---
name: web-security-hardener-agent
description: 'CSP/HSTS, XSS/CSRF, and SRI for web apps'
version: 1.0.0
...
2. Run deterministic heuristics for **Web Security Hardener** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/web-security-hardener-agent/cli/web_security_hardener.py --help`
