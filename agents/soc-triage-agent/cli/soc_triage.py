"""CLI for SOC Alert Triage — Alert correlation, false-positive suppression, playbook dispatch, MTTR estimation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='SOC Alert Triage — Alert correlation, false-positive suppression, playbook dispatch, MTTR estimation')
    ...
    analysis = SocTriageEngine.analyze(text)
    if args.json:
        ...
        print(SocTriageEngine.format_report(analysis))
