"""CLI for Log Rotation Steward — logrotate/journal vacuuming, retention budgets, and centralized shipper wiring"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Log Rotation Steward — logrotate/journal vacuuming, retention budgets, and centralized shipper wiring")
    ...
    from core.log_rotation_engine import LogRotationEngine
    analysis=LogRotationEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(LogRotationEngine.format_report(analysis))
