"""CLI for SSR Optimizer — SSR/SSG/CSR tradeoffs, hydration, and streaming"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="SSR Optimizer — SSR/SSG/CSR tradeoffs, hydration, and streaming")
    ...
    from core.ssr_optimizer_engine import SsrOptimizerEngine
    analysis=SsrOptimizerEngine.analyze(text)
    if args.json:
        ...
        print(SsrOptimizerEngine.format_report(analysis))
