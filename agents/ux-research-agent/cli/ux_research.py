"""CLI for UX Research Synthesizer — Interview coding, affinity mapping, insight prioritization, JTBD extraction"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='UX Research Synthesizer — Interview coding, affinity mapping, insight prioritization, JTBD extraction')
    ...
    from core.ux_research_engine import UxResearchEngine
    analysis = UxResearchEngine.analyze(text)
    if args.json:
        ...
        print(UxResearchEngine.format_report(analysis))
