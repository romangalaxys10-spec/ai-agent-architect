---
name: lifecycle-marketer-agent
description: 'Journey mapping, trigger logic, send-time optimization, deliverability linting'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Lifecycle Email Architect
...
2. Run deterministic heuristics for **Lifecycle Email Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/lifecycle-marketer-agent/cli/lifecycle_marketer.py --help`
