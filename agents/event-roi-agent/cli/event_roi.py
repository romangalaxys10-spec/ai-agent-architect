"""CLI for Field & Event ROI Tracker — Event cost capture, lead-to-opportunity math, follow-up SLA enforcement, repeat/skip verdict"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Field & Event ROI Tracker — Event cost capture, lead-to-opportunity math, follow-up SLA enforcement, repeat/skip verdict')
    ...
    from core.event_roi_engine import EventRoiEngine
    analysis = EventRoiEngine.analyze(text)
    if args.json:
        ...
        print(EventRoiEngine.format_report(analysis))
