...
description: 'apt/dnf/pacman/apk/zypper — repo pinning, hold/unhold, and atomic rollback'
version: 1.0.0
author: AI Agent Architect
category: 'Server Mgmt (Linux/Mac/Win)'
---

# Package Manager Pilot
...
2. Run deterministic heuristics for **Package Manager Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/package-manager-agent/cli/package_manager.py --help`
