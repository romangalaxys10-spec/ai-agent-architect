---
name: instructional-architect-agent
description: 'ADDIE/SAM, learning objectives (Bloom), and assessment alignment'
version: 1.0.0
...
2. Run deterministic heuristics for **Instructional Architect** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/instructional-architect-agent/cli/instructional_architect.py --help`
