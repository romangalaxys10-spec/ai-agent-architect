---
name: playwright-orchestrator-agent
description: 'Cross-browser (Chromium/Firefox/WebKit) test generation, auto-wait, trace viewer'
version: 1.0.0
...
2. Run deterministic heuristics for **Playwright Orchestrator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/playwright-orchestrator-agent/cli/playwright_orchestrator.py --help`
