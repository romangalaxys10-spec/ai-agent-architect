---
name: terminal-renderer-agent
description: 'ANSI/VT100 parsing, 24-bit color, ligature handling, and damage-region rendering'
version: 1.0.0
...
2. Run deterministic heuristics for **Terminal Renderer** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/terminal-renderer-agent/cli/terminal_renderer.py --help`
