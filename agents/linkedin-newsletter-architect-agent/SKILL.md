---
name: linkedin-newsletter-architect-agent
description: 'Newsletter cadence, issue scaffolding, and subscriber growth loops'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Newsletter Architect
...
2. Run deterministic heuristics for **LinkedIn Newsletter Architect** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-newsletter-architect-agent/cli/linkedin_newsletter_architect.py --help`
