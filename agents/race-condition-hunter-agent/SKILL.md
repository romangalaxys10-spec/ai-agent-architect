---
name: race-condition-hunter-agent
description: 'Data-race detection, happens-before, and lock ordering'
version: 1.0.0
...
2. Run deterministic heuristics for **Race Condition Hunter** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/race-condition-hunter-agent/cli/race_condition_hunter.py --help`
