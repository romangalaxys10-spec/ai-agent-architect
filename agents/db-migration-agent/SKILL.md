...
description: 'Schema diff, zero-downtime migration plans, rollback scripts, data backfill verification'
version: 1.0.0
...
2. Run deterministic heuristics for **Database Migration Strategist** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/db-migration-agent/cli/db_migration.py --help`
