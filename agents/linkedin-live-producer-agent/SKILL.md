---
name: linkedin-live-producer-agent
description: 'Live event run-of-show, speaker comms, and replay repurposing'
version: 1.0.0
author: AI Agent Architect
category: 'Social: LinkedIn'
---

# LinkedIn Live Producer
...
2. Run deterministic heuristics for **LinkedIn Live Producer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-live-producer-agent/cli/linkedin_live_producer.py --help`
