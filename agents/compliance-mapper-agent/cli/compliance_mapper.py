"""CLI for Compliance Mapper — SOC2/ISO27001/HIPAA control mapping, evidence collection checklists, gap heatmaps"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Compliance Mapper — SOC2/ISO27001/HIPAA control mapping, evidence collection checklists, gap heatmaps')
    ...
    from core.compliance_mapper_engine import ComplianceMapperEngine
    analysis = ComplianceMapperEngine.analyze(text)
    if args.json:
        ...
        print(ComplianceMapperEngine.format_report(analysis))
