"""CLI for RevOps Auditor — Funnel stage conversion, forecast hygiene, territory balancing, comp-plan alignment"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='RevOps Auditor — Funnel stage conversion, forecast hygiene, territory balancing, comp-plan alignment')
    ...
    from core.revenue_ops_engine import RevenueOpsEngine
    analysis = RevenueOpsEngine.analyze(text)
    if args.json:
        ...
        print(RevenueOpsEngine.format_report(analysis))
