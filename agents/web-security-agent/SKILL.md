...
description: 'CSP/HSTS/XFO audit, mixed-content detection, and SRI/subresource integrity checks'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Web Security Sentinel
...
2. Run deterministic heuristics for **Web Security Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/web-security-agent/cli/web_security.py --help`
