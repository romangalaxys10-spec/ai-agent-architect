"""CLI for Event Producer — Run-of-show authoring, speaker/venue logistics, contingency branches, post-event retro"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Event Producer — Run-of-show authoring, speaker/venue logistics, contingency branches, post-event retro')
    ...
    from core.event_producer_engine import EventProducerEngine
    analysis = EventProducerEngine.analyze(text)
    if args.json:
        ...
        print(EventProducerEngine.format_report(analysis))
