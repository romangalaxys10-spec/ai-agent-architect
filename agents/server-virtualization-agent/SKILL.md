---
name: server-virtualization-agent
description: 'KVM/QEMU/libvirt, live migration, and snapshot hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Server Mgmt'
---

# Server Virtualization Pilot
...
2. Run deterministic heuristics for **Server Virtualization Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-virtualization-agent/cli/server_virtualization.py --help`
