---
name: youtube-collab-scout-agent
description: 'Collab fit, audience overlap, and cross-promo planning'
version: 1.0.0
author: AI Agent Architect
category: 'Social: YouTube'
---

# YouTube Collab Scout
...
2. Run deterministic heuristics for **YouTube Collab Scout** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-collab-scout-agent/cli/youtube_collab_scout.py --help`
