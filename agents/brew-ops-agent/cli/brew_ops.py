"""CLI for Homebrew Ops — Formula/cask lifecycle, pin, bottle vs source, and cleanup/doctor diagnostics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Homebrew Ops — Formula/cask lifecycle, pin, bottle vs source, and cleanup/doctor diagnostics")
    ...
    from core.brew_ops_engine import BrewOpsEngine
    analysis=BrewOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(BrewOpsEngine.format_report(analysis))
