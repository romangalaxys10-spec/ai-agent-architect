---
name: creator-monetization-agent
description: 'Revenue stream mapping, tier pricing, sponsor-fit scoring, payout optimization'
version: 1.0.0
...
2. Run deterministic heuristics for **Creator Monetization Scout** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/creator-monetization-agent/cli/creator_monetization.py --help`
