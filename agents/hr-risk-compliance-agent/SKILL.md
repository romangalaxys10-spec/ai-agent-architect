---
name: hr-risk-compliance-agent
description: 'Employment law, policy compliance, audit readiness, and mitigation playbooks'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# HR Risk & Compliance Sentinel
...
2. Run deterministic heuristics for **HR Risk & Compliance Sentinel** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/hr-risk-compliance-agent/cli/hr_risk_compliance.py --help`
