---
name: solana-rpc-surgeon-agent
description: 'RPC latency, rate-limits, Geyser/Yellowstone feeds, and failover routing'
version: 1.0.0
...
2. Run deterministic heuristics for **Solana RPC Surgeon** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-rpc-surgeon-agent/cli/solana_rpc_surgeon.py --help`
