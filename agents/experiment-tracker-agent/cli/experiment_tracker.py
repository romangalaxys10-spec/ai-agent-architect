"""CLI for Experiment Tracker & Comparator — Run comparison matrices, hyperparam importance, early-stopping verdicts, reproducibility checklists"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Experiment Tracker & Comparator — Run comparison matrices, hyperparam importance, early-stopping verdicts, reproducibility checklists')
    ...
    from core.experiment_tracker_engine import ExperimentTrackerEngine
    analysis = ExperimentTrackerEngine.analyze(text)
    if args.json:
        ...
        print(ExperimentTrackerEngine.format_report(analysis))
