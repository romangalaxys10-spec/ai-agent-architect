---
name: prompt-ops-agent
description: 'Prompt versioning, regression evals, few-shot curation, token-cost vs quality tradeoffs'
version: 1.0.0
...
2. Run deterministic heuristics for **Prompt Engineering Ops** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/prompt-ops-agent/cli/prompt_ops.py --help`
