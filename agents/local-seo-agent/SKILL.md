...
description: 'NAP consistency audit, review velocity tracking, GMB optimization checklist'
version: 1.0.0
...
2. Run deterministic heuristics for **Local SEO Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/local-seo-agent/cli/local_seo.py --help`
