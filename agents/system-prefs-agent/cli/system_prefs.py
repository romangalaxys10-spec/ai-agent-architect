"""CLI for System Preferences Tuner — Settings search, plist/registry diffing, profile provisioning, and drift enforcement"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="System Preferences Tuner — Settings search, plist/registry diffing, profile provisioning, and drift enforcement")
    ...
    from core.system_prefs_engine import SystemPrefsEngine
    analysis=SystemPrefsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(SystemPrefsEngine.format_report(analysis))
