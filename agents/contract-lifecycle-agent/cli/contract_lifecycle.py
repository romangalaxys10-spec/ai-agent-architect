"""CLI for Contract Lifecycle Manager — Obligation extraction, renewal/deadline tracking, clause deviation flagging"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Contract Lifecycle Manager — Obligation extraction, renewal/deadline tracking, clause deviation flagging')
    ...
    from core.contract_lifecycle_engine import ContractLifecycleEngine
    analysis = ContractLifecycleEngine.analyze(text)
    if args.json:
        ...
        print(ContractLifecycleEngine.format_report(analysis))
