---
name: event-producer-agent
description: 'Run-of-show authoring, speaker/venue logistics, contingency branches, post-event retro'
version: 1.0.0
...
2. Run deterministic heuristics for **Event Producer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/event-producer-agent/cli/event_producer.py --help`
