---
name: nginx-ops-agent
description: 'vhosts, upstreams, mTLS, rate-limit, and config test/ reload choreography'
version: 1.0.0
...
2. Run deterministic heuristics for **Nginx Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/nginx-ops-agent/cli/nginx_ops.py --help`
