---
name: webrtc-media-agent
description: 'Peer connection forensics, ICE candidate mapping, bandwidth/echo diagnostics'
version: 1.0.0
...
2. Run deterministic heuristics for **WebRTC Media Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/webrtc-media-agent/cli/webrtc_media.py --help`
