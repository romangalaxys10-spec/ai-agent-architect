...
description: 'Interaction scoring against rubric, coaching themes, calibration packet assembly'
version: 1.0.0
...
2. Run deterministic heuristics for **Support QA Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/support-qa-agent/cli/support_qa.py --help`
