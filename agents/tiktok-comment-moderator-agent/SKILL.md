---
name: tiktok-comment-moderator-agent
description: 'Spam, hate, and brand-safety moderation at TikTok scale'
version: 1.0.0
author: AI Agent Architect
category: 'Social: TikTok'
---

# TikTok Comment Moderator
...
2. Run deterministic heuristics for **TikTok Comment Moderator** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-comment-moderator-agent/cli/tiktok_comment_moderator.py --help`
