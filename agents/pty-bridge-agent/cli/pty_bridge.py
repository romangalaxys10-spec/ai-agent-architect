"""CLI for PTY Bridge — Pseudo-terminal allocation, raw mode, echo suppression, and resize propagation"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="PTY Bridge — Pseudo-terminal allocation, raw mode, echo suppression, and resize propagation")
    ...
    from core.pty_bridge_engine import PtyBridgeEngine
    analysis=PtyBridgeEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(PtyBridgeEngine.format_report(analysis))
