---
name: cdn-edge-agent
description: 'Cache keys, purge, stale-while-revalidate, and edge function forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **CDN & Edge Tuner** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/cdn-edge-agent/cli/cdn_edge.py --help`
