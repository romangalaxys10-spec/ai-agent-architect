---
name: sdk-forge-agent
description: 'Multi-language SDK scaffolding from OpenAPI/Proto, versioned changelogs, breaking-change detection'
version: 1.0.0
...
2. Run deterministic heuristics for **SDK & Client Generator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/sdk-forge-agent/cli/sdk_forge.py --help`
