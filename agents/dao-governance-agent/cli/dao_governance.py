"""CLI for DAO Governance Pilot — Proposals, voting, and execution queue ops"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="DAO Governance Pilot — Proposals, voting, and execution queue ops")
    ...
    from core.dao_governance_engine import DaoGovernanceEngine
    analysis=DaoGovernanceEngine.analyze(text)
    if args.json:
        ...
        print(DaoGovernanceEngine.format_report(analysis))
