---
name: subtitle-transcription-agent
description: 'Whisper-grade transcription, translation, and burned-in subtitle styling'
version: 1.0.0
...
2. Run deterministic heuristics for **Subtitle & Transcription Engine** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/subtitle-transcription-agent/cli/subtitle_transcription.py --help`
