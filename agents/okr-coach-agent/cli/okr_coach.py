"""CLI for OKR Coach — Objective quality scoring, key-result measurability checks, alignment mapping, retrospective synthesis"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='OKR Coach — Objective quality scoring, key-result measurability checks, alignment mapping, retrospective synthesis')
    ...
    from core.okr_coach_engine import OkrCoachEngine
    analysis = OkrCoachEngine.analyze(text)
    if args.json:
        ...
        print(OkrCoachEngine.format_report(analysis))
