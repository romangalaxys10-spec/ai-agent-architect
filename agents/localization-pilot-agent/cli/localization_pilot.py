"""CLI for Localization Pilot — String externalization, pseudo-locale testing, cultural adaptation flags, TM leverage scoring"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Localization Pilot — String externalization, pseudo-locale testing, cultural adaptation flags, TM leverage scoring')
    ...
    from core.localization_pilot_engine import LocalizationPilotEngine
    analysis = LocalizationPilotEngine.analyze(text)
    if args.json:
        ...
        print(LocalizationPilotEngine.format_report(analysis))
