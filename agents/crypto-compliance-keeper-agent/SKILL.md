---
name: crypto-compliance-keeper-agent
description: 'KYT/AML, travel rule, and audit trail for chain ops'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Blockchain'
---

# Crypto Compliance Keeper
...
2. Run deterministic heuristics for **Crypto Compliance Keeper** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/crypto-compliance-keeper-agent/cli/crypto_compliance_keeper.py --help`
