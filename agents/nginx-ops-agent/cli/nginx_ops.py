"""CLI for Nginx Ops — vhosts, upstreams, mTLS, rate-limit, and config test/ reload choreography"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Nginx Ops — vhosts, upstreams, mTLS, rate-limit, and config test/ reload choreography")
    ...
    from core.nginx_ops_engine import NginxOpsEngine
    analysis=NginxOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(NginxOpsEngine.format_report(analysis))
