---
name: cdn-optimizer-global-agent
description: 'Edge cache keys, tiered caching, and purge hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Security/Optimization'
---

# CDN Optimizer (Global)
...
2. Run deterministic heuristics for **CDN Optimizer (Global)** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/cdn-optimizer-global-agent/cli/cdn_optimizer_global.py --help`
