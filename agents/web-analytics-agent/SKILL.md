...
description: 'Funnel drop analysis, cohort retention curves, attribution model comparison'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Web Analytics Interpreter
...
2. Run deterministic heuristics for **Web Analytics Interpreter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/web-analytics-agent/cli/web_analytics.py --help`
