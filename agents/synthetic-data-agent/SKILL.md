...
description: 'Privacy-preserving synthetic generation, fidelity metrics, bias preservation checks'
version: 1.0.0
...
2. Run deterministic heuristics for **Synthetic Data Forge** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/synthetic-data-agent/cli/synthetic_data.py --help`
