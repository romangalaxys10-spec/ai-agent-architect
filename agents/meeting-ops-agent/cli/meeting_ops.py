"""CLI for Meeting Operations Auditor — Meeting load analysis, purpose/attendee pruning, async-shift recommendations"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Meeting Operations Auditor — Meeting load analysis, purpose/attendee pruning, async-shift recommendations')
    ...
    from core.meeting_ops_engine import MeetingOpsEngine
    analysis = MeetingOpsEngine.analyze(text)
    if args.json:
        ...
        print(MeetingOpsEngine.format_report(analysis))
