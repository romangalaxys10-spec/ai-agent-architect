---
name: three-studio-max-agent
description: '3ds Max modeling, modifiers, and Arnold/V-Ray scene assembly'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# 3ds Max Studio Pilot
...
2. Run deterministic heuristics for **3ds Max Studio Pilot** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/three-studio-max-agent/cli/three_studio_max.py --help`
