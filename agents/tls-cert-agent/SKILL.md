---
name: tls-cert-agent
description: 'ACME/Let''s Encrypt, chain validation, OCSP, and cert-rotation without downtime'
version: 1.0.0
...
2. Run deterministic heuristics for **TLS Cert Steward** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/tls-cert-agent/cli/tls_cert.py --help`
