---
name: perf-bottleneck-agent
description: 'Latency budgets, flame graphs, and regression gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Perf Bottleneck Hunter** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/perf-bottleneck-agent/cli/perf_bottleneck.py --help`
