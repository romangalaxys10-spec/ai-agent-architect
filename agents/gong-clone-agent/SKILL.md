---
name: gong-clone-agent
description: 'Call transcript themes, competitor mention tracking, coaching moment extraction'
version: 1.0.0
...
2. Run deterministic heuristics for **Conversation Intelligence Miner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/gong-clone-agent/cli/gong_clone.py --help`
