"""CLI for Brand System Curator — Brand tokens, typography, and component API harmony"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Brand System Curator — Brand tokens, typography, and component API harmony")
    ...
    from core.brand_system_engine import BrandSystemEngine
    analysis=BrandSystemEngine.analyze(text)
    if args.json:
        ...
        print(BrandSystemEngine.format_report(analysis))
