---
name: accessibility-design-auditor-agent
description: 'WCAG 2.2, contrast, and screen-reader order for design'
version: 1.0.0
...
2. Run deterministic heuristics for **A11y Design Auditor** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/accessibility-design-auditor-agent/cli/accessibility_design_auditor.py --help`
