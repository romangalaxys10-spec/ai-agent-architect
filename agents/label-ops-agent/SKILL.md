---
name: label-ops-agent
description: 'Label schema design, IAA measurement, active-learning queue prioritization, QA sampling plans'
version: 1.0.0
...
2. Run deterministic heuristics for **Data Labeling Ops** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/label-ops-agent/cli/label_ops.py --help`
