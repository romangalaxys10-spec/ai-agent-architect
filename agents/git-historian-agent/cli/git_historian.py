"""CLI for Git History Archaeologist — Blame forensics, bisect automation, contributor graphs, tech-debt timeline mapping"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Git History Archaeologist — Blame forensics, bisect automation, contributor graphs, tech-debt timeline mapping')
    ...
    from core.git_historian_engine import GitHistorianEngine
    analysis = GitHistorianEngine.analyze(text)
    if args.json:
        ...
        print(GitHistorianEngine.format_report(analysis))
