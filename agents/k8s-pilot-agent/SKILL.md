...
description: 'kubectl, helm, Kustomize, CNI/CSI forensics, and etcd backup/restore'
version: 1.0.0
...
2. Run deterministic heuristics for **K8s Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/k8s-pilot-agent/cli/k8s_pilot.py --help`
