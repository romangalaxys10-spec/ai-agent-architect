"""CLI for Security Hardening Sentinel — CIS benchmarks, Lynis scoring, fail2ban, AppArmor/SELinux, and auditd"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Security Hardening Sentinel — CIS benchmarks, Lynis scoring, fail2ban, AppArmor/SELinux, and auditd")
    ...
    from core.sec_hardening_engine import SecHardeningEngine
    analysis=SecHardeningEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(SecHardeningEngine.format_report(analysis))
