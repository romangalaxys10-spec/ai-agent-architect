"""CLI for RAG System Architect — Chunking/embedding model selection, retrieval grading, citation grounding, hallucination rate measurement"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='RAG System Architect — Chunking/embedding model selection, retrieval grading, citation grounding, hallucination rate measurement')
    ...
    from core.rag_architect_engine import RagArchitectEngine
    analysis = RagArchitectEngine.analyze(text)
    if args.json:
        ...
        print(RagArchitectEngine.format_report(analysis))
