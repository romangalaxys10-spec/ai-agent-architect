---
name: static-analysis-orchestrator-agent
description: 'Lints, SAST, type-check orchestration with SARIF rollup'
version: 1.0.0
...
2. Run deterministic heuristics for **Static Analysis Orchestrator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/static-analysis-orchestrator-agent/cli/static_analysis_orchestrator.py --help`
