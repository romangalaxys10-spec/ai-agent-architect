---
name: landing-page-designer-agent
description: 'Hero, social proof, and CTA hierarchy for high conversion'
version: 1.0.0
...
2. Run deterministic heuristics for **Landing Page Designer** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/landing-page-designer-agent/cli/landing_page_designer.py --help`
