"""CLI for Talent Sourcer — Boolean search construction, profile-fit scoring, outreach personalization, pipeline health tracking"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Talent Sourcer — Boolean search construction, profile-fit scoring, outreach personalization, pipeline health tracking')
    ...
    from core.talent_sourcer_engine import TalentSourcerEngine
    analysis = TalentSourcerEngine.analyze(text)
    if args.json:
        ...
        print(TalentSourcerEngine.format_report(analysis))
