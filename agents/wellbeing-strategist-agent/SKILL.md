---
name: wellbeing-strategist-agent
description: 'Wellbeing pillars, program portfolio, and manager enablement'
version: 1.0.0
...
2. Run deterministic heuristics for **Wellbeing Strategist** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/wellbeing-strategist-agent/cli/wellbeing_strategist.py --help`
