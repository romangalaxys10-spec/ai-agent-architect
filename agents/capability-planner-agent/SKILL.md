...
description: 'Future capability planning: critical roles × skills × time horizon matrix'
version: 1.0.0
...
2. Run deterministic heuristics for **Capability Planner** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/capability-planner-agent/cli/capability_planner.py --help`
