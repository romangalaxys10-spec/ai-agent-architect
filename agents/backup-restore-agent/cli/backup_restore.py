"""CLI for Backup & Restore Orchestrator — rsync/restic/borg, push vs pull, encryption, and restore drill verification"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Backup & Restore Orchestrator — rsync/restic/borg, push vs pull, encryption, and restore drill verification")
    ...
    from core.backup_restore_engine import BackupRestoreEngine
    analysis=BackupRestoreEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(BackupRestoreEngine.format_report(analysis))
