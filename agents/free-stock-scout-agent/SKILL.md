---
name: free-stock-scout-agent
description: 'Discover free stock video/images across Pexels/Pixabay/Unsplash/Mixkit/Coverr with license filters'
version: 1.0.0
...
2. Run deterministic heuristics for **Free Stock Scout** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/free-stock-scout-agent/cli/free_stock_scout.py --help`
