...
description: 'Audience overlap scoring, authenticity checks, brief generation, performance attribution'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Influencer & Creator Scout
...
2. Run deterministic heuristics for **Influencer & Creator Scout** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/influencer-scout-agent/cli/influencer_scout.py --help`
