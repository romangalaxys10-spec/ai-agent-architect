---
name: log-tail-agent
description: 'Follow-mode, ANSI stripping, pattern alerting, and backpressure handling'
version: 1.0.0
...
2. Run deterministic heuristics for **Log Tail & Watch** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/log-tail-agent/cli/log_tail.py --help`
