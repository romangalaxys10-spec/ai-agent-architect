---
name: cohort-learning-agent
description: 'Cohort-based courses: pacing, peer learning, accountability, and community'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Cohort Learning Producer
...
2. Run deterministic heuristics for **Cohort Learning Producer** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/cohort-learning-agent/cli/cohort_learning.py --help`
