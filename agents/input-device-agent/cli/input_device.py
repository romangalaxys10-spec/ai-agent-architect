"""CLI for Input Device Manager — Keyboard/mouse/gamepad pairing, driver health, DPI/remap sync, and latency checks"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Input Device Manager — Keyboard/mouse/gamepad pairing, driver health, DPI/remap sync, and latency checks")
    ...
    from core.input_device_engine import InputDeviceEngine
    analysis=InputDeviceEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(InputDeviceEngine.format_report(analysis))
