---
name: recognition-rituals-agent
description: 'Recognition systems: peer, milestone, and values-tied rituals'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Recognition Rituals Designer
...
2. Run deterministic heuristics for **Recognition Rituals Designer** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/recognition-rituals-agent/cli/recognition_rituals.py --help`
