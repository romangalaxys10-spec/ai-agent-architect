---
name: mouse-precision-agent
description: 'DPI-aware moves, drag semantics, hover intent, and pixel-perfect assertion'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Mouse Precision Engine
...
2. Run deterministic heuristics for **Mouse Precision Engine** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/mouse-precision-agent/cli/mouse_precision.py --help`
