"""CLI for Audio Cleanup Lab — Denoise, de-reverb, de-click, and spectral restoration"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Audio Cleanup Lab — Denoise, de-reverb, de-click, and spectral restoration")
    ...
    from core.audio_cleanup_engine import AudioCleanupEngine
    analysis=AudioCleanupEngine.analyze(text)
    if args.json:
        ...
        print(AudioCleanupEngine.format_report(analysis))
