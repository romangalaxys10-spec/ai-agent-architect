"""CLI for API Design & Spec Generator — Designs REST/GraphQL/gRPC APIs with OpenAPI specs, versioning, and contract tests"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='API Design & Spec Generator — Designs REST/GraphQL/gRPC APIs with OpenAPI specs, versioning, and contract tests')
    ...
    from core.api_architect_engine import ApiArchitectEngine
    analysis = ApiArchitectEngine.analyze(text)
    if args.json:
        ...
        print(ApiArchitectEngine.format_report(analysis))
