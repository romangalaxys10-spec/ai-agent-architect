"""CLI for Legal Ops Orchestrator — Matter intake, outside-counsel spend tracking, playbook compliance, ebilling audit"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Legal Ops Orchestrator — Matter intake, outside-counsel spend tracking, playbook compliance, ebilling audit')
    ...
    from core.legal_ops_engine import LegalOpsEngine
    analysis = LegalOpsEngine.analyze(text)
    if args.json:
        ...
        print(LegalOpsEngine.format_report(analysis))
