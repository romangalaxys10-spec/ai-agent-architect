"""CLI for Creator Monetization Scout — Revenue stream mapping, tier pricing, sponsor-fit scoring, payout optimization"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Creator Monetization Scout — Revenue stream mapping, tier pricing, sponsor-fit scoring, payout optimization')
    ...
    from core.creator_monetization_engine import CreatorMonetizationEngine
    analysis = CreatorMonetizationEngine.analyze(text)
    if args.json:
        ...
        print(CreatorMonetizationEngine.format_report(analysis))
