...
description: 'SPC chart interpretation, defect Pareto, CAPA tracking, traceability mapping'
version: 1.0.0
author: AI Agent Architect
category: 'Vertical Specialists'
---

# Manufacturing QA Sentinel
...
2. Run deterministic heuristics for **Manufacturing QA Sentinel** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/manufacturing-qa-agent/cli/manufacturing_qa.py --help`
