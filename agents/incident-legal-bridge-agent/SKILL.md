---
name: incident-legal-bridge-agent
description: 'Breach classification, notification timeline, regulator mapping, disclosure draft generation'
version: 1.0.0
author: AI Agent Architect
category: 'Security & Compliance'
---

# Breach Disclosure Drafter
...
2. Run deterministic heuristics for **Breach Disclosure Drafter** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/incident-legal-bridge-agent/cli/incident_legal_bridge.py --help`
