---
name: talent-sourcer-agent
description: 'Boolean search construction, profile-fit scoring, outreach personalization, pipeline health tracking'
version: 1.0.0
...
2. Run deterministic heuristics for **Talent Sourcer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/talent-sourcer-agent/cli/talent_sourcer.py --help`
