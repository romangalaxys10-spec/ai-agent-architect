"""CLI for X DM Funnel — Public → DM permission, value ladders, and auto-qualify"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="X DM Funnel — Public → DM permission, value ladders, and auto-qualify")
    ...
    from core.x_dm_funnel_engine import XDmFunnelEngine
    analysis=XDmFunnelEngine.analyze(text)
    if args.json:
        ...
        print(XDmFunnelEngine.format_report(analysis))
