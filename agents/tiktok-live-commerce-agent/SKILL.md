---
name: tiktok-live-commerce-agent
description: 'Live run-of-show, gifting, and shop conversion'
version: 1.0.0
...
2. Run deterministic heuristics for **TikTok Live Commerce** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-live-commerce-agent/cli/tiktok_live_commerce.py --help`
