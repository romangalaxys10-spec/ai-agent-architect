---
name: forecast-radar-agent
description: 'Pipeline coverage math, stage-weighted forecast, risk-adjusted commit calls'
version: 1.0.0
author: AI Agent Architect
category: 'Sales & Revenue Ops'
---

# Revenue Forecast Radar
...
2. Run deterministic heuristics for **Revenue Forecast Radar** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/forecast-radar-agent/cli/forecast_radar.py --help`
