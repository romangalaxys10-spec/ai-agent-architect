---
name: io-tuner-agent
description: 'iostat, io_uring, and queue-depth tuning'
version: 1.0.0
...
2. Run deterministic heuristics for **IO Tuner** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/io-tuner-agent/cli/io_tuner.py --help`
