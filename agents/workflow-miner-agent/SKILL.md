---
name: workflow-miner-agent
description: 'Process mining from logs, variant analysis, automation opportunity ranking'
version: 1.0.0
...
2. Run deterministic heuristics for **Workflow Miner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/workflow-miner-agent/cli/workflow_miner.py --help`
