---
name: touch-gesture-agent
description: 'Trackpad/phone gestures, palm rejection, pressure curves, and haptic feedback mapping'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Touch & Gesture Interpreter
...
2. Run deterministic heuristics for **Touch & Gesture Interpreter** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/touch-gesture-agent/cli/touch_gesture.py --help`
