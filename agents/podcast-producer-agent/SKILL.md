...
description: 'Episode arcs, show-note generation, guest research packs, distribution checklist'
version: 1.0.0
...
2. Run deterministic heuristics for **Podcast Producer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/podcast-producer-agent/cli/podcast_producer.py --help`
