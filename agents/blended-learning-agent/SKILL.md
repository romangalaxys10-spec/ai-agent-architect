---
name: blended-learning-agent
description: 'Blended journeys: pre-work → live → practice → reinforcement spacing'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Blended Learning Choreographer
...
2. Run deterministic heuristics for **Blended Learning Choreographer** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/blended-learning-agent/cli/blended_learning.py --help`
