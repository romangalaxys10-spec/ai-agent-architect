---
name: memory-ops-agent
description: 'Memory tier health, compaction trigger tuning, recall precision measurement, curation backlog'
version: 1.0.0
...
2. Run deterministic heuristics for **Memory Ops Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/memory-ops-agent/cli/memory_ops.py --help`
