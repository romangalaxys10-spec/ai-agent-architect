---
name: linux-user-governance-agent
description: 'PAM, sudoers, and orphaned account hunting'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Linux'
---

# Linux User Governance
...
2. Run deterministic heuristics for **Linux User Governance** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-user-governance-agent/cli/linux_user_governance.py --help`
