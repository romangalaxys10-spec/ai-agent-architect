"""CLI for Sales Call Coach — MEDDICC gap analysis, talk-time metrics, objection handling plays, next-step enforcement"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Sales Call Coach — MEDDICC gap analysis, talk-time metrics, objection handling plays, next-step enforcement')
    ...
    from core.sales_coach_engine import SalesCoachEngine
    analysis = SalesCoachEngine.analyze(text)
    if args.json:
        ...
        print(SalesCoachEngine.format_report(analysis))
