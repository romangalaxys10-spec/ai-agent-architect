---
name: free-audio-scout-agent
description: 'Free music/SFX (Pixabay Music, Mixkit, YouTube Audio Library) with license hygiene'
version: 1.0.0
...
2. Run deterministic heuristics for **Free Audio Scout** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/free-audio-scout-agent/cli/free_audio_scout.py --help`
