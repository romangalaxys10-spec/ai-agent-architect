---
name: solana-payments-pilot-agent
description: 'PayFi, fee sponsorship, and payment rail ops'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Solana'
---

# Solana Payments Pilot
...
2. Run deterministic heuristics for **Solana Payments Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-payments-pilot-agent/cli/solana_payments_pilot.py --help`
