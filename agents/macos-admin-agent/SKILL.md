---
name: macos-admin-agent
description: 'launchd, defaults, profiles, MDM, SIP/TCC, and `systemextensionsctl`'
version: 1.0.0
...
2. Run deterministic heuristics for **macOS Admin** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/macos-admin-agent/cli/macos_admin.py --help`
