"""CLI for DOM Forensics — Selector resilience scoring, shadow-DOM piercing, hydration mismatch detection"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="DOM Forensics — Selector resilience scoring, shadow-DOM piercing, hydration mismatch detection")
    ...
    from core.dom_forensics_engine import DomForensicsEngine
    analysis=DomForensicsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(DomForensicsEngine.format_report(analysis))
