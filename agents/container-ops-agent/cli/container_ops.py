"""CLI for Container Ops — Docker/Podman, cgroups, overlayfs, rootless, and image provenance (cosign)"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Container Ops — Docker/Podman, cgroups, overlayfs, rootless, and image provenance (cosign)")
    ...
    from core.container_ops_engine import ContainerOpsEngine
    analysis=ContainerOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(ContainerOpsEngine.format_report(analysis))
