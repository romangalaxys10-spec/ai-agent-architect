...
description: 'Capacity modeling, hiring plan phasing, attrition risk flags, org design options'
version: 1.0.0
...
2. Run deterministic heuristics for **Workforce Planner** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/workforce-planner-agent/cli/workforce_planner.py --help`
