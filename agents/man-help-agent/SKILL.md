---
name: man-help-agent
description: 'Man page summarization, flag inference, example harvesting, and TL;DR generation'
version: 1.0.0
author: AI Agent Architect
category: 'Terminal Use'
---

# Man & Help Synthesizer
...
2. Run deterministic heuristics for **Man & Help Synthesizer** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/man-help-agent/cli/man_help.py --help`
