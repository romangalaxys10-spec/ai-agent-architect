"""CLI for Growth Loops Architect — Loop mapping (acquisition/retention/monetization), unit economics, experiment backlog"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Growth Loops Architect — Loop mapping (acquisition/retention/monetization), unit economics, experiment backlog')
    ...
    from core.growth_loops_engine import GrowthLoopsEngine
    analysis = GrowthLoopsEngine.analyze(text)
    if args.json:
        ...
        print(GrowthLoopsEngine.format_report(analysis))
