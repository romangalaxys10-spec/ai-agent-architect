---
name: x-reply-bot-agent
description: 'Reply-guy strategy, context-aware replies, and rate-limit safety'
version: 1.0.0
...
2. Run deterministic heuristics for **X Reply Bot** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/x-reply-bot-agent/cli/x_reply_bot.py --help`
