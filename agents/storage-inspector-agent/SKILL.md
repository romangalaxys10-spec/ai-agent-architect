---
name: storage-inspector-agent
description: 'LocalStorage/SessionStorage/IndexedDB/cookies audit, quota sizing, and eviction forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Storage Inspector** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/storage-inspector-agent/cli/storage_inspector.py --help`
