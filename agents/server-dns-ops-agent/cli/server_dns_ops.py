"""CLI for Server DNS Ops — 权威 DNS, split-horizon, and DNSSEC forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Server DNS Ops — 权威 DNS, split-horizon, and DNSSEC forensics")
    ...
    from core.server_dns_ops_engine import ServerDnsOpsEngine
    analysis=ServerDnsOpsEngine.analyze(text)
    if args.json:
        ...
        print(ServerDnsOpsEngine.format_report(analysis))
