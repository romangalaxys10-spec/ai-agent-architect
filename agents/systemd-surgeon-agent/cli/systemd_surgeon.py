"""CLI for Systemd Surgeon — Unit authoring, dependency ordering, socket activation, and journald forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Systemd Surgeon — Unit authoring, dependency ordering, socket activation, and journald forensics")
    ...
    from core.systemd_surgeon_engine import SystemdSurgeonEngine
    analysis=SystemdSurgeonEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(SystemdSurgeonEngine.format_report(analysis))
