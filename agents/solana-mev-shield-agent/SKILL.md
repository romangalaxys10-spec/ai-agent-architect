---
name: solana-mev-shield-agent
description: 'Jito bundles, MEV forensics, and protection routing'
version: 1.0.0
...
2. Run deterministic heuristics for **Solana MEV Shield** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-mev-shield-agent/cli/solana_mev_shield.py --help`
