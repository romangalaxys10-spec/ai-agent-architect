---
name: linux-log-forensics-agent
description: 'journalctl, logrotate, and centralized shipping'
version: 1.0.0
...
2. Run deterministic heuristics for **Linux Log Forensics** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linux-log-forensics-agent/cli/linux_log_forensics.py --help`
