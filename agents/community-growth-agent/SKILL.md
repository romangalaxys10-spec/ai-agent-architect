...
description: 'Activation funnel, referral loop design, moderation at scale, UGC flywheel'
version: 1.0.0
...
2. Run deterministic heuristics for **Community Growth Hacker** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/community-growth-agent/cli/community_growth.py --help`
