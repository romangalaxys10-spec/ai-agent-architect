...
description: 'SOC2/ISO27001/HIPAA control mapping, evidence collection checklists, gap heatmaps'
version: 1.0.0
...
2. Run deterministic heuristics for **Compliance Mapper** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/compliance-mapper-agent/cli/compliance_mapper.py --help`
