---
name: evm-node-ops-agent
description: 'Geth/Reth/Erigon sync, peering, and pruning for EVM chains'
version: 1.0.0
...
2. Run deterministic heuristics for **EVM Node Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/evm-node-ops-agent/cli/evm_node_ops.py --help`
