"""CLI for Eval Judge Forge — Rubric authoring, LLM-as-judge calibration, inter-rater agreement scoring, golden-set expansion"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Eval Judge Forge — Rubric authoring, LLM-as-judge calibration, inter-rater agreement scoring, golden-set expansion')
    ...
    from core.eval_judge_engine import EvalJudgeEngine
    analysis = EvalJudgeEngine.analyze(text)
    if args.json:
        ...
        print(EvalJudgeEngine.format_report(analysis))
