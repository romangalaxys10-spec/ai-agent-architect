---
name: youtube-seo-optimizer-agent
description: 'Title/tags/chapters, search vs suggested, and CTR from impressions'
version: 1.0.0
...
2. Run deterministic heuristics for **YouTube SEO Optimizer** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-seo-optimizer-agent/cli/youtube_seo_optimizer.py --help`
