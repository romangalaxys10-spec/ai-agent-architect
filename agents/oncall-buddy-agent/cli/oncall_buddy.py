"""CLI for On-Call Companion — Runbook retrieval, escalation routing, post-page context assembly, handoff summaries"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='On-Call Companion — Runbook retrieval, escalation routing, post-page context assembly, handoff summaries')
    ...
    from core.oncall_buddy_engine import OncallBuddyEngine
    analysis = OncallBuddyEngine.analyze(text)
    if args.json:
        ...
        print(OncallBuddyEngine.format_report(analysis))
