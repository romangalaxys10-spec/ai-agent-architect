...
description: 'Chunking/embedding model selection, retrieval grading, citation grounding, hallucination rate measurement'
version: 1.0.0
...
2. Run deterministic heuristics for **RAG System Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/rag-architect-agent/cli/rag_architect.py --help`
