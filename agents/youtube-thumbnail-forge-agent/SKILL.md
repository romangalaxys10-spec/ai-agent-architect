---
name: youtube-thumbnail-forge-agent
description: 'Thumbnail contrast, face/eyes, text sparsity, and A/B planning'
version: 1.0.0
author: AI Agent Architect
category: 'Social: YouTube'
---

# YouTube Thumbnail Forge
...
2. Run deterministic heuristics for **YouTube Thumbnail Forge** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-thumbnail-forge-agent/cli/youtube_thumbnail_forge.py --help`
