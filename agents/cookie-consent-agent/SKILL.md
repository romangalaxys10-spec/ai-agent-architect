...
description: 'CMP banner classification, preference persistence, and consent-string validation'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Cookie Consent Navigator
...
2. Run deterministic heuristics for **Cookie Consent Navigator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/cookie-consent-agent/cli/cookie_consent.py --help`
