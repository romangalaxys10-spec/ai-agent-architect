...
description: 'Language/framework translation plans with semantic equivalence checks and test scaffolding'
version: 1.0.0
author: AI Agent Architect
category: 'Coding & DevOps'
---

# Polyglot Code Transpiler
...
2. Run deterministic heuristics for **Polyglot Code Transpiler** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/code-migration-agent/cli/code_migration.py --help`
