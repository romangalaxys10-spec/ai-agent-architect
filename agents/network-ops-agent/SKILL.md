...
description: 'iptables/nftables, ip route, DNS (systemd-resolved/Unbound), and mtr forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **Network Ops** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/network-ops-agent/cli/network_ops.py --help`
