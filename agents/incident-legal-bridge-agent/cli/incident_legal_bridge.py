"""CLI for Breach Disclosure Drafter — Breach classification, notification timeline, regulator mapping, disclosure draft generation"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Breach Disclosure Drafter — Breach classification, notification timeline, regulator mapping, disclosure draft generation')
    ...
    from core.incident_legal_bridge_engine import IncidentLegalBridgeEngine
    analysis = IncidentLegalBridgeEngine.analyze(text)
    if args.json:
        ...
        print(IncidentLegalBridgeEngine.format_report(analysis))
