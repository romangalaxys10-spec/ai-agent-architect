---
name: inclusion-belonging-agent
description: 'Belonging diagnostics, moments that matter, and intervention sequencing'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Inclusion & Belonging Weaver
...
2. Run deterministic heuristics for **Inclusion & Belonging Weaver** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/inclusion-belonging-agent/cli/inclusion_belonging.py --help`
