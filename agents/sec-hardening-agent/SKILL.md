---
name: sec-hardening-agent
description: 'CIS benchmarks, Lynis scoring, fail2ban, AppArmor/SELinux, and auditd'
version: 1.0.0
...
2. Run deterministic heuristics for **Security Hardening Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/sec-hardening-agent/cli/sec_hardening.py --help`
