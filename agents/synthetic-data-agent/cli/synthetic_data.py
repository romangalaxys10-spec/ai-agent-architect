"""CLI for Synthetic Data Forge — Privacy-preserving synthetic generation, fidelity metrics, bias preservation checks"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Synthetic Data Forge — Privacy-preserving synthetic generation, fidelity metrics, bias preservation checks')
    ...
    analysis = SyntheticDataEngine.analyze(text)
    if args.json:
        ...
        print(SyntheticDataEngine.format_report(analysis))
