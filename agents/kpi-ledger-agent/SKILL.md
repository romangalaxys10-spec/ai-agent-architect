---
name: kpi-ledger-agent
description: 'North-star decomposition, metric ownership, anomaly alerts, board-ready rollups'
version: 1.0.0
...
2. Run deterministic heuristics for **KPI Ledger Keeper** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/kpi-ledger-agent/cli/kpi_ledger.py --help`
