---
name: log-trace-correlator-agent
description: 'Correlates logs↔traces↔metrics via trace IDs and baggage'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Debugging/Code Review'
---

# Log-Trace Correlator
...
2. Run deterministic heuristics for **Log-Trace Correlator** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/log-trace-correlator-agent/cli/log_trace_correlator.py --help`
