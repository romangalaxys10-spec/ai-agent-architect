"""CLI for CDN & Edge Tuner — Cache keys, purge, stale-while-revalidate, and edge function forensics"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="CDN & Edge Tuner — Cache keys, purge, stale-while-revalidate, and edge function forensics")
    ...
    from core.cdn_edge_engine import CdnEdgeEngine
    analysis=CdnEdgeEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(CdnEdgeEngine.format_report(analysis))
