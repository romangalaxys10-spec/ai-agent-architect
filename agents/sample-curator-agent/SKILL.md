---
name: sample-curator-agent
description: 'Sample pack curation, key/BPM tagging, and crate-dig hygiene'
version: 1.0.0
...
2. Run deterministic heuristics for **Sample Curator** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/sample-curator-agent/cli/sample_curator.py --help`
