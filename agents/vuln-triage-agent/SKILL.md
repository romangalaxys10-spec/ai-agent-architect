---
name: vuln-triage-agent
description: 'CVE intake, EPSS, and patch priority with SLAs'
version: 1.0.0
...
2. Run deterministic heuristics for **Vuln Triage Sentinel** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/vuln-triage-agent/cli/vuln_triage.py --help`
