---
name: tiktok-hashtag-virality-agent
description: 'Hashtag tiering, challenge fit, and banned-tag hygiene'
version: 1.0.0
author: AI Agent Architect
category: 'Social: TikTok'
---

# TikTok Hashtag Virality
...
2. Run deterministic heuristics for **TikTok Hashtag Virality** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/tiktok-hashtag-virality-agent/cli/tiktok_hashtag_virality.py --help`
