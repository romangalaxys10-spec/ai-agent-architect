"""CLI for Dashboard & BI Crafter — KPI tree design, chart selection logic, SQL generation, stakeholder-ready narrative framing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Dashboard & BI Crafter — KPI tree design, chart selection logic, SQL generation, stakeholder-ready narrative framing')
    ...
    from core.dashboard_crafter_engine import DashboardCrafterEngine
    analysis = DashboardCrafterEngine.analyze(text)
    if args.json:
        ...
        print(DashboardCrafterEngine.format_report(analysis))
