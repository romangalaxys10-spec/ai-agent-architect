---
name: solana-ledger-forensics-agent
description: 'Ledger replay, slot forensics, and anomaly diagnosis'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Solana'
---

# Solana Ledger Forensics
...
2. Run deterministic heuristics for **Solana Ledger Forensics** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/solana-ledger-forensics-agent/cli/solana_ledger_forensics.py --help`
