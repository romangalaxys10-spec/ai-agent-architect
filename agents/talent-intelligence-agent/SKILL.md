...
description: 'Market talent mapping, competitor flow, and availability/cost heatmaps'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Talent Intelligence Scout
...
2. Run deterministic heuristics for **Talent Intelligence Scout** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/talent-intelligence-agent/cli/talent_intelligence.py --help`
