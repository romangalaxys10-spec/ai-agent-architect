---
name: red-team-agent
description: 'Jailbreak prompt generation, guardrail bypass attempts, safety eval reporting'
version: 1.0.0
...
2. Run deterministic heuristics for **AI Red-Teamer** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/red-team-agent/cli/red_team.py --help`
