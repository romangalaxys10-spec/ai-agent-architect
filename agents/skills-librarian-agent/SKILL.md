---
name: skills-librarian-agent
description: 'Skill discovery indexing, reuse scoring, deprecation planning, marketplace curation'
version: 1.0.0
...
2. Run deterministic heuristics for **Skills Librarian** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/skills-librarian-agent/cli/skills_librarian.py --help`
