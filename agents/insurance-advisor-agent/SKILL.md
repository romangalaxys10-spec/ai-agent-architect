...
description: 'Gap analysis, limit adequacy, exclusion flagging, renewal negotiation prep (not advice)'
version: 1.0.0
...
2. Run deterministic heuristics for **Insurance Coverage Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/insurance-advisor-agent/cli/insurance_advisor.py --help`
