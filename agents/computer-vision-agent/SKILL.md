...
description: 'GUI element detection, screenshot grounding, coordinate resolution, and vision-to-action translation'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Computer Vision Operator
...
2. Run deterministic heuristics for **Computer Vision Operator** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/computer-vision-agent/cli/computer_vision.py --help`
