---
name: dei-auditor-agent
description: 'Pipeline diversity metrics, language inclusivity audit, intervention effectiveness scoring'
version: 1.0.0
...
2. Run deterministic heuristics for **DEI Auditor** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/dei-auditor-agent/cli/dei_auditor.py --help`
