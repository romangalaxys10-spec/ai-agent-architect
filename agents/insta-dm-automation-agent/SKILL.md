---
name: insta-dm-automation-agent
description: 'Story-reply → DM, keyword triggers, and human-handoff'
version: 1.0.0
...
2. Run deterministic heuristics for **Insta DM Automation** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/insta-dm-automation-agent/cli/insta_dm_automation.py --help`
