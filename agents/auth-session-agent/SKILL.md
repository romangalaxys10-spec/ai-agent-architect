...
description: 'Login flows, OAuth/PKCE, MFA/TOTP, session refresh, and token theft guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Auth & Session Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/auth-session-agent/cli/auth_session.py --help`
