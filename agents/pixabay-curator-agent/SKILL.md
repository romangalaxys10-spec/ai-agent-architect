---
name: pixabay-curator-agent
description: 'Pixabay curation, duration/orientation filters, and safe-search guards'
version: 1.0.0
...
2. Run deterministic heuristics for **Pixabay Curator** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/pixabay-curator-agent/cli/pixabay_curator.py --help`
