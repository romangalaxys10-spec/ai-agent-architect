"""CLI for Storage & RAID Architect — RAID/LVM/ZFS/btrfs, fstab, mount guards, and SMART failure prediction"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Storage & RAID Architect — RAID/LVM/ZFS/btrfs, fstab, mount guards, and SMART failure prediction")
    ...
    from core.storage_raid_engine import StorageRaidEngine
    analysis=StorageRaidEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(StorageRaidEngine.format_report(analysis))
