...
description: 'Active Directory/GPO, Entra ID sync, LDAP, and Kerberos ticket forensics'
version: 1.0.0
...
2. Run deterministic heuristics for **AD & Identity Steward** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ad-identity-agent/cli/ad_identity.py --help`
