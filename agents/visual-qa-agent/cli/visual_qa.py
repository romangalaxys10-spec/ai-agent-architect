"""CLI for Visual QA Sentinel — Pixel diff, perceptual hash, and responsive breakpoints QA"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Visual QA Sentinel — Pixel diff, perceptual hash, and responsive breakpoints QA")
    ...
    from core.visual_qa_engine import VisualQaEngine
    analysis=VisualQaEngine.analyze(text)
    if args.json:
        ...
        print(VisualQaEngine.format_report(analysis))
