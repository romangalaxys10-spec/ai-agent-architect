---
name: power-battery-agent
description: 'Sleep/wake orchestration, battery health, thermal throttling, and charge-limit policies'
version: 1.0.0
author: AI Agent Architect
category: 'Computer Use'
---

# Power & Battery Sentinel
...
2. Run deterministic heuristics for **Power & Battery Sentinel** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/power-battery-agent/cli/power_battery.py --help`
