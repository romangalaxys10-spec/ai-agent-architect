"""CLI for UX Wireframer — IA, user flows, and low→high fidelity wireframes"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="UX Wireframer — IA, user flows, and low→high fidelity wireframes")
    ...
    from core.ux_wireframer_engine import UxWireframerEngine
    analysis=UxWireframerEngine.analyze(text)
    if args.json:
        ...
        print(UxWireframerEngine.format_report(analysis))
