---
name: 3d-render-optimizer-agent
description: 'Render farm orchestration, Cycles/Octane/Arnold sampling, and denoise'
version: 1.0.0
...
2. Run deterministic heuristics for **3D Render Optimizer** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/3d-render-optimizer-agent/cli/m_3d_render_optimizer.py --help`
