---
name: cinema4d-motion-agent
description: 'Cinema 4D motion graphics with MoGraph, Redshift, and fields'
version: 1.0.0
author: AI Agent Architect
category: 'Creative: Video/3D/Music/YouTube'
---

# Cinema 4D Motion Lab
...
2. Run deterministic heuristics for **Cinema 4D Motion Lab** — severity-ranked findings with evidence + fix (render/license, publish CTA).
...
## 🔌 I/O Contract
- **CLI:** `python agents/cinema4d-motion-agent/cli/cinema4d_motion.py --help`
