...
description: 'Objective quality scoring, key-result measurability checks, alignment mapping, retrospective synthesis'
version: 1.0.0
...
2. Run deterministic heuristics for **OKR Coach** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/okr-coach-agent/cli/okr_coach.py --help`
