"""CLI for X Reply Bot — Reply-guy strategy, context-aware replies, and rate-limit safety"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="X Reply Bot — Reply-guy strategy, context-aware replies, and rate-limit safety")
    ...
    from core.x_reply_bot_engine import XReplyBotEngine
    analysis=XReplyBotEngine.analyze(text)
    if args.json:
        ...
        print(XReplyBotEngine.format_report(analysis))
