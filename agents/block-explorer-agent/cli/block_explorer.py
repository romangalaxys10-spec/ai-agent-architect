"""CLI for Block Explorer Architect — Explorer API, tracing, and label curation"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Block Explorer Architect — Explorer API, tracing, and label curation")
    ...
    from core.block_explorer_engine import BlockExplorerEngine
    analysis=BlockExplorerEngine.analyze(text)
    if args.json:
        ...
        print(BlockExplorerEngine.format_report(analysis))
