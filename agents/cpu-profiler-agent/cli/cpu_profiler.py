"""CLI for CPU Profiler — pprof, perf, and hot-spot refactors"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="CPU Profiler — pprof, perf, and hot-spot refactors")
    ...
    from core.cpu_profiler_engine import CpuProfilerEngine
    analysis=CpuProfilerEngine.analyze(text)
    if args.json:
        ...
        print(CpuProfilerEngine.format_report(analysis))
