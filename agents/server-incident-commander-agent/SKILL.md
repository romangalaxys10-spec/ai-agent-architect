---
name: server-incident-commander-agent
description: 'Incident runbooks, war-room, and blameless postmortem'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Server Mgmt'
---

# Server Incident Commander
...
2. Run deterministic heuristics for **Server Incident Commander** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/server-incident-commander-agent/cli/server_incident_commander.py --help`
