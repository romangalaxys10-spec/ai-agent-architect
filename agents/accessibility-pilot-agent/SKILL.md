---
name: accessibility-pilot-agent
description: 'AX tree traversal, VoiceOver/Narrator/Orca mapping, label-role audits, and a11y-driven control'
version: 1.0.0
...
2. Run deterministic heuristics for **Accessibility Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/accessibility-pilot-agent/cli/accessibility_pilot.py --help`
