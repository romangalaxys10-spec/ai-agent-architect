"""CLI for Beat Maker — Beat construction with 808s, drum machines, and swing/groove"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Beat Maker — Beat construction with 808s, drum machines, and swing/groove")
    ...
    from core.beat_maker_engine import BeatMakerEngine
    analysis=BeatMakerEngine.analyze(text)
    if args.json:
        ...
        print(BeatMakerEngine.format_report(analysis))
