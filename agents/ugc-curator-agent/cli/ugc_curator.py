"""CLI for UGC Curator — Submission triage, rights management, creator attribution, repurposing queue"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='UGC Curator — Submission triage, rights management, creator attribution, repurposing queue')
    ...
    from core.ugc_curator_engine import UgcCuratorEngine
    analysis = UgcCuratorEngine.analyze(text)
    if args.json:
        ...
        print(UgcCuratorEngine.format_report(analysis))
