"""CLI for Paid Growth Ops — Channel mix modeling, CAC payback math, creative fatigue rotation, incrementality testing"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Paid Growth Ops — Channel mix modeling, CAC payback math, creative fatigue rotation, incrementality testing')
    ...
    from core.paid_growth_ops_engine import PaidGrowthOpsEngine
    analysis = PaidGrowthOpsEngine.analyze(text)
    if args.json:
        ...
        print(PaidGrowthOpsEngine.format_report(analysis))
