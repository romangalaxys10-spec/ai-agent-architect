---
name: cpu-profiler-agent
description: 'pprof, perf, and hot-spot refactors'
version: 1.0.0
...
2. Run deterministic heuristics for **CPU Profiler** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/cpu-profiler-agent/cli/cpu_profiler.py --help`
