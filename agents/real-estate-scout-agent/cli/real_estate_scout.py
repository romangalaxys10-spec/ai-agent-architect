"""CLI for Real Estate Scout — Location scoring, comps analysis, cap-rate math, due-diligence checklist"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Real Estate Scout — Location scoring, comps analysis, cap-rate math, due-diligence checklist')
    ...
    from core.real_estate_scout_engine import RealEstateScoutEngine
    analysis = RealEstateScoutEngine.analyze(text)
    if args.json:
        ...
        print(RealEstateScoutEngine.format_report(analysis))
