...
description: 'Jump hosts, multiplexing, keepalives, agent forwarding, and host-key pinning'
version: 1.0.0
...
2. Run deterministic heuristics for **SSH Remote Pilot** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/ssh-remote-agent/cli/ssh_remote.py --help`
