"""CLI for Wallet Ops — Custody, multisig (Squads/MPC), and key ceremony ops"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Wallet Ops — Custody, multisig (Squads/MPC), and key ceremony ops")
    ...
    from core.wallet_ops_engine import WalletOpsEngine
    analysis=WalletOpsEngine.analyze(text)
    if args.json:
        ...
        print(WalletOpsEngine.format_report(analysis))
