...
description: 'MEDDICC gap analysis, talk-time metrics, objection handling plays, next-step enforcement'
version: 1.0.0
...
2. Run deterministic heuristics for **Sales Call Coach** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/sales-coach-agent/cli/sales_coach.py --help`
