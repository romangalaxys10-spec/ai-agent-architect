"""CLI for Press Kit Assembler — Boilerplate synthesis, asset inventory, embargo packet, media Q&A prep"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Press Kit Assembler — Boilerplate synthesis, asset inventory, embargo packet, media Q&A prep')
    ...
    from core.press_kit_engine import PressKitEngine
    analysis = PressKitEngine.analyze(text)
    if args.json:
        ...
        print(PressKitEngine.format_report(analysis))
