---
name: learning-needs-diagnostician-agent
description: 'TNA done right: performance gap → learning vs non-learning root cause'
version: 1.0.0
author: AI Agent Architect
category: 'HR · HRBP · L&D'
---

# Learning Needs Diagnostician
...
2. Run deterministic heuristics for **Learning Needs Diagnostician** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/learning-needs-diagnostician-agent/cli/learning_needs_diagnostician.py --help`
