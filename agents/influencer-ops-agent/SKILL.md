---
name: influencer-ops-agent
description: 'Brief generation, deliverable tracking, usage-rights ledger, payout reconciliation'
version: 1.0.0
author: AI Agent Architect
category: 'GTM & SMM Power Suite'
---

# Influencer Ops Commander
...
2. Run deterministic heuristics for **Influencer Ops Commander** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/influencer-ops-agent/cli/influencer_ops.py --help`
