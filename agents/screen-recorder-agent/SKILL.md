...
description: 'Session capture, action trace diffing, deterministic replay, and flake diagnosis'
version: 1.0.0
...
2. Run deterministic heuristics for **Screen Recorder & Replay** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/screen-recorder-agent/cli/screen_recorder.py --help`
