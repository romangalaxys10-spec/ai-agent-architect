---
name: wallet-ops-agent
description: 'Custody, multisig (Squads/MPC), and key ceremony ops'
version: 1.0.0
...
2. Run deterministic heuristics for **Wallet Ops** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/wallet-ops-agent/cli/wallet_ops.py --help`
