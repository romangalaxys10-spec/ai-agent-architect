...
description: 'Health-triggered playbooks, commercial term tracking, risk-adjusted renewal forecast'
version: 1.0.0
...
2. Run deterministic heuristics for **Renewal Orchestrator** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/renewal-orchestrator-agent/cli/renewal_orchestrator.py --help`
