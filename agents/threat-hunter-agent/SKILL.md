...
description: 'Hypothesis-driven hunting, Sigma rules, and lateral movement mapping'
version: 1.0.0
...
2. Run deterministic heuristics for **Threat Hunter** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/threat-hunter-agent/cli/threat_hunter.py --help`
