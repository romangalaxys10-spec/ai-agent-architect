"""CLI for Renewal Orchestrator — Health-triggered playbooks, commercial term tracking, risk-adjusted renewal forecast"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Renewal Orchestrator — Health-triggered playbooks, commercial term tracking, risk-adjusted renewal forecast')
    ...
    from core.renewal_orchestrator_engine import RenewalOrchestratorEngine
    analysis = RenewalOrchestratorEngine.analyze(text)
    if args.json:
        ...
        print(RenewalOrchestratorEngine.format_report(analysis))
