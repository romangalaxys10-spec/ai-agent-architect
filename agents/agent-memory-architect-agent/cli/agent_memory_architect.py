"""CLI for Agent Memory Architect — Working/episodic/semantic tier design, compaction triggers, retrieval policy tuning"""
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Agent Memory Architect — Working/episodic/semantic tier design, compaction triggers, retrieval policy tuning')
    ...
    from core.agent_memory_architect_engine import AgentMemoryArchitectEngine
    analysis = AgentMemoryArchitectEngine.analyze(text)
    if args.json:
        ...
        print(AgentMemoryArchitectEngine.format_report(analysis))
