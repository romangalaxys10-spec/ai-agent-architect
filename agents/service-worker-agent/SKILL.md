...
description: 'Cache strategy, offline fallback, update lifecycle, and push subscription forensics'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Service Worker Auditor
...
2. Run deterministic heuristics for **Service Worker Auditor** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/service-worker-agent/cli/service_worker.py --help`
