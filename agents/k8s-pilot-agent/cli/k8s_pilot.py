"""CLI for K8s Pilot — kubectl, helm, Kustomize, CNI/CSI forensics, and etcd backup/restore"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="K8s Pilot — kubectl, helm, Kustomize, CNI/CSI forensics, and etcd backup/restore")
    ...
    from core.k8s_pilot_engine import K8sPilotEngine
    analysis=K8sPilotEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(K8sPilotEngine.format_report(analysis))
