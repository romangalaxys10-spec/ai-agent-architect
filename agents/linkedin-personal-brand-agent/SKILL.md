...
description: 'POV mining from commits/work, voice calibration, and authority cadence'
version: 1.0.0
...
2. Run deterministic heuristics for **LinkedIn Personal Brand** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/linkedin-personal-brand-agent/cli/linkedin_personal_brand.py --help`
