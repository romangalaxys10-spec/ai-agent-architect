---
name: terminal-recorder-agent
description: 'Asciinema-style capture, timing file synthesis, and deterministic replay gates'
version: 1.0.0
...
2. Run deterministic heuristics for **Terminal Recorder** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/terminal-recorder-agent/cli/terminal_recorder.py --help`
