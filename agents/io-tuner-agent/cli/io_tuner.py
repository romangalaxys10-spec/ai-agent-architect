"""CLI for IO Tuner — iostat, io_uring, and queue-depth tuning"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="IO Tuner — iostat, io_uring, and queue-depth tuning")
    ...
    from core.io_tuner_engine import IoTunerEngine
    analysis=IoTunerEngine.analyze(text)
    if args.json:
        ...
        print(IoTunerEngine.format_report(analysis))
