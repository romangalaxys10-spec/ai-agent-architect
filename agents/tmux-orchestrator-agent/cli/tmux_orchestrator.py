"""CLI for Tmux Orchestrator — Session/window/pane topology, layout persistence, and copy-mode automation"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Tmux Orchestrator — Session/window/pane topology, layout persistence, and copy-mode automation")
    ...
    from core.tmux_orchestrator_engine import TmuxOrchestratorEngine
    analysis=TmuxOrchestratorEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(TmuxOrchestratorEngine.format_report(analysis))
