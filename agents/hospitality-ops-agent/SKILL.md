---
name: hospitality-ops-agent
description: 'Occupancy pacing, upsell triggers, staffing-to-demand matching, guest recovery workflows'
version: 1.0.0
author: AI Agent Architect
category: 'Vertical Specialists'
---

# Hospitality Ops Concierge
...
2. Run deterministic heuristics for **Hospitality Ops Concierge** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/hospitality-ops-agent/cli/hospitality_ops.py --help`
