---
name: growth-loops-agent
description: 'Loop mapping (acquisition/retention/monetization), unit economics, experiment backlog'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Growth Loops Architect
...
2. Run deterministic heuristics for **Growth Loops Architect** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/growth-loops-agent/cli/growth_loops.py --help`
