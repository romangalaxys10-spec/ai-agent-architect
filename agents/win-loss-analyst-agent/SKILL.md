...
description: 'Interview synthesis, loss-reason taxonomy, competitive loss attribution, fix-backlog routing'
version: 1.0.0
...
2. Run deterministic heuristics for **Win/Loss Analyst** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/win-loss-analyst-agent/cli/win_loss_analyst.py --help`
