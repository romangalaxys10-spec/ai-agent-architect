"""CLI for Auth & Session Pilot — Login flows, OAuth/PKCE, MFA/TOTP, session refresh, and token theft guards"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Auth & Session Pilot — Login flows, OAuth/PKCE, MFA/TOTP, session refresh, and token theft guards")
    ...
    from core.auth_session_engine import AuthSessionEngine
    analysis=AuthSessionEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(AuthSessionEngine.format_report(analysis))
