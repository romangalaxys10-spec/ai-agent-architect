...
description: 'Willingness-to-pay modeling, packaging tiers, discount guardrails, expansion triggers'
version: 1.0.0
...
2. Run deterministic heuristics for **Pricing Strategist** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/pricing-strategist-agent/cli/pricing_strategist.py --help`
