"""CLI for Kernel Tuner — sysctl, cgroups v2, io-queue, hugepages, and perf/eBPF perf analysis"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Kernel Tuner — sysctl, cgroups v2, io-queue, hugepages, and perf/eBPF perf analysis")
    ...
    from core.kernel_tuner_engine import KernelTunerEngine
    analysis=KernelTunerEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(KernelTunerEngine.format_report(analysis))
