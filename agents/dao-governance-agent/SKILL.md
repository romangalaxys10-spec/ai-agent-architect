...
description: 'Proposals, voting, and execution queue ops'
version: 1.0.0
author: AI Agent Architect
category: 'SysAdmin: Blockchain'
---

# DAO Governance Pilot
...
2. Run deterministic heuristics for **DAO Governance Pilot** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/dao-governance-agent/cli/dao_governance.py --help`
