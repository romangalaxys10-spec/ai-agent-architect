"""CLI for Secrets Ops — Vault/1Password/AWS Secrets Manager rotation, lease scoping, and break-glass drills"""
import os, sys
...
def main():
    parser=argparse.ArgumentParser(description="Secrets Ops — Vault/1Password/AWS Secrets Manager rotation, lease scoping, and break-glass drills")
    ...
    from core.secrets_ops_engine import SecretsOpsEngine
    analysis=SecretsOpsEngine.analyze(text, os_hint=args.os)
    if args.json:
        ...
        print(SecretsOpsEngine.format_report(analysis))
