---
name: jobs-to-be-done-agent
description: 'Job statement extraction, switch-moment mapping, competing-solution analysis'
version: 1.0.0
...
2. Run deterministic heuristics for **JTBD Mapper** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/jobs-to-be-done-agent/cli/jobs_to_be_done.py --help`
