---
name: affiliate-ops-agent
description: 'Payout integrity, fraud heuristics, creative freshness scoring, partner tiering'
version: 1.0.0
author: AI Agent Architect
category: 'Marketing & Growth'
---

# Affiliate Ops Manager
...
2. Run deterministic heuristics for **Affiliate Ops Manager** — severity-ranked findings with evidence + fix.
...
## 🔌 I/O Contract
- **CLI:** `python agents/affiliate-ops-agent/cli/affiliate_ops.py --help`
