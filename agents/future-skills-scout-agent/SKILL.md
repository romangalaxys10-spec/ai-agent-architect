---
name: future-skills-scout-agent
description: 'Horizon scanning for emerging skills with adjacency and decay rates'
version: 1.0.0
...
2. Run deterministic heuristics for **Future Skills Scout** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/future-skills-scout-agent/cli/future_skills_scout.py --help`
