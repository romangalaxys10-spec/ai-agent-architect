...
description: 'Heap dumps, ASAN/Valgrind, and leak triage'
version: 1.0.0
...
2. Run deterministic heuristics for **Memory Leak Hunter** — severity-ranked findings with evidence + fix (secret exposure, urgency, domain-specific hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/memory-leak-hunter-agent/cli/memory_leak_hunter.py --help`
