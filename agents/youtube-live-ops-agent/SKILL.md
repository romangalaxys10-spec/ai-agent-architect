---
name: youtube-live-ops-agent
description: 'Live run-of-show, chat moderation, and super-chat funnel'
version: 1.0.0
...
2. Run deterministic heuristics for **YouTube Live Ops** — severity-ranked findings with evidence + fix (platform mismatch, CTA/hook, license hygiene for freebie, Gemini prompt hygiene).
...
## 🔌 I/O Contract
- **CLI:** `python agents/youtube-live-ops-agent/cli/youtube_live_ops.py --help`
