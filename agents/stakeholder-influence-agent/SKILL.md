---
name: stakeholder-influence-agent
description: 'Power/interest mapping, influence paths, and coalition building for HR initiatives'
version: 1.0.0
...
2. Run deterministic heuristics for **Stakeholder Influence Mapper** — severity-ranked findings with evidence + fix (HR-grade guardrails: PII, bias language, employment-law risk).
...
## 🔌 I/O Contract
- **CLI:** `python agents/stakeholder-influence-agent/cli/stakeholder_influence.py --help`
