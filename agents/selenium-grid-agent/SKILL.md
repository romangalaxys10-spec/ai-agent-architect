...
description: 'Hub/node scaling, capability matching, grid health, and flaky quarantine'
version: 1.0.0
author: AI Agent Architect
category: 'Browser Use'
---

# Selenium Grid Commander
...
2. Run deterministic heuristics for **Selenium Grid Commander** — severity-ranked findings with evidence + fix; OS-adaptive checks for Linux/macOS/Windows.
...
## 🔌 I/O Contract
- **CLI:** `python agents/selenium-grid-agent/cli/selenium_grid.py --help`
